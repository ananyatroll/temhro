...
|       | of a        | new        | substance |       |           |        | formed. |     |        |            |     |
| 1.    | Odor        | Production |           |       |           | -      | this    |     |        |            |     |
| is    | an          | odor       | far       |       | different |        |         |     |        |            |     |
| from  |             | what       |           |       | it        | should |         |     |        |            |     |
| smell |             | like       |           |       |           |        |         |     |        |            |     |
|       | Ex:         |            | Rotting   |       |           |        | eggs,   |     |        |            |     |
|       | decomposing |            |           | flesh |           |        |         |     |        |            |     |
...
| Examples | include: |       |            | substance. | Examples: |        |      |       |
1. Physical state: solid, liquid, gas
| 2. Color  |     |     |     | 1. Flammability |     |     |     |     |
| --------- | --- | --- | --- | --------------- | --- | --- | --- | --- |
3. Shape
...
| Intensive |          | property-  |     | One    | that      | DOES |     |
| --------- | -------- | ---------- | --- | ------ | --------- | ---- | --- |
| NOT       | depend   | on         | the | amount |           | of   | the |
| substance | present. |            |     |        |           |      |     |
| Extensive |          | property-  |     | One    | that      | DOES |     |
| depend    | on       | the amount |     | of the | substance |      |     |
present.

| Intensive |           | properties  |                | are | determined |           | by the |
| --------- | --------- | ----------- | -------------- | --- | ---------- | --------- | ------ |
| chemical  |           | composition |                | of  | the        | particles | and    |
...
combined.
| Substances |     |     |     | held | together |     | by  | physicalforces, |     |     |     |
| ---------- | --- | --- | --- | ---- | -------- | --- | --- | --------------- | --- | --- | --- |
notchemical.
...
MIXTURES
| A mixture |          |      | is       | something |         |         | that      | CAN       | be  |
| --------- | -------- | ---- | -------- | --------- | ------- | ------- | --------- | --------- | --- |
...
| single      |     | substance, |     |           |         |           | but    |            |       | it   | is        |        | actually |     |        |     |
| composed    |     |            | of  | 2         | or      | more      |        | substances |       |      |           |        | that     |     | are    |     |
| distributed |     |            |     | evenly    |         | amongst   |        |            |       | each |           | other. |          |     |        |     |
| Examples:   |     | Salt       |     | dissolved |         | in        | water, |            | sugar |      | dissolved |        |          | in  | water, |     |
apple juice, tea, copper (II) sulfate solution in water, alloys,
...
| 2. Magnetic |            | Separation: |            | takes         | advantage |
| ----------- | ---------- | ----------- | ---------- | ------------- | --------- |
| of the      | physical   |             | property   | of magnetism. |           |
| Example:    | Separating | Metals      | in a Scrap | Yard          |           |

| 3.         | Filtration: |           |          |           | takes   |            | advantage |             |     | of       | the   |
| ---------- | ----------- | --------- | -------- | --------- | ------- | ---------- | --------- | ----------- | --- | -------- | ----- |
|            | physical    |           | property |           |         | of         | the       | state       | of  | matter.  |       |
|            | A screen    |           | lets     |           | the     | liquid     |           | particles   |     | through, |       |
|            | but         | traps     |          | the       | solid   | particles. |           |             |     |          |       |
|            | A filter    |           | can      |           | also    | be         | used      | to separate |     |          | solid |
...
| ------------- | --------- | ------ | ----------- | ---- | ----- | ----------- | ------- |
| another       |           | liquid |             | or   | solid | behind.     | Takes   |
...
Example:  Obtaining sea salt from
sea water
...
| 8.        | Centrifuge: |                | Circular |        | motion | helps   | denser |
| --------- | ----------- | -------------- | -------- | ------ | ------ | ------- | ------ |
|           | components  |                | sink     | to the | bottom | faster. |        |
| Examples: |             | The separation | of       |        |        |         |        |
| blood     | or DNA      | from blood     |          |        |        |         |        |

| 9. Paper  |     | chromatography: |        |             | Uses      | the        | property    |     | of  |
| --------- | --- | --------------- | ------ | ----------- | --------- | ---------- | ----------- | --- | --- |
| molecular |     | attraction      |        | to separate |           | a mixture. |             |     |     |
| Different |     | molecules       |        | have        | different |            | attractions |     |     |
| for       | the | paper           | (the   | stationary  |           | phase)     |             | vs. | the |
...
| --------- | ---------- | --------------- | ---------------- | ----- | ---------- | ---------- | --- |
|           | substances |                 | crystallize      | out   | of         | a solution |     |
|           | once       | their           | solubility       | limit | is reached |            | as  |
|           | the        | solution        | cools.           |       |            |            |     |
...
Objectives
| 1. To   | show |     | how |     | very | large     |     | or very |            | small |
| ------- | ---- | --- | --- | --- | ---- | --------- | --- | ------- | ---------- | ----- |
| numbers |      |     | can |     | be   | expressed |     | in      | scientific |       |
notation
| 2. To  | learn       |     | the    | English, |        | metric, |     | and     | SI  | systems |
| ------ | ----------- | --- | ------ | -------- | ------ | ------- | --- | ------- | --- | ------- |
| of     | measurement |     |        |          |        |         |     |         |     |         |
| 3. To  | use         | the | metric |          | system |         | to  | measure |     | length, |
| volume |             | and |        | mass     |        |         |     |         |     |         |
...
unit)
SI (uses prefixes to change the size of the
unit)

C. Measurements of Length, Volume and
Mass
Length
...
Volume
â–ª
| Amount | of 3-D | space | occupied | by  |
| ------ | ------ | ----- | -------- | --- |
a substance
â–ª
3
...
| 3. To       | learn | to determine |             | the         | number     |         | of  |
...
| Record    | all     | certain | numbers | and | one |
| --------- | ------- | ------- | ------- | --- | --- |
| estimated | number. |         |         |     |     |
...
Objectives
| 1. To | learn | how        | dimensional |             | analysis        |        | can | be used |     |
| ----- | ----- | ---------- | ----------- | ----------- | --------------- | ------ | --- | ------- | --- |
| to    | solve | problems   |             |             |                 |        |     |         |     |
...
required change (cancel the unwanted units).
...
| ---- | ------- | --------- | ------- | -------------- | ------------- | --- | --- | -------- | --- | --- |
|      | The     | zero      | points  |                | are different |     |     |          |     |     |
| To   | convert |           | between |                | Fahrenheit    |     | and | Celsius, |     | we  |
...
Objectives
| i. To | learn | about | the | relative | abundances | of the |
| ----- | ----- | ----- | --- | -------- | ---------- | ------ |
elements
...
| ---------- | ------ | --- | --------- | --- | ---- | ---- | ----- | -------- | --- | --------- | --- | --- |
| chemically |        |     | broken    |     | down | into | about |          | 100 | different |     |     |
elements.
| Compounds |     |      | are       | made     | by  | combining |             |     | atoms |      | of  | the |
| --------- | --- | ---- | --------- | -------- | --- | --------- | ----------- | --- | ----- | ---- | --- | --- |
| elements  |     | just |           | as words |     | are       | constructed |     |       | from |     | the |
...
III. A given compound always has the same
relative
...
| ---------- | --- | -------------- | --- | ------- | -------- | ------- | ------- | --- |
| in which   | the | number         | and | kind    | of atoms |         | present | is  |
| shown      | by  | using          | the | element |          | symbols |         | and |
subscripts.
...
|      | subatomic |            | particles |            |           |        |              |          |          |          |     |
| iv.  | To        | learn      | about     |            | the       | terms  |              | isotope, |          | atomic   |     |
|      | number,   |            | and       | mass       | number    |        |              |          |          |          |     |
| v.   | To        | understand |           | the        | use       | of the | symbol       |          | to       | describe |     |
|      | a given   |            | atom      |            |           |        |              |          |          |          |     |

A. Introduction to the Modern Concept of
Atomic Structure
...
| The Mass | and Charge | of the | Electron, | Proton | and |
| -------- | ---------- | ------ | --------- | ------ | --- |
neutron.
...
Objectives
| i. To | learn | the | various |     | features | of the |
| ----- | ----- | --- | ------- | --- | -------- | ------ |
periodic table
| ii. To    | learn | some | of the     | properties |        | of metals, |
| --------- | ----- | ---- | ---------- | ---------- | ------ | ---------- |
| nonmetals |       | and  | metalloids |            |        |            |
| iii. To   | learn | the  | natures    |            | of the | common     |
elements
...
2. Malleability (can be hammered into thin
sheets)
...
Objectives
| i.   | To     | describe |          | the  | formation |         | of ions | from    | their |
| ---- | ------ | -------- | -------- | ---- | --------- | ------- | ------- | ------- | ----- |
|      | parent |          | atoms    |      |           |         |         |         |       |
| ii.  | To     | learn    | to       | name | ions      |         |         |         |       |
| iii. | To     | predict  | which    |      | ion       | a given | element | forms   | by    |
|      | using  | the      | periodic |      | table     |         |         |         |       |
| iv.  | To     | describe |          | how  | ions      | combine | to form | neutral |       |
compounds
...
Cations are generally named by using the
name of the parent atom.

p79

| Nonmetals |          | tend  | to   | gain       | one     | or more  | electrons | to   |
| --------- | -------- | ----- | ---- | ---------- | ------- | -------- | --------- | ---- |
...
High melting points
â–ª
Conduct electricity (If melted & If dissolved in
water)
...
| The   | number  | of      | cations | and | anions | must     | be correct |
| for   | their   | charges | to sum  | to  | zero.  |          |            |
...
|        | possible | charge, |     |              | write |              | the charge |      |      | as a   | Roman  |      |
...
| take     | up  | to four. |          |                     |     |      |        |     |
| Charges  |     | increase | as you   | go fromrighttoleft. |     |      |        |     |
...
| ---- | --- | --- | --------- | --- | --- | --- | --- | --- | --- | --- | --- |
2
| The | one | with | the | second |     | most |     | oxygens |     | ends | in - |
| --- | --- | ---- | --- | ------ | --- | ---- | --- | ------- | --- | ---- | ---- |
âˆ’
| ate: | ClO | is  | chlorate. |     |     |     |     |     |     |     |     |
| ---- | --- | --- | --------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ----- | --- | ---- | --- | ------ | ------- | ------- | ---- | ------------- | --- | ---------- | ------ |
| hypo- | and | ends | in  | -ite:  | ClO     |         | âˆ’ is | hypochlorite. |     |            |        |
| The   | one | with | the | most   | oxygens |         |      | has           | the | prefixper- |        |
âˆ’
| and | ends | in -ate:ClO |     |     | is  | perchlorate. |     |     |     |     |     |
| --- | ---- | ----------- | --- | --- | --- | ------------ | --- | --- | --- | --- | --- |
...
nomenclature.
| The  | simplest |      | hydrocarbons |           |       |        | (compounds |          |        | containing |     |
| ---- | -------- | ---- | ------------ | --------- | ----- | ------ | ---------- | -------- | ------ | ---------- | --- |
| only | carbon   |      | and          | hydrogen) |       |        | are        | alkanes. |        |            |     |
| The  | first    | part | of           | the       | names |        | just       |          | listed | correspond | to  |
...
| Hydrogen gas (H     | ) and oxygen gas (O |     |     | ) combine to form  |
| ------------------- | ------------------- | --- | --- | ------------------ |
|                     | 2                   |     |     | 2                  |
| liquid water (H O). |                     |     |     |                    |
2
...
| SSeeccttioionn 6 3.3.3 |     | Balancing using the underline |     |     |     | method. |     |
| ---------------------- | --- | ----------------------------- | --- | --- | --- | ------- | --- |
Balancing Chemical Equations
...
|           | I.   | CaO            | + 3C â†’ | CaC  |      | + CO |           |     |
|           |      |                | 2      |      |      | 2    |           | 2   |
|           | II.  | 2CaO + 5C â†’    |        |      | 2CaC |      | + CO      |     |
|           |      |                |        |      |      |      | 2         | 2   |
|           | III. | CaO + (2.5)C â†’ |        |      | CaC  |      | + (0.5)CO |     |
2 2
|     | IV. | 4CaO + 10C â†’ |     |     | 4CaC |     | + 2CO |     |
| --- | --- | ------------ | --- | --- | ---- | --- | ----- | --- |
2 2
Return to TOC
...
|     | this,    | simply |        | exchange   |     |        | the     |      | anions    |          | of the | added |
salts.
...
1. Divorce
3
|     |     | Pb+2+NO | - + Na++ l- |     | Pbl | +  NaNO |     |     |
| --- | --- | ------- | ----------- | --- | --- | ------- | --- | --- |
2. Change Partners
|     |     |         | 3            |     |     | 2          | 3   |     |
| --- | --- | ------- | ------------ | --- | --- | ---------- | --- | --- |
|     |     | Pb+2+NO | - + Na++ l - |     | Pbl | (s) +  Na+ | NO  | -   |
3. Soluble?
|     |     |     | 3   |     |     | 2   |     | 3   |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
Total Ionic Equation
| 4. Cross out |     | Pb+2+  l- |     | Pbl (s)   |     |     |     |     |
| ------------ | --- | --------- | --- | --------- | --- | --- | --- | --- |
2
Spectator Ions
| 5. Balance |     | Pb+2+  2 l- |     | Pbl (s)   |     |     |     |     |
| ---------- | --- | ----------- | --- | --------- | --- | --- | --- | --- |
2
Net Ionic Equation
Return to TOC
...
â–ª Shows the complete formulas of all
reactants and products.
â–ª It does not give a very clear picture of
...
Molecular Equation:
CoCl (aq) + 2NaOH(aq) â†’ Co(OH) (s) + 2NaCl(aq)
2 2
Complete Ionic Equation:
Co2+(aq) + 2Clâˆ’(aq) + 2Na+(aq) + 2OHâˆ’(aq) â†’
Co(OH) (s) + 2Na+(aq) + 2Clâˆ’(aq)
2
Net Ionic Equation:
...
5. Acid-Base (Neutralization) HA + BOH      H O + BA
2
| 6. Combustion-  | Organic + O             |     | CO  | + H O |
| --------------- | ----------------------- | --- | --- | ----- |
|                 |                         | 2   |     | 2 2   |
...
|     | base,  |        | one | product  |     |          | is always  |          |     | water |             | and       | the      | other |
|     | is     | always |     |          | an  |          | ionic      | compound |     |       |             | called    | a        | salt, |
|     | which  |        |     | remains  |     |          | dissolved  |          | in  | the   |             | water.    | This     | salt  |
|     | can    |        | be  | obtained |     |          | as a       | solid    |     | by    | evaporating |           |          | the   |
.
water
Return to TOC
Copyright Â© Cengage Learning. All rights reserved
...
a) 26.98 g
1 mole Al 1 mole Au 196.97g Au
b) 13.49 g
26.98 g Al ----------- --------------- ---------------- = 197.0 g Au
c) 197.0 g
...
3 8
areas. Predict how many moles of CO are formed when 3.74
2
...
a) 118.7 g/mol
carbonate is NiCO . Therefore
3
b) 134.7 g/mol the molar mass is:
58.69 + 12.01 + 3(16.00) =
c) 178.71 g/mol
118.70 g/mol.
d) 296.09 g/mol
...
2
| Al(NO ) | , and KCN.  Rank these from least to  |     |     |
| ------- | ------------------------------------- | --- | --- |
3 3
...
15.999g O
95.994
| 6 moles O -------------- | =  95.994g O |     |     | x100%=53.3% O |
| ------------------------ | ------------ | --- | --- | ------------- |
1 mole O 180.155
180.155
...
Solution:
1. Calculate molar mass of C H N O , by finding the mass
11 17 3 8
...
3. Divide the mass of each element by the mass of the
compound.
Example C: 132 g / 317 g = 0.42 g/g (42 %)
Return to TOC
Zumdahl Chapter 3 32
...
| --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- |
|     |     |     | 6 6 |         | 2   | 6   | 12  |     |     |
MHoolews  mlevaenly grams of cyclohexane C H can be made from
Balanced?
6 12
|     |     | 4.5 grams of benzene C |     |     |     |     | H ? |     |     |
| --- | --- | ---------------------- | --- | --- | --- | --- | --- | --- | --- |
6 6
...
| Grams level |          | 4.5g  |            |     |     |           | ?   |     |     |
| ----------- | -------- | ----- | ---------- | --- | --- | --------- | --- | --- | --- |
|             | 1 mole C |       | H 1 mole C |     | H   | 84.174g C |     | H   |     |
4.8 g
|     |     | 6   | 6   |     | 6 12 |     |     | 6 12 |     |
| --- | --- | --- | --- | --- | ---- | --- | --- | ---- | --- |
4.5 g C H ---------------- ------------------ ------------------- =
6 6
C H
|     | 78.1134 g    1 mole C |     |     |     | H   | 1 mole C |     | H   |     |
| --- | --------------------- | --- | --- | --- | --- | -------- | --- | --- | --- |
6 12
|     |                     |     |     |     | 6 6             |     |     | 6 12 |     |
| --- | ------------------- | --- | --- | --- | --------------- | --- | --- | ---- | --- |
|     | How many grams of H |     |     |     | will be needed? |     |     |      |     |
2
|     | 1 mole C |     | H 3 moles H |     |     | 2.0158g H |     |     |          |
| --- | -------- | --- | ----------- | --- | --- | --------- | --- | --- | -------- |
|     |          |     | 6 6         |     | 2   |           |     | 2   | 0.35 g H |
4.5 g C H ---------------- ---------------- ----------------- =
2
6 6
|     | 78.1134 g   1 mole C |     |     |     | H   | 1 mole H |     |     |     |
| --- | -------------------- | --- | --- | --- | --- | -------- | --- | --- | --- |
|     |                      |     |     |     | 6 6 |          |     | 2   |     |
Return to TOC
Copyright Â© Cengage Learning. All rights reserved
...
|     |     | PCl | + 3H | O â†’ |     | H PO | + 3HCl |     |     |     |
| --- | --- | --- | ---- | --- | --- | ---- | ------ | --- | --- | --- |
|     |     |     | 3    | 2   |     | 3    | 3      |     |     |     |
What mass of H O is needed to completely react with 20.0 g of
2
PCl ?
3
a) 7.87 g
...
|     |     |     |     |     | #   g r a m s | 1 7 | 5   g   X |
| --- | --- | --- | --- | --- | ------------- | --- | --------- |
d) C M o l a r   M a s s   =     =     =   1 2 . 0   g / m o l
...
H + I â†’ 2 HI
2 2
How many grams of HI can be formed from 2.00 g H and
2
2.00 g of I ?
2
2.00 g 2.00 g ?
1 mole H 2 mole HI 127.9124g HI
2
2.00 g H -------------- ------------- ------------------- = 254 g HI
2
2.0158 g 1 mole H 1 mole HI
2
1 mole I 2 moles HI 127.9124g HI
2
2.00g I ------------- --------------- ----------------- = 2.02 g HI
2
253.810 g 1 mole I 1 mole HI
2
...
Calculations Involving a Limiting Reactant
Exercise
How many grams of NH can be produced from the
3
...
Percent Yield
Exercise
Find the percent yield of product if 1.50 g of SO is
3
produced from 1.00 g of O and excess sulfur via the
2
reaction:
2S + 3O â†’ 2SO
2 3
...
| -------------- | ---------- | --------------------------------- | --- | --- | --- |
|                | 4          | 2                                 |     | 3   |     |
| What mass of P |            | is needed to produce 85.0 g of PF |     |     | if  |
|                |            | 4                                 |     |     | 3   |
...
1 mole K
1.10
43.2 g K -------------- = 1.10 moles K =1.0 mole K
39.098g K 1.10
1 mole Cl 1.10
39.1 g Cl -------------- = 1.10 moles Cl = 1.0 mole Cl
35.453 g Cl 1.10
1 mole O
1.10
17.7 g O ------------- = 1.10 moles O = 1.0 mole O
15.999g O 1.10
...
1 mole C
3.33
| 40.0 g C -------------- |           | =  3.33 moles C |       | =1.0 mole C  |     |
| ----------------------- | --------- | --------------- | ----- | ------------ | --- |
|                         | 12.011g C |                 | 3.33  |              |     |
|                         | 1 mole H  |                 | 6.64  |              |     |
...
| ---------------------- | --- | -------------- | --- | ------------ | --- |
15.999g O 3.33
|     | The Empirical Formula is CH |     | O (MW =30.026) |     |     |
| --- | --------------------------- | --- | -------------- | --- | --- |
2
If MW of the real formula is 180.155, what is the actual formula?
|     | (180.155)/(30.026) = 6       CH |     | O x 6 = C | H    | O   |
| --- | ------------------------------- | --- | --------- | ---- | --- |
|     |                                 |     | 2         | 6 12 | 6   |
Return to TOC
...
empirical formula to be C H . What is the molecular
3 7
formula of the compound?
...
| The empirical formula is C |     |     |     | H O | . What is the  |
| -------------------------- | --- | --- | --- | --- | -------------- |
|                            |     |     |     | 3 5 | 2              |
molecular formula?
| Mw C                  | H O | = 3x12 + 5x1 + 2x16 =73 g/mole |     |     |     |
| --------------------- | --- | ------------------------------ | --- | --- | --- |
|                       | 3 5 | 2                              |     |     |     |
|                       |     |                                |     | C H | O   |
| 146/73 = 2      2 x C |     |                                | H O | =   |     |
...
or scattering of electromagnetic
...
atomic world but, rather that as our views
shift so does our notice of the behaviors.

3.The structure of many
electron atoms
Orbital energies
a.
...
a. Number of protons- the greater the number of protons the
smaller the atom.
...
down a group because of an increase in metallic character.
3. Boiling point: is the temperature at which a liquid starts to
vaporize.
...
6.4 Stable Electron Configurations and Charges on Ions
6.5 Ionic Bonding and Structures of Ionic Compounds
6.6 Lewis Structures
6.7 Lewis Structures of Molecules with Multiple Bonds
6.8 Molecular Structure
6.9 Molecular Structure: The VSEPR Model
6.10 Molecular Structure: Molecules with Double Bonds
...
Table of Contents
8
| Bonding,   |      | the | way    |     | atoms   | are | attracted  |
| ---------- | ---- | --- | ------ | --- | ------- | --- | ---------- |
...
configuration.
â–ª
Nonmetals gain electrons to reach
...
| 1. When       |     | anonmetalandaGroup1,2,or3metal |               |     |          |     |          |           |                  |          |       |     |      |
| ------------- | --- | ------------------------------ | ------------- | --- | -------- | --- | -------- | --------- | ---------------- | -------- | ----- | --- | ---- |
| react         |     | to                             | form          |     | a binary |     | ionic    | compound, |                  |          | the   |     | ions |
| form          |     |                                | so            |     | that     |     | the      |           | valence-electron |          |       |     |      |
...
| Na+ | + Cl- | = NaCl |     | Ca+2 | + Cl- |     | = CaCl |     |     |     |
| --- | ----- | ------ | --- | ---- | ----- | --- | ------ | --- | --- | --- |
2
| Ca+2 | + O-2= CaO |     |     | Na+ | + O-2 |     | = Na | O   |     |     |
| ---- | ---------- | --- | --- | --- | ----- | --- | ---- | --- | --- | --- |
2
| Al+3 | + S-2 | = Al | S   | Ca+2 | + N-3 |     | = Ca | N   |     |     |
| ---- | ----- | ---- | --- | ---- | ----- | --- | ---- | --- | --- | --- |
|      |       |      | 2 3 |      |       |     |      | 3   | 2   |     |
You try these!
| Li+ + Br- |     |         |     | Mg+2 | + F- |     |        |     |     |     |
...
1. Write a skeleton molecule with the lone atom in the middle (Hydrogen can
...
6. Insert minimum number of bonding electrons in the skeleton between atoms
only. Add more bonding if needed until you have B bonding electrons.
7. Insert needed non-bonding electrons around (not between) atoms so that all
atoms have 8 electrons around them. The total should be the same as NB in 5
above.
Return to TOC
...
Calculate the pH of the buffer before and after the addition of added
acid or base

7.1. Introduction
| The        | convention |         |             |          | for        | writing  |     |          | chemical |          |             | equations  |          |       |
| ---------- | ---------- | ------- | ----------- | -------- | ---------- | -------- | --- | -------- | -------- | -------- | ----------- | ---------- | -------- | ----- |
| involves   |            | placing |             |          | reactant   |          |     | formulas |          |          | on the      |            | left     | side  |
...
| forward    |            | (left   |             | to       | right)     |          | and | reverse  |          |          | (right      |            | to       | left) |
3
directions.

| When        |          | the     |             | rates   |                | of  |            | the          | forward        |      |           | and          | reverse |      |
| ----------- | -------- | ------- | ----------- | ------- | -------------- | --- | ---------- | ------------ | -------------- | ---- | --------- | ------------ | ------- | ---- |
| reactions   |          |         | are         |         | equal,         |     | the        |              | concentrations |      |           |              | of      | the  |
| reactant    |          |         | and         |         | product        |     | species    |              | remain         |      |           | constant     |         | over |
| time        | and      |         | the         | system  |                | is  | at         | equilibrium. |                |      |           |              |         |      |
| The         | relative |         |             |         | concentrations |     |            |              |                | of   | reactants |              |         | and  |
| products    |          | in      | equilibrium |         |                |     |            | systems      |                | vary |           | greatly;     |         | some |
| systems     |          | contain |             |         | mostly         |     |            | products     |                |      | at        | equilibrium, |         |      |
| some        | contain  |         |             |         | mostly         |     | reactants, |              |                | and  |           | some         | contain |      |
| appreciable |          |         |             | amounts |                |     | of both.   |              |                |      |           |              |         |      |

| Figure    | 7.1:       | Illustrates |           | fundamental |          |               | equilibrium |          |     |
| --------- | ---------- | ----------- | --------- | ----------- | -------- | ------------- | ----------- | -------- | --- |
| concepts  | using      |             | the       | reversible  |          | decomposition |             |          | of  |
| colorless | dinitrogen |             | tetroxide |             | to yield | brown         |             | nitrogen |     |
| dioxide,  | an         | elementary  |           | reaction    |          | described     |             | by       | the |
equation:
|     |     |     | N O     | =>  | 2NO  |     |     |     |     |
| --- | --- | --- | ------- | --- | ---- | --- | --- | --- | --- |
|     |     |     | 2 4 (g) |     | 2(g) |     |     |     |     |
...
| -------- | ---------- | -------- | -------- | --- | --- | ---- | ------------ | --- | ------------ | ----------- | ----------- | --- | --- |
| also     | reversible |          |          | and |     | may  | establish    |     |              | equilibria. |             |     | As  |
| one      | example,   |          | consider |     |     | the  | vaporization |     |              |             | of bromine: |     |     |
(l)   â‡Œ
|     |     |     |     | Br  |     |     | Br  | (g) |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|     |     |     |     |     | 2   |     | 2   |     |     |     |     |     |     |
...
| -------- | ------------ | --- | ---------- | ------------ | --- | --------- | -------- | --- | --- | --------------- | --- | --- | ---- |
| assessed |              | by  | evaluating |              |     | its       | reaction |     |     | quotient        |     |     | (Q). |
...
|            |           |          |     |          |     |           |     |     |     | P   | P   |     |
|            |           |          |     |          |     |           |     |     |     |     | C D |     |
| a reaction |           | quotient |     | may      | be  | similarly |     | Q   | =   |     |     |     |
p
|          |          |         |     |            |     |     |                     |     |     | P         | m P | n   |
| -------- | -------- | ------- | --- | ---------- | --- | --- | ------------------- | --- | --- | --------- | --- | --- |
| derived  | using    | partial |     | pressures: |     |     |                     |     |     |           |     |     |
|          |          |         |     |            |     |     |                     |     |     |           | A B |     |
| Example  |          | 7.1:    |     | Write      |     | the | concentration-based |     |     |           |     |     |
| reaction | quotient |         |     | expression |     | for | each                | of  | the | following |     |     |
reactions:
|     |     |     |     |     |     | [ O ] 2 |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- | --- |
|     |     |     |     |     | Q = | 3       |     |     |     |     |     |     |
...
|     |         |          |           |         |     |        | 2   |             |     | 2 4      |          |        |
| --- | ------- | -------- | --------- | ------- | --- | ------ | --- | ----------- | --- | -------- | -------- | ------ |
| a.  | What    |          | is the    | value   |     | of the |     | reaction    |     | quotient |          | before |
|     | any     | reaction |           | occurs? |     |        |     |             |     |          |          |        |
| b.  | What    |          | is the    | value   |     | of     | the | equilibrium |     |          | constant |        |
|     | for the |          | reaction? |         |     |        |     |             |     |          |          |        |

Solution
| a.      | Before |     |           | any |     | reaction |                |     | started |     |     |     | or  | before | any |     |
| ------- | ------ | --- | --------- | --- | --- | -------- | -------------- | --- | ------- | --- | --- | --- | --- | ------ | --- | --- |
| product |        |     | is formed |     |     | the      | concentrations |     |         |     |     |     | of: |        |     |     |
|         |        |     |           | 0 . | 1 m | o l      |                |     |         |     |     |     |     |        |     |     |
|         |        |     |           |     |     |          |                |     |         |     |     | [N  | O   | ] = 0  |     |     |
|         | [      | N O | ] =       |     |     |          | = 0            | . 1 | M       |     |     |     |     |        |     |     |
|         |        |     | 2         |     |     |          |                |     |         |     |     |     | 2   | 4      |     |     |
...
| A         | homogeneous |     |     |     |          | equilibrium |     |     | is      | one | in  | which |     | all  |
| --------- | ----------- | --- | --- | --- | -------- | ----------- | --- | --- | ------- | --- | --- | ----- | --- | ---- |
| reactants |             |     | and |     | products |             |     | are | present |     | in  | the   |     | same |
phase.
|     | By         | this      |     | definition, |         |            |      | homogeneous |     |     |        | equilibria |        |     |
| --- | ---------- | --------- | --- | ----------- | ------- | ---------- | ---- | ----------- | --- | --- | ------ | ---------- | ------ | --- |
|     | take       | place     |     | in          |         | solutions. |      |             |     |     |        |            |        |     |
|     | These      | solutions |     |             |         | are        | most | commonly    |     |     | either |            | liquid |     |
|     |            |           |     |             |         |            |      |             |     |     |        | [ C        | H B    | r ] |
|     | or gaseous |           |     |             | phases, |            | as   | shown       |     | by  | the    | examples   |        |     |
|     |            |           |     |             |         |            |      |             |     | K   | =      | 2          | 2      | 2   |
â‡Œ
|     |     |     |     |     |     |     |     |     |     | c   |     |     |     | 2     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----- |
...
| These         | examples |           | all       | involve       |       | aqueous   |           | solutions, |          |         | those |     |
| ------------- | -------- | --------- | --------- | ------------- | ----- | --------- | --------- | ---------- | -------- | ------- | ----- | --- |
| in            | which    | water     | functions |               | as    | the       | solvent.  |            |          |         |       |     |
| In            | the      | examples, |           | water         |       | also      | functions |            |          |         | as    | a   |
| reactant,     |          | but       | its       | concentration |       |           | is        | not        | included |         |       | in  |
| the           | reaction | quotient. |           |               |       |           |           |            |          |         |       |     |
| Consequently, |          |           |           | reaction      |       | quotients |           |            |          | include |       |     |
| concentration |          |           | or        | pressure      | terms |           | only      | for        | gaseous  |         | and   |     |
13
| solute | species. |     |     |     |     |     |     |     |     |     |     |     |
| ------ | -------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --------- | --- | --- | --- |
|     |     |     |     |     | 2         | 2   |     |     |
For gas-phase solutions, the equilibrium constant may be expressed in
terms of either the molar concentrations (Kc) or partial pressures (Kp) of
| the reactants |     | and products. |     |     |     |     |     |     |
| ------------- | --- | ------------- | --- | --- | --- | --- | --- | --- |
A relation between these two Kvalues may be simply derived from the
| ideal gas | equation | and the | definition | of molarity: |     |     |     |     |
| --------- | -------- | ------- | ---------- | ------------ | --- | --- | --- | --- |
ïƒ¦ n ïƒ¶
|     | PV  | = nRT |     | P = | ïƒ§ ïƒ·RT | = MRT |     |     |
| --- | --- | ----- | --- | --- | ----- | ----- | --- | --- |
ïƒ¨ V ïƒ¸
...
|     |     |     |     |     |     |     |     |     | p   |     | C      |     |     | C      |     | (RT)2 |     |     |
â‡Œ
| ï„n  |     | = (2 | +1) | âˆ’   | (1+ | 4)  | = âˆ’2 |     |     |     |                    |     |     |     |     |     |     | âˆ’2  |
| --- | --- | ---- | --- | --- | --- | --- | ---- | --- | --- | --- | ------------------ | --- | --- | --- | --- | --- | --- | --- |
|     |     |      |     |     |     |     |      |     | K   | =   | 0.28x(0.0821x1173) |     |     |     |     |     |     |     |
P
| K   |     | =   | K (RT |     | ) ï„n | =   | K (RT | ) âˆ’2 |     |     |         |     |     |     |     |     |     |     |
| --- | --- | --- | ----- | --- | ---- | --- | ----- | ---- | --- | --- | ------- | --- | --- | --- | --- | --- | --- | --- |
|     |     |     |       |     |      |     |       |      | K   | =   | 3.02x10 |     |     | âˆ’5  |     |     |     |     |
|     | p   |     | C     |     |      |     | C     |      |     |     |         |     |     |     |     |     |     |     |
P
...
| A heterogeneous |          |        | equilibrium |         |           | involves |     | reactants |     |
| --------------- | -------- | ------ | ----------- | ------- | --------- | -------- | --- | --------- | --- |
| and             | products | in     | two         | or more | different |          |     | phases,   | as  |
...
| conditions  |             |                     | that |             | affects      |        |              | these      |              |            | reaction |     |         |        | rates  |     |
| differently |             |                     | (a   | stress),    |              | then   |              | the        | rates        |            | are      |     | no      |        | longer |     |
| equal       | and         |                     | the  | system      |              | is not |              | at         | equilibrium. |            |          |     |         |        |        |     |
| The         | system      |                     |      | will        | subsequently |        |              |            |              | experience |          |     |         |        | a      | net |
...
| ------------- | --- | --- | --- | --- | ------- | --- | --- | --- | -------- | --- | ------------- | --- | --- | ----- | --- | --- |
| temperature   |     |     |     | are | the     |     | two |     | stresses |     | that          |     | can | shift |     | an  |
equilibrium.
...
| If   | an equilibrium |           |          | system |            | is subjected |     |     | to a      | change |          | in  |
| ---- | -------------- | --------- | -------- | ------ | ---------- | ------------ | --- | --- | --------- | ------ | -------- | --- |
| the  | concentration  |           |          | of     | a reactant |              |     | or  | product   |        | species, |     |
| the  | rate           | of either |          | the    | forward    |              | or  | the | reverse   |        | reaction |     |
| will | change.        |           |          |        |            |              |     |     |           |        |          |     |
...
| When      |         | this      |           | system |          |           | is       | at  | equilibrium, |                  |           | the       | forward   |        |         |         | and |
| --------- | ------- | --------- | --------- | ------ | -------- | --------- | -------- | --- | ------------ | ---------------- | --------- | --------- | --------- | ------ | ------- | ------- | --- |
| reverse   |         | reaction  |           |        | rates    |           | are      |     | equal.       |                  |           |           |           |        |         |         |     |
|           |         |           |           |        |          |           | Rate     |     |              | =Rate            |           |           |           |        |         |         |     |
|           |         |           |           |        |          |           |          |     | f            |                  | r         |           |           |        |         |         |     |
| If the    |         | system    |           | is     | stressed |           |          | by  |              | adding           | reactant, |           |           | either |         | H2      | or  |
| I2,       | the     | resulting |           |        |          | increase  |          |     |              | in concentration |           |           |           | causes |         |         | the |
| rate      | of      | the       | forward   |        |          |           | reaction |     |              | to increase,     |           | exceeding |           |        |         | that    | of  |
| the       | reverse |           | reaction: |        |          |           |          |     |              |                  |           |           |           |        |         |         |     |
|           |         |           |           |        |          |           | Rate     |     |              | >Rate            |           |           |           |        |         |         |     |
|           |         |           |           |        |          |           |          |     | f            |                  | r         |           |           |        |         |         |     |
| This      | same    |           | shift     |        | will     |           | result   |     |              | if some          | product   |           | HI        | is     | removed |         |     |
| from      | the     |           | system,   |        |          | which     |          |     | decreases    |                  | the       | rate      | of        | the    |         | reverse |     |
| reaction, |         |           | again     |        |          | resulting |          |     |              | in the           | same      |           | imbalance |        |         |         | in  |
rates.

7.3.2. Effect of a Change in Temperature
| When         | an           |          | equilibrium |     |       |              | shifts |                | in          | response       |             |      | to   | a   |
| ------------ | ------------ | -------- | ----------- | --- | ----- | ------------ | ------ | -------------- | ----------- | -------------- | ----------- | ---- | ---- | --- |
| temperature  |              |          | change,     |     |       | it           | is     | re-established |             |                |             | with |      | a   |
| different    |              | relative |             |     |       | composition  |        |                | that        |                | exhibits    |      |      | a   |
| different    |              | value    |             | for | the   | equilibrium  |        |                |             | constant.      |             |      |      |     |
| Predicting   |              |          | the         |     | shift |              | an     |                | equilibrium |                |             |      | will |     |
| experience   |              | in       | response    |     |       | to           | a      | change         |             | in temperature |             |      |      |     |
| is most      | conveniently |          |             |     |       | accomplished |        |                |             | by             | considering |      |      |     |
| the enthalpy |              |          | change      |     |       | of the       |        | reaction.      |             |                |             |      |      |     |

| For       | example, |     |     | the |             | decomposition |     |     |       |     |     | of         | dinitrogen |     |     |     |
| --------- | -------- | --- | --- | --- | ----------- | ------------- | --- | --- | ----- | --- | --- | ---------- | ---------- | --- | --- | --- |
| tetroxide |          | is  | an  |     | endothermic |               |     |     | (heat |     |     | consuming) |            |     |     |     |
process:
...
|      |          |        | Heat    +   N    |          |             | O      | (g)    =>   2NO |             |              | (g)  |        |      |            |       |      |     |
|      |          |        |                  |          |             | 2 4    |                 |             |              | 2    |        |      |            |       |      |     |
|      | Raising  |        | the              |          | temperature |        |                 |             |              | of   | the    |      | system     |       |      | is  |
|      | causing  |        |                  | to       | increasing  |        |                 |             | the          |      | amount |      |            |       | of   | a   |
|      | product, |        | and              |          | so          | the    | equilibrium     |             |              |      |        | will |            | shift |      | to  |
|      | the      | right. |                  |          |             |        |                 |             |              |      |        |      |            |       |      |     |
|      | Lowering |        |                  | the      |             | system |                 |             | temperature  |      |        |      |            |       | will |     |
23
...
| pressure  |          | is            | reduced. |             |             |             |     |          |       |           |            |     |          |        |       |      |        |
| Since     |          | the           | pressure |             |             | depends     |     |          |       | upon      |            | the |          | number |       |      | of     |
| moles,    |          | on increasing |          |             |             |             | the | pressure |       |           | the        |     | reaction |        |       | will |        |
| proceed   |          | in            | that     |             | direction   |             |     |          | where |           |            | the |          | number |       |      | of     |
| moles     | are      | reduced.      |          |             |             |             |     |          |       |           |            |     |          |        |       |      |        |
| If the    | pressure |               |          | at          | equilibrium |             |     |          |       | is        | decreased  |     |          |        | then  |      | the    |
| reaction  |          | will          |          | proceed     |             |             | in  | that     |       | direction |            |     |          |        | where |      | th24 e |
| number    |          | of            | moles    |             | is          | more.       |     |          |       |           |            |     |          |        |       |      |        |

â‡Œ
| For a general reaction, |     |     |     |     | mA  | + nB | xC + yD |
| ----------------------- | --- | --- | --- | --- | --- | ---- | ------- |
The effect of pressure is decided by âˆ†n.  âˆ†n = (x+y)-
(m+n)
If âˆ†n > 0, that means the total moles of products is greater than the
total moles of reactants. Lowering of pressure will favour the reaction
in forward direction. That is, more products will be formed at
| equilibrium |     | if the | pressure | is lowered. |     |     |     |
| ----------- | --- | ------ | -------- | ----------- | --- | --- | --- |
If âˆ†n < 0, that means the total moles of products is less than the total
moles of reactants. Increasing the pressure will favour the reaction in
forward direction. That is, more products will be formed at equilibrium
| if the | pressure |     | is increased. |     |     |     |     |
| ------ | -------- | --- | ------------- | --- | --- | --- | --- |
If âˆ†n = 0, then the change in pressure has no effect on the position of
25
equilibrium.

â‡Œ
âˆ†n =  2-(1+3) =  -2
| Therefore,  |     | an                   | increase |     | in      | pressure  | at  |
| ----------- | --- | -------------------- | -------- | --- | ------- | --------- | --- |
| equilibrium |     | will                 | favour   | the | forward | reaction. |     |
|             |     | N O (g)    =>    2NO |          | (g) |         |           |     |
|             |     | 2 4                  |          | 2   |         |           |     |
âˆ†n  = 2-(1)  =  1
| The     | decrease | in      | pressure  |     | at  | equilibrium, |     |
| ------- | -------- | ------- | --------- | --- | --- | ------------ | --- |
| favours | the      | forward | reaction. |     |     |              |     |

| A.      | Calculation |      |      | of an   | Equilibrium |           |     | Constant |       |            |     |      |
| ------- | ----------- | ---- | ---- | ------- | ----------- | --------- | --- | -------- | ----- | ---------- | --- | ---- |
| Example |             |      | 7.4: | Iodine  |             | molecules |     |          | react | reversibly |     | with |
| iodine  |             | ions | to   | produce |             | triiodide |     |          | ions. |            |     |      |
|         |             |      |      |         |             |           |     |          |       |            | [ I | âˆ’3 ] |
|         |             |      |      |         |             |           |     |          |       | K          | =   |      |
â‡Œ
|     |     |     |     |     |     |     |     |     |     | C   |       | âˆ’     |
...
|     |     |     |     |     |     |     |     |     |     |     | [ I ] | [ I ] |
2
If a solution with the concentrations of and both equal to 1x10-3M
...
|     | [ I ] [ I ] |     |     |     |     |     |     |     |     |
C
|     |     |     |     |     | 6 . 6 1 x | 1 0 âˆ’ 4 M | x 6 . 6 | 1 x 1 0 | âˆ’ 4 M |
| --- | --- | --- | --- | --- | --------- | --------- | ------- | ------- | ----- |
2
|     |     |     | K   | = 776 |     |     |     |     |     |
| --- | --- | --- | --- | ----- | --- | --- | --- | --- | --- |
...
|          |     |     |     |     |     | 2000 |     | 0c  |       |       |     |     |     |     |     |     |     |
| -------- | --- | --- | --- | --- | --- | ---- | --- | --- | ----- | ----- | --- | --- | --- | --- | --- | --- | --- |
| Example: |     |     |     | At  |     |      |     |     | , the | value |     | of  | the |     | Kc  | for | the |
4.1x10-4
|           |     |     | N   | (g) | +   | O   | (g) | â‡Œ   | 2NO(g) |     |     |     |     |           |     |     |     |
| --------- | --- | --- | --- | --- | --- | --- | --- | --- | ------ | --- | --- | --- | --- | --------- | --- | --- | --- |
| reaction, |     |     |     | 2   |     |     | 2   |     |        | ,   | is  |     | .   | Calculate |     |     | the |
1
| equilibrium |     |      |     |          | concentration |     |     |     |             | of             | NO(g) |     | in  |     | air   | at  | atm |
| ----------- | --- | ---- | --- | -------- | ------------- | --- | --- | --- | ----------- | -------------- | ----- | --- | --- | --- | ----- | --- | --- |
| pressure.   |     |      | The |          | equilibrium   |     |     |     |             | concentrations |       |     |     |     | of    | N2  | and |
|             |     |      |     |          |               |     |     |     |             |                |       |     |     |     | 0.036 |     | M   |
| O2          | at  | this |     | pressure |               |     |     | and | temperature |                |       |     |     | are |       |     | and |
| 0.0089      |     | M    |     |          |               |     |     |     |             |                |       |     |     |     |       |     |     |
respectively.
2
|     |     |     |     |     |     |     |     | [ N | O ] |     |     |     |     |     |     |     |     |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
âˆ’4
|     | [NO] |     |     | =   |     | (4.1x10 |     |     |     | )(0.036)(0.0089) |     |     |     |     |     |     |     |
| --- | ---- | --- | --- | --- | --- | ------- | --- | --- | --- | ---------------- | --- | --- | --- | --- | --- | --- | --- |
âˆ’4
|     |     |     |     |     |     | [NO] |     |     | = 3.6x10 |     |     |     | M   |     |     |     |     |
| --- | --- | --- | --- | --- | --- | ---- | --- | --- | -------- | --- | --- | --- | --- | --- | --- | --- | --- |

C. Calculation of Equilibrium Concentrations from Initial
Concentrations
| Example | 7.6: |     |       |         |             |     |     |             |     |          |     |     |
| ------- | ---- | --- | ----- | ------- | ----------- | --- | --- | ----------- | --- | -------- | --- | --- |
|         |      |     | Under | certain | conditions, |     | the | equilibrium |     | constant |     | Kc  |
for the decomposition of PCl (g) in to PCl (g) and Cl (g) is 0.0211.
|     |     |     |     |     | 5   |     | 3   |     | 2   |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
What are the equilibrium concentrations of PCl , PCl and Cl in a
|     |     |     |     |     |     |     |     | 5   | 3   |     | 2   |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
mixture that initially contained only PCl at a concentration of 1 M?
5
Solution:
â‡Œ
|         |     |     |     |     |     | 1 M |     |     |     |     |     | 0   |
...
| Example |      | 7.7: |          | What |     | are the | concentrations |     |     |     |     | at  | equilibrium |     |
| ------- | ---- | ---- | -------- | ---- | --- | ------- | -------------- | --- | --- | --- | --- | --- | ----------- | --- |
| of a    | 0.15 | M    | solution |      |     | of HCN? |                |     |     |     |     |     |             |     |
â‡Œ
Solution:
|     |     |     | [   | H + | ] [ C | N âˆ’ ] |     |     |     |     | x 2 |     |     |     |
| --- | --- | --- | --- | --- | ----- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|     |     | C   |     |     |     |           |     |     | C     |     |       |     |     |           |
|     |     |     |     | [ H | C N | ]         |     |     |       | 0   | . 1 5 | âˆ’ x |     |           |
|     | x   | ï€¼   | ï€¼ ï€¼ | 0   | . 1 | 5 , t h e | n ( | 0 . | 1 5 âˆ’ | x   | ) ï€   | 0   | . 1 | 5         |
2
x
|     |       |       | âˆ’ 1 | 0   |     |     |     |     |     |     |     |       |     |     |
| --- | ----- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----- | --- | --- |
...
| An  | Arrhenius |     |     | acid |     |     | dissociates |     |     | in  |     | water |     | to  | form |
| --- | --------- | --- | --- | ---- | --- | --- | ----------- | --- | --- | --- | --- | ----- | --- | --- | ---- |
+
| hydrogen |     | ions |     | (H  |     | ),  | while |     | an  |     | Arrhenius |     |     |     | base |
| -------- | --- | ---- | --- | --- | --- | --- | ----- | --- | --- | --- | --------- | --- | --- | --- | ---- |
-
| dissociates |     | in  | water |     |     | to  | form | hydroxide |     |     |     | ions | (OH |     | ).  |
| ----------- | --- | --- | ----- | --- | --- | --- | ---- | --------- | --- | --- | --- | ---- | --- | --- | --- |
Limitation:
|     | The        | Arrhenius |     |     |     |     | definitions |            |     |     | of  | acidity |     |         | and |
| --- | ---------- | --------- | --- | --- | --- | --- | ----------- | ---------- | --- | --- | --- | ------- | --- | ------- | --- |
|     | alkalinity |           |     |     |     | are |             | restricted |     |     |     | to      |     | aqueous |     |
solutions.
|     | Thus,    |     | the |       | Arrhenius |     |     |       | definition |     |     |     | can |         | only |
| --- | -------- | --- | --- | ----- | --------- | --- | --- | ----- | ---------- | --- | --- | --- | --- | ------- | ---- |
|     | describe |     |     | acids |           |     | and | bases |            |     | in  | an  |     | aqueous |      |
33
environment.

7.5.2. Brâˆ…nsted-Lowery Concept
| An  | acid |     | is a | proton |     |     | donor, |     |     | any |     | species |     | that |     | donates |     |
| --- | ---- | --- | ---- | ------ | --- | --- | ------ | --- | --- | --- | --- | ------- | --- | ---- | --- | ------- | --- |
+
| an  | H   | ion. |     |      |     |         |     |     |     |     |     |     |          |     |     |     |     |
| --- | --- | ---- | --- | ---- | --- | ------- | --- | --- | --- | --- | --- | --- | -------- | --- | --- | --- | --- |
|     | An  | acid |     | must |     | contain |     |     | H   | in  |     | its | formula; |     | HNO |     | and |
3
-
|     | H PO           |     | are |     | two    |     | examples, |           |     |     | all | Arrhenius |     |         | acids |     | are  |
| --- | -------------- | --- | --- | --- | ------ | --- | --------- | --------- | --- | --- | --- | --------- | --- | ------- | ----- | --- | ---- |
|     | 2              | 4   |     |     |        |     |           |           |     |     |     |           |     |         |       |     |      |
|     | BrÃ¸nsted-Lowry |     |     |     |        |     | acids.    |           |     |     |     |           |     |         |       |     |      |
| A   | base           |     | is  | a   | proton |     |           | acceptor, |     |     |     |           | any | species |       |     | that |
+
| accepts |          | an  |      | H   | ion.     |     |     |     |      |      |     |      |           |          |      |      |       |
| ------- | -------- | --- | ---- | --- | -------- | --- | --- | --- | ---- | ---- | --- | ---- | --------- | -------- | ---- | ---- | ----- |
|         | A base   |     | must |     | contain  |     |     | a   | lone | pair |     | of   | electrons |          | to   | bind | the   |
|         | H + ion; |     | a    | few | examples |     |     |     | are  | NH   |     | , CO | 2- ,      | F - , as | well |      | as OH |
|         |          |     |      |     |          |     |     |     |      |      | 3   |      | 3         |          |      |      |       |
-
.
|     | BrÃ¸nsted-Lowry |     |     |     |     |     | bases | are |     | not | Arrhenius |     |     | bases, |     | but | all |
| --- | -------------- | --- | --- | --- | --- | --- | ----- | --- | --- | --- | --------- | --- | --- | ------ | --- | --- | --- |
-
|     | Arrhenius |     |     | bases |     | contain |     |     | the | BrÃ¸nsted-Lowry |     |     |     |     | base |     | OH . |
| --- | --------- | --- | --- | ----- | --- | ------- | --- | --- | --- | -------------- | --- | --- | --- | --- | ---- | --- | ---- |

| The | concept |     | of conjugate |     |     | pairs |     | is  | useful | in  | describing |     |     |
| --- | ------- | --- | ------------ | --- | --- | ----- | --- | --- | ------ | --- | ---------- | --- | --- |
âˆ…
| Br         | nsted-Lowry |            |           | acid    |        | base    |     | reactions |         | (and         |           | other |     |
| ---------- | ----------- | ---------- | --------- | ------- | ------ | ------- | --- | --------- | ------- | ------------ | --------- | ----- | --- |
| reversible |             | reactions, |           | as      | well). |         |     |           |         |              |           |       |     |
|            | When        | an         | acid      | donates |        | H+,     | the | species   |         | that         | remains   |       | is  |
|            | called      | the        | conjugate |         | base   | of      | the | acid      | because |              | it reacts |       | as  |
|            | a proton    |            | acceptor  | in      | the    | reverse |     | reaction. |         |              |           |       |     |
...
| --------- | ---- | ---------- | ---- | ----- | ----------- | ---- |
| acceptor, | and  | a Lewis    | base | as    | an electron | pair |
donor.
Examples of Lewis Acids: H+, K+, Mg2+, Fe3+, BF3, , AlCl , Br .
3 2
Examples of Lewis Bases: OH-, F-, H O, NH , SO 2-, H-, CO, C H .
|     |     |     |     | 2   | 3 4 | 6 6 |
| --- | --- | --- | --- | --- | --- | --- |

| Lewis            |           | Acid:        | a         | species |        |      | that     |          | accepts  |          | an     |      | electron   |           |     | pair     | (i.e., |     |
| ---------------- | --------- | ------------ | --------- | ------- | ------ | ---- | -------- | -------- | -------- | -------- | ------ | ---- | ---------- | --------- | --- | -------- | ------ | --- |
| an electrophile) |           |              |           |         | and    |      | will     |          | have     |          | vacant |      |            | orbitals, |     |          | or the |     |
| ability          |           | to form      |           | a       | vacant |      |          |          | orbital. |          |        |      |            |           |     |          |        |     |
| Lewis            |           | Base:        | a         | species |        |      | that     |          | donates  |          | an     |      | electron   |           |     | pair     | (i.e., |     |
| a nucleophile)   |           |              |           | and     |        | will |          | have     |          | lonepair |        |      | electrons. |           |     |          |        |     |
| In a             | Lewis     |              | Acid-Base |         |        |      |          | reaction |          |          | a      | bond |            | is formed |     |          | where  |     |
| both             | electrons |              |           | come    |        |      | from     |          | the      |          | Lewis  |      | base,      |           | and |          | this   | is  |
| called           |           | a Coordinate |           |         |        |      | Covalent |          |          |          | bond   | (or  |            | dative    |     | covalent |        |     |
bond).
Lewis Acids: There are three general types of Lewis Acids, that is,
| chemical |     | species |     | that | can |     | accept |     | electrons. |     |     |     |     |     |     |     |     |     |
| -------- | --- | ------- | --- | ---- | --- | --- | ------ | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
A.Incomplete Octets
| Boron  | Trifluoride | is  an exception  |     | to the  | octet  | rule  |
| ------ | ----------- | ----------------- | --- | ------- | ------ | ----- |
and has an incomplete octet, and can thus accept
electrons to form a bond.
|                                |     |     | 2            |     | 3        |     |
| ------------------------------ | --- | --- | ------------ | --- | -------- | --- |
| In the process it goes from sp |     |     | hybrid to sp |     | hybrid.  |     |

B. Double Bonds
| A double    |         | bond    |            | has      | 4 electrons |     |       |      | shared |     | between |     |           | 2         | atoms     |      | in   |
| ----------- | ------- | ------- | ---------- | -------- | ----------- | --- | ----- | ---- | ------ | --- | ------- | --- | --------- | --------- | --------- | ---- | ---- |
| a PI        | and     | sigma   |            | orbital. |             |     |       |      |        |     |         |     |           |           |           |      |      |
| If you      | break   |         | the        | pi       | bond        |     | and   | move |        |     | the     | two |           | electrons |           |      | to a |
| non-bonding |         |         |            | orbital  |             | on  | one   |      | atom,  |     |         | the |           | other     |           | atom |      |
| develops    |         | an      | incomplete |          |             |     | octet |      | and    |     | can     |     | function  |           |           | as   | a    |
| Lewis       | acid.   |         |            |          |             |     |       |      |        |     |         |     |           |           |           |      |      |
| This        | is      | shown   |            | next     | figure      |     | where |      |        | the |         | pi  | electrons |           |           | move |      |
| onto        | the     | oxygen, |            | allowing |             |     | the   |      | sulfur |     |         | to  | receive   |           | electrons |      |      |
| from        | a Lewis |         | base.      |          |             |     |       |      |        |     |         |     |           |           |           |      |      |

C. Metal Cations
| Many         | metals |       |               | have   |         | vacant     |       |      | d-orbitals |           |        | that      | can  | accept |     |
| ------------ | ------ | ----- | ------------- | ------ | ------- | ---------- | ----- | ---- | ---------- | --------- | ------ | --------- | ---- | ------ | --- |
| electrons    |        | and   | thus          |        | behave  |            |       | as   | Lewis      |           | Acids. |           |      |        |     |
| In fact,     |        | most  |               | metals |         |            | react |      |            | with      |        | water     | when | they   |     |
| dissolve     | in     | water |               |        | to form |            |       | what |            | is called |        | a complex |      | ion.   |     |
| For example, |        |       | aluminum(III) |        |         |            |       |      |            | is        | not    | a free    | ion, | but    | a   |
| complex      |        | with  | 6             | water  |         | molecules. |       |      |            |           |        |           |      |        |     |
...
| --------- | ---------- | --- | --- | --- | -------- | ----- | ------------- | --- | --- | --- |
| hydronium |            |     | ion | [H  | O + ]    | molar | concentration |     |     | in  |
3
mol/L.
|     |     |             |     |     | +           |     | +   |     |     |     |
| --- | --- | ----------- | --- | --- | ----------- | --- | --- | --- | --- | --- |
|     |     | pH = -log[H |     |     | ] = -log [H |     | O   | ]   |     |     |
3
| The        | hydronium |     |             |     | ion      | molarity |     | yields |     | the |
| ---------- | --------- | --- | ----------- | --- | -------- | -------- | --- | ------ | --- | --- |
...
| pOH       | of  | a   | solution |           |     | is defined |     |       | as  |     | the           | negative |     |
| --------- | --- | --- | -------- | --------- | --- | ---------- | --- | ----- | --- | --- | ------------- | -------- | --- |
| logarithm |     | of  | the      | hydroxide |     |            | ion | molar |     |     | concentration |          |     |
in mol/L.
-
|     |           |     |     | pOH |          | = -log[OH |     |        | ]   |     |            |     |     |
| --- | --------- | --- | --- | --- | -------- | --------- | --- | ------ | --- | --- | ---------- | --- | --- |
...
| ------- | ------ | ----------- | --- | -------- | --- | -------- | ---- | ----------------- | --- | --- | --- | --- | ---- |
|         |        |             |     |          | [HO | ] = 10   |      |                   |     |     |     |     |      |
| From    | the    | definitions |     |          |     | of pH    |      | and               | pOH |     | and | the | ion- |
| product | of     | water,      |     |          |     |          |      |                   |     |     |     |     |      |
|         |        |             |     | pH + pOH |     |          | = 14 |                   |     |     |     |     |      |
...
|     |       |     |     |     |       | w    |     | 3       |     |     |       |       |           |
|     |       |     |     |     |       |      |     |         |     | +   |       |       | âˆ’         |
|     |       | âˆ’   | l o | g K | =     | âˆ’    | l o | g ( [ H | O   |     | ] [ O | H     | ] )       |
|     |       |     |     |     | w     |      |     |         | 3   |     |       |       |           |
|     |       |     |     |     |       |      |     | +       |     |     |       |       | âˆ’         |
|     | âˆ’ l o | g   | K   | =   | ( âˆ’ l | o g  | [ H | O       | ] ) | + ( | âˆ’     | l o g | [ O H ] ) |
|     |       |     | w   |     |       |      |     | 3       |     |     |       |       |           |
|     |       |     |     |     | p K   |      | =   | p H     | +   | p   | O     | H     |           |
w
...
Example 7.8: What is th pH of stomach acid, a solution of HCl with
| a   | hydronium |     |     | ion | concentration |     |       |     |     | of 1.2x10-3 |     | M?  |     |     |     |       |     |     |     |     |
| --- | --------- | --- | --- | --- | ------------- | --- | ----- | --- | --- | ----------- | --- | --- | --- | --- | --- | ----- | --- | --- | --- | --- |
|     |           |     |     |     |               |     |       |     |     |             |     |     |     |     |     |       |     | âˆ’   | 3   |     |
|     |           |     |     |     |               |     |       |     |     | âˆ’           | p H | =   | âˆ’   | l o | g ( | 1 . 2 | x 1 | 0   | M   | )   |
|     |           |     | p   | H   | =             | âˆ’ l | o g [ | H   | O   | ]           |     |     |     |     |     |       |     |     |     |     |
Solution:
3
|         |     |     |      |     |           |     |     |      |     | p         | H   | =   | 2   | . 9 | 2             |     |     |     |     |     |
| ------- | --- | --- | ---- | --- | --------- | --- | --- | ---- | --- | --------- | --- | --- | --- | --- | ------------- | --- | --- | --- | --- | --- |
|         | p   | H = | 3    | âˆ’   | l o g     | 1 . | 2   |      |     |           |     |     |     |     |               |     |     |     |     |     |
| Example |     |     | 7.9: |     | Calculate |     |     | the  |     | hydronium |     |     |     | ion | concentration |     |     |     |     | of  |
| blood,  |     | the | pH   | of  | which     |     | is  | 7.3. |     |           |     |     |     |     |               |     |     |     |     |     |
|         |     |     |      |     |           |     |     |      |     |           |     | 7.3 |     | = âˆ’ | log[H         |     |     | O   | âˆ’ ] |     |
âˆ’
|     |     |     |     | pH  | =   | âˆ’   | log[H |     | O   | ]   |     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| The        | relative       | strength   |      |          | of an     | acid                    | or          | base          | is the    | extent |        | to  |
| ---------- | -------------- | ---------- | ---- | -------- | --------- | ----------------------- | ----------- | ------------- | --------- | ------ | ------ | --- |
| which      | it ionizes     |            | when |          | dissolved |                         | in          | water.        |           |        |        |     |
| If         | the ionization |            |      | reaction |           | is                      | essentially |               | complete, |        |        | the |
| acid       | or base        |            | is   | termed   |           | strong;                 |             | if relatively |           |        | little |     |
| ionization |                | occurs,    |      | the      | acid      | or base                 |             | is weak.      |           |        |        |     |
|            | Strong Acids   |            |      |          |           | Strong Bases            |             |               |           |        |        |     |
|            | Perchloric     | Acid, HClO |      |          |           | Lithium Hydroxide, LiOH |             |               |           |        |        |     |
4
...
2
|     | Nitric Acid, HNO |     |     |     |     | Strontium Hydroxide, Sr(OH) |     |     |     |     |     |     |
| --- | ---------------- | --- | --- | --- | --- | --------------------------- | --- | --- | --- | --- | --- | --- |
|     |                  |     | 3   |     |     |                             |     |     |     | 2   |     |     |
|     | Sulfuric Acid, H |     |     | SO  |     | Barium Hydroxide, Ba(OH)    |     |     |     |     |     |     |
|     |                  |     | 2   | 4   |     |                             |     |     | 2   |     |     |     |

| The             | relative    |            |     | strengths    |      |         | of             | acids |             |      | or  |      | bases     | may    |        | be    |
| --------------- | ----------- | ---------- | --- | ------------ | ---- | ------- | -------------- | ----- | ----------- | ---- | --- | ---- | --------- | ------ | ------ | ----- |
| quantified      |             |            | by  | measuring    |      |         | their          |       | equilibrium |      |     |      | constants |        |        | in    |
| aqueous         |             | solutions. |     |              |      |         |                |       |             |      |     |      |           |        |        |       |
| In              | solutions   |            | of  | the          | same |         | concentration, |       |             |      |     |      | stronger  |        |        | acids |
| ionize          |             | to         | a   | greater      |      | extent, |                |       | and         |      |     | so   | yield     |        | higher |       |
| concentrations  |             |            |     | of hydronium |      |         |                | ions  |             | than |     | do   | weaker    |        | acids. |       |
| The             | equilibrium |            |     | constant     |      |         | for            | an    | weak        |      |     | acid | is        | called |        | the   |
| acid-ionization |             |            |     | constant,    |      |         | K              | .     | For         |      | the |      | reaction  |        | of     | an    |
a
| acid | HA: |     |     |     |     |     |     |     |     |     |     |     |     |     |     |     |
| ---- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|      |     |     |     |     |     |     |     |     | +   |     | âˆ’   |     |     |     |     |     |
...
| The    | equilibrium |                 |     | constant | for       | an  | weak | Base      | is  |
| ------ | ----------- | --------------- | --- | -------- | --------- | --- | ---- | --------- | --- |
| called | the         | Base-ionization |     |          | constant, |     | K    | . For the |     |
b
| reaction |     | of an | acid | B:  |     |     |     |     |     |
| -------- | --- | ----- | ---- | --- | --- | --- | --- | --- | --- |
â‡Œ
|     |     |     |     |       | +     | âˆ’   |     |     |     |
| --- | --- | --- | --- | ----- | ----- | --- | --- | --- | --- |
...
| Another     |             | measure |             | of     | the | strength   |             | of an | acid | or base |
| ----------- | ----------- | ------- | ----------- | ------ | --- | ---------- | ----------- | ----- | ---- | ------- |
| is          | its percent |         | ionization. |        |     |            |             |       |      |         |
| The         | percent     |         | or          | degree | of  | ionization |             | of a  | acid | or base |
| is          | defined     |         | in          | terms  |     | of the     | composition |       |      | of an   |
| equilibrium |             |         | mixture:    |        |     |            |             |       |      |         |
|             |             |         |             |        |     | [ H        | O +         | ]     |      |         |
3
|     | %   | i o n i | z a t | i o n = | ï¡   | =   |     | x 1 | 0 0 |     |
| --- | --- | ------- | ----- | ------- | --- | --- | --- | --- | --- | --- |
[ H A ]
âˆ’
|     |     |       |       |         |     | [ O | H   | ]   |     |     |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----- | --- | --- | ----- | --- | ------- | --- |
|     | a   |     |     |     |     |     |     |     |     | a   |     |       |     |     |       |     |         |     |
|     |     |     | [   | H C | N O | ]   |     |     |     |     | 0   | . 1   | âˆ’ x |     | 0 . 1 |     |         |     |
|     |     |     | x   | = [ | H   | +   | ] = | [ C | N O | âˆ’ ] | =   | 0 . 0 | 0   | 4 5 | M     |     |         |     |
+
|     | [H  |     | O   | ]   |     |     |     |     |     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
0.0045M
...
| Example |     | 7.11: |     |     | Calculate |     |     | the |     | OH- | ion |     | conc. | in  | 0.4 | M NH |
| ------- | --- | ----- | --- | --- | --------- | --- | --- | --- | --- | --- | --- | --- | ----- | --- | --- | ---- |
3
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
+ âˆ’ 5
|     |     | [ N | H   | ]   | [ O | H âˆ’ ] |     | K   | =   |     |     |     | =   |       | =   | 1 . 8 x 1 0 |
| --- | --- | --- | --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- | --- | ----- | --- | ----------- |
|     | K   | =   |     | 4   |     |       |     |     | b   |     |     |     |     |       |     |             |
|     |     |     |     |     |     |       |     |     |     | 0   | . 4 | âˆ’ x |     | 0 . 4 |     |             |
|     | b   |     | [   | N H | ]   |       |     |     |     |     |     |     |     |       |     |             |
3
|     |     |     |     | x   | =   | [ O | H âˆ’ | ] = | 2   | . 7 x | 1 0 | âˆ’ 3 | M   |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- |
âˆ’
|     |     | [OH |     | ]   |      |     |     |     |        |     |     |     |     |      |     |        |
| --- | --- | --- | --- | --- | ---- | --- | --- | --- | ------ | --- | --- | --- | --- | ---- | --- | ------ |
...
| --- | --------- | --- | ------- | ---------- | --- | ---- | --- | --- | -------- | --- | --- | -------- | --- | --- | --- | --- | --------- | --- | --- |
|     | dissolved |     |         | compounds? |     |      |     |     |          |     |     |          |     |     |     |     |           |     |     |
Example 7.12: - Both CH COONa and CH COOH are in solution and
|     |     |     |     |     |     |     | 3   |     |     |     |     | 3   |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
COO-
| they | dissociate |     |     |     | and | ionize |     | to produce |     |     | CH  |     | ions: |     |     |     |     |     |     |
| ---- | ---------- | --- | --- | --- | --- | ------ | --- | ---------- | --- | --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- |
3
...
|     |     |        | CH  |       | COOH |      |         |                   |               | CH  | COO - |       |        | +  H+  |     |              |     |     |     |
|     |     |        |     | 3     |      | (aq) |         |                   |               |     | 3     |       | (aq)   |        |     | (aq)         |     |     |     |
|     | CH  | COONa  |     |       | is   | a    | strong  |                   | electrolyte,  |     |       |       |        | so     | it  | dissociates  |     |     |     |
3
completely in  solution, but  CH COOH,  a weak  acid,  ionizes
3
partially.
...
| ------ | ------------ | --- | ------------------------- | --- | --- | --- | --- | ---------- | --- |
| 3      |              |     | 3                         |     |     |     |     | 3          |     |
suppress the  ionization  of  CH COOH,  that  is,  shifts  the
3
+
| equilibrium  |     | to  the  | left | there  | by  | decreasing |     | the  | H ion  |
| ------------ | --- | -------- | ---- | ------ | --- | ---------- | --- | ---- | ------ |
concentration.
Thus,  a  solution  containing  both  CH COOH  and  CH COONa
|                                                        |     |     |     |     |     | 3   |     |     | 3     |
| ------------------------------------------------------ | --- | --- | --- | --- | --- | --- | --- | --- | ----- |
| will be less acidic than a solution containing only CH |     |     |     |     |     |     |     |     | COOH  |
3
at the same concentration.
The  shift  in  equilibrium  of  the  CH COOH  ionization  is
3
-
| caused by the additional acetate, CH |     |     |     |     |     | COO | , ions which comes  |     |     |
| ------------------------------------ | --- | --- | --- | --- | --- | --- | ------------------- | --- | --- |
3
from the salt.
...
| It is    |     | a solution |          |     | that     |     | has |         | the | ability |          |         | to  | resist   |     | change |      |     |
| -------- | --- | ---------- | -------- | --- | -------- | --- | --- | ------- | --- | ------- | -------- | ------- | --- | -------- | --- | ------ | ---- | --- |
| in       | pH  | up         | on       | the | addition |     |     |         | of  | small   |          | amounts |     |          | of  | either |      |     |
| acid     | or  |            | base.    |     |          |     |     |         |     |         |          |         |     |          |     |        |      |     |
|          |     | Buffer     |          |     | solution |     |     | is      | a   |         | solution |         |     | of       | a   | weak   |      |     |
|          |     | acid/weak  |          |     | base     |     | and |         | its | salt.   |          |         |     |          |     |        |      |     |
| A buffer |     |            | solution |     | must     |     |     | contain |     |         | an       | acid    |     | to react |     |        | with |     |
-
| OH  | ions |     | that |     | may | be  | added |     |     | to  | it  | and |     | a base | to  | react |     |     |
| --- | ---- | --- | ---- | --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- | ------ | --- | ----- | --- | --- |
+
| with           |     | any | added |     | H         | ions. |         |     |     |     |      |            |     |       |     |     |     |     |
| -------------- | --- | --- | ----- | --- | --------- | ----- | ------- | --- | --- | --- | ---- | ---------- | --- | ----- | --- | --- | --- | --- |
| Furthermore,   |     |     |       | the | acid      |       | and     |     | the |     | base | components |     |       |     | of  | the |     |
| buffer         |     |     | must  |     | not       |       | consume |     |     |     | each |            |     | other |     | in  |     | a   |
| neutralization |     |     |       |     | reaction. |       |         |     |     |     |      |            |     |       |     |     | 57  |     |

Buffer solution
Types of buffer solution
| a.  | Acidic buffer:          | CH  | COOH and CH  |       | COONa |
| --- | ----------------------- | --- | ------------ | ----- | ----- |
|     |                         |     | 3            |       | 3     |
| b.  | Basic buffer:           |     | NH OH and NH |       | Cl    |
|     |                         |     | 4            |       | 4     |
| c.  | Salt or neutral buffer: |     | CH           | COONH |       |
|     |                         |     |              | 3     | 4     |

Now, to find the pH, Let us consider
â‡Œ
|     |     |     |     |         |       |     | Since |     | CH  |     | COOH |     | is parially |     |
| --- | --- | --- | --- | ------- | ----- | --- | ----- | --- | --- | --- | ---- | --- | ----------- | --- |
|     |     |     | +   |         |       | âˆ’   |       |     |     | 3   |      |     |             |     |
|     | [   | H O |     | ] [ C H | C O O | ]   |       |     |     |     |      |     |             |     |
â€“
...
| 3   |     |     |     | a   |       |             |     |                          |     |     |     |     |     |     |
|     |     |     |     | [ C | H C O | O âˆ’ ]       |     |                          |     |     |     |     |     |     |
|     |     |     |     |     | 3     |             |     | Taking log of both sides |     |     |     |     |     |     |
|     |     |     |     |     |       | [ A c i d ] |     |                          |     |     |     |     |     |     |
+
| âˆ’ l o | g [ H | O   | ] = | âˆ’ l o g | K âˆ’ l o | g   |     |     |     |     |     |     |     |     |
| ----- | ----- | --- | --- | ------- | ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
SeScteicotni o2n2. 1 Classification of Hydrocarbons
...
| --- | --- | --- | --- | --- | --- |
of I
The first step is to write the straight-chain structure
|     | H   | C   | C C | C   | C H |
| --- | --- | --- | --- | --- | --- |
| I i |     | H   | H H | H   | H   |
I
...
|     |     |     | ( b . p . 3 | 6 . 1 C ) |     |
| --- | --- | --- | ----------- | --------- | --- |
The second structure, by necessity, must be a branched
chain:
...
| â–ª At | a high         | temperature, |     |      | alkanes | react | vigorously |     |
| ---- | -------------- | ------------ | --- | ---- | ------- | ----- | ---------- | --- |
| and  | exothermically |              |     | with | oxygen. |       |            |     |
â–ª Basis for use as fuels.
2 C H ( g )   +   1 3 O ( g )   â†’   8 C O ( g )   +   1 0 H O ( g )
| 4   | 1 0 |     | 2   |     |     | 2   |     | 2   |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --------- | --- | --- | ------- | ----- | -------- | ------- | --- | -------- | --- | ------ | ------- |
| hydrogen  |     |     | atoms.  |       |          |         |     |          |     |        |         |
|           | CH  |     |  + Cl   |       |   âŽ¯âŽ¯â†’ hv |  CH     |     | Cl + HCl |     |        |         |
|           |     | 4   |         | 2     |          |         |     | 3        |     |        |         |
|           | CH  |     | Cl + Cl |       |   âŽ¯âŽ¯â†’ hv |         |  CH |          | Cl  |  + HCl |         |
|           |     | 3   |         |       | 2        |         |     |          | 2   | 2      |         |
hv
|     | CH  |     | Cl  + Cl |     |   âŽ¯âŽ¯â†’ |     |     |  CHCl |     |  + HCl |     |
| --- | --- | --- | -------- | --- | ----- | --- | --- | ----- | --- | ------ | --- |
|     |     | 2   | 2        |     | 2     |     |     |       |     | 3      |     |
hv
|     | CHCl |     |  + Cl |     |   âŽ¯âŽ¯â†’ |     |  CCl |     |     |  + HCl |     |
| --- | ---- | --- | ----- | --- | ----- | --- | ---- | --- | --- | ------ | --- |
|     |      |     | 3     |     | 2     |     |      |     | 4   |        |     |
...
â–ª
| Hydrogen | atoms |             | are | removed |              | and | the |
| -------- | ----- | ----------- | --- | ------- | ------------ | --- | --- |
| product  | is an | unsaturated |     |         | hydrocarbon. |     |     |
...
SeScteicotni o2n2. 1 Cycloalkanes
Alkan8e.s1: Saturated Hydrocarbons
...
â–ª Addition of halogen atoms of alkenes and alkynes.
...
hydrocarbons.
â–ª
| Simplest |     | of  | these | is benzene |     | (C  | H ). |     |     |
| -------- | --- | --- | ----- | ---------- | --- | --- | ---- | --- | --- |
6 6
ï°
â–ª
| The     | delocalization |             |      | of     | the          | electrons   |     | makes |     |
| ------- | -------------- | ----------- | ---- | ------ | ------------ | ----------- | --- | ----- | --- |
| the     | benzene        |             | ring | behave |              | differently |     | from  | a   |
| typical |                | unsaturated |      |        | hydrocarbon. |             |     |       |     |

SeScteicotni o2n2. 3
Arom8a.3tic Hydrocarbons
Benzene
(Aromatic
Hydrocarbon)
...
SeScteicotni o2n2. 3
Arom8a.3tic Hydrocarbons
â–ª Unsaturated hydrocarbons generally undergo rapid
addition reactions, but benzene does not.
â–ª Benzene undergoes substitution reactions in which
...
SeScteicotni o2n2. 4
Hydr8o.c4arbon Derivatives
â–ª
| Molecules    |     | that  | are    | fundamentally |            |       |     |
| ------------ | --- | ----- | ------ | ------------- | ---------- | ----- | --- |
| hydrocarbons |     | but   | have   | additional    |            | atoms | or  |
...
Alcohols: contain the hydroxyl functional
group and have the general formula Râˆ’OH.
group and have the general formula Râˆ’OH.

Ethers have the general formula Râˆ’Oâˆ’Râ€².
Condensation Reaction
H SO
2 4
| CH OH + HOCH |            | CH OCH | + H | O   |
| ------------ | ---------- | ------ | --- | --- |
| 3            | 3 catalyst | 3      | 3   | 2   |
...
| Carboxylic        | acids | contain | the carboxyl | ( âˆ’COOH | )   |
| ----------------- | ----- | ------- | ------------ | ------- | --- |
| functional group. |       |         |              |         |     |

| Esters | have          | the general |        | formula | Râ€²COOR, | where |
| ------ | ------------- | ----------- | ------ | ------- | ------- | ----- |
