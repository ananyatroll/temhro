...
their
development,  and  contemporary  variations,  wherever  and  whenever
...
îŽ¢ Anthropology  is  a  broad  scientific  discipline  dedicated  to
...
î¶  Analyses  the  material  and  non-material  products  of  social
groups

îŽ¢ Anthropology  is  an  understanding  of  culture,  society  and  humanity
life,  supplemented  by

through  detailed  studies  of  community
comparison.

îŽ¢ Anthropology offers two kinds of insight.

î¼First, knowledge about the biological and cultural variations
î¼ Second, methods and theoretical perspectives
1.2. The Historical Development of Anthropology
o Anthropology has its roots in the works and ideas of the great ancient
...
philosophical  movement  that    emphasized  human  progress  and    based  on
the Darwinian theory of Evolution.

î˜ Anthropology did not arise as a science until the 1850s,
î˜ Anthropological  research  in  its  present-day  sense  only  commenced
...
îŽ¢ During  the  1870s  and  1880s  anthropology  became  a  profession
...
îŽ¢ Ethnography  provides  a  comprehensive  account  of  a  particular

community, society or culture.

îŽ¢ It describes the features of specific cultures in as much detail as possible
including local behavior, beliefs, customs, social life, economic activities,
politics, and religion.
îŽ¢ Ethnographies  are
...
îŽ¢ During  ethnographic  fieldwork  -  anthropologists  gathers,  organizes,
describes,  analyzes,  and  interprets  data  to  build  and  present  an
account in the form of a book, article, or film.

îŽ¢ Ethnology  -  the  comparative  understanding  and  analysis  of  different
...
îŽ¢ Ethnologists use ethnographic data to compare and contrast and to make

generalizations about society and culture.

îŽ¢ The  primary  objective  of  ethnology
...
intensive level since the late 1950s.

1.3. Scope and Subject Matter of Anthropology
îŽ¢ Anthropology is a broad discipline in terms of;

î˜Area  Coverage  -  from  Arctic  to  Desert,  from  Megapolis  to  hunting  gathering

areas

î˜ Time Coverage - covers the past, the present and even the future
î˜Issues  coverage  -  covers  all  aspects  of  human  ways  of  life  experiences  and
...
îŽ¢ Anthropologists  strive  to  understand  the  biological  and  cultural

origins and evolutionary development of humans.

îŽ¢ All  humans,  past  and  present,  as  well  as  their  behavior  patterns,

thought systems, and material possessions.

1.4. Sub-fields of Anthropology
1.4.1. Physical/Biological Anthropology
îŽ¢ Study  how  culture  and  environment  influenced  biological  evolution

and contemporary variations.

îŽ¢ Human biology affects some aspects of human behavior and culture
like marriage patterns, sexual division of labor, gender ideology etc.

îŽ¢ Culture

in  turn  have  biological  effects
...
îŽ¢ Physical anthropology concerned with two broad areas of investigation: human

evolution and genetics.

îŽ¢ Human evolution is the study of the gradual processes of simple forms into more

differentiated structures

îŽ¢ Human evolution further divided into three special sub-fields:
îŽ¢ Paleoanthropology: the study of human evolution through the analysis of fossil

remains.

îŽ¢ Primatology:  the study of the biology and behavior of primates.
îŽ¢ Anthropometry:  the  study  of  human  variations  within  and  among  different
populations in time and space - in terms of skin colors, skull shape, facial shape,
hair texture, and the like.

îŽ¢ Evolution,  key  concept  in  Physical  Anthropology,  with  comparative  approach
allows  to  address  fundamental  questions  regarding  our  distant  origin,  current
...
îŽ¢ It  focuses  to  examine  the  genetic  materials  of  an  organism  such  as  DNA  and

RNA.

îŽ¢ Human  biology  and  culture  have  evolved  over  millions  of  years  and  they  will

continue to evolve together.

îŽ¢ Human biology affects human culture and vice versa.
îŽ¢ Anthropologists  use  the  term  bio-cultural  to  describe  the  dual  nature  of  human

evolution: biological and cultural dimensions

 The Bio-cultural Animal
îŽ¢ Humanity  evolves  as  a  result  of  biological  and  cultural  factors  -  bio-cultural

evolution.

îŽ¢ For  example,  the  earliest  use  of  stone  tools  corresponds  with
...
î˜Relatively large brains for primates of our size;
î˜Using modern language to communicate ideas; and
î˜Using complex sets of ideas called culture to survive.

Origin of the Modern Human Species: Homo Sapiens Sapiens
îŽ¢ One  of  the  major  questions  anthropologists  grapple  with  is  the  origins  of

humankind.

îŽ¢ Theories  concerning  the  evolution  of  life  date  back  to  the  ancient  Greeks,  but  it
was only during the 19th century that the first comprehensive theories of evolution
were developed.

îŽ¢ The  most  profound  questions  are;  Where  did  we  come  from?  Why  are  we  here?

What is our place in the universe?

îŽ¢ Explanations that provide answers to these fundamental questions include;
Cosmologies and Human Origins
îŽ¢ Cosmologies  -  supernatural  beings  or  forces  formed  human  beings  and  the  planet
...
îŽ¢ In  Western  cultural  traditions,  the  ancient  Greeks  had  various  mythological
...
îŽ¢ The most important cosmological tradition affecting Western views of creation is -
...
îŽ¢ Evolution refers to a process and gradual change in species over time.

îŽ¢ It is used to describe the cumulative effects of three independent facts and these

attributes can be observed in nature every day.

îŽ¢ They are:

î¶ Replication: life forms have offspring;
î¶ Variation:  each  offspring  is  slightly  different  from  its  parents,  and  its  siblings;

and

î¶ Selection: not all offspring survive, only the ones best suited to their environment

.

îŽ¢ The prominent person to this development is Charles Darwin (1809-1882) - known
...
î¼ Where and when did we fist appear?
î¼ What were our ancestors like?
î¼ Can we learn about human behavior from the behavior of our nearest relatives,
...
îŽ¢ The ways of lives of past peoples by excavating and analyzing the material
culture/physical remains (artifacts, features and eco -facts) they left behind.
îŽ¢ Artifacts  are  material  remains  made  and  used  by  the  past  peoples  -  tools,
...
îŽ¢ Archaeological features include such things as house foundations, ancient

buildings, fireplaces, steles, and postholes.

îŽ¢ Eco-facts  are  organic  and  environmental  remains  such  as  soil,  animal
bones,  and  plant  remains  that  were  not  made  or  altered  by  humans;  but
were used by them.

îŽ¢ Eco-facts  provide  important  data  concerning  the  environment  and  how

people used natural resources in the past.

îŽ¢ Archaeology has two major areas of specialties or sub-fields
îŽ¢ Prehistoric  archaeology:  investigates  human  prehistory  and  prehistoric

cultures.

îŽ¢ It focuses on the period between 6,000 years ago and the time of the first
stone tools (the first artifacts), around 2.5 million years ago - prehistory.
14
îŽ¢ Historic archaeology: reconstruct the cultures of people who used writing
...
îŽ¢ Ethiopian have very glorious past.

îŽ¢ Archaeological  findings  showed  that  our  county  belonged  to  those  countries

which have old civilization.

1.4.3. Linguistic Anthropology
îŽ¢ It  studies  human  language  as  a  cultural  resource  and  speaking  as  a  cultural

practice in its social and cultural context, across space and time.
îŽ¢ Language is a system of information transmission and reception.
îŽ¢ Humans communicate messages by;

î¶  Sound (speech),
î¶  Gesture (body language), and
î¶  Visual ways such as writing.
...
îŽ¢ Every culture has a distinctive language with its own structure and set of rules for
...
îŽ¢ In any language, certain cultural aspects that are emphasized are reflected in the

vocabulary.

îŽ¢ Cultural  linguists  explore  how  different  linguistic  categories  can  affect  how
people  categorize  their  experiences,  how  they  think,  and  how  they  perceive  the
world around them.

îŽ¢ Historical  linguistics:-  the  emergence  of  language  and  how  specific  languages
...
îŽ¢ Language is a key to explore and transmit culture.
1.4.4. Socio-Cultural Anthropology
îŽ¢ It is the largest sub-fields of anthropology
îŽ¢ It deals with human society and culture
îŽ¢ Society is the group of people who have similar ways of life, but culture is
...
îŽ¢ It studies the social (human relations), symbolic or nonmaterial (religious,
language,  and  any  other  symbols)  and  material  (all  man-made  objects)
lives of living peoples.

îŽ¢ Socio-cultural anthropologists engage in two aspects of study: Ethnography
...
Uses data collected by other researchers
...
îŽ¢ Socio-cultural  anthropology  uses  ethnographical  and  ethnological
...
1.5. Unique Features of Anthropology
îŽ¢ Several  distinguishing  characteristics

identify  anthropology  from  other

discipline.
î˜Broad Scope

î¼Interested  in  all  human  beings  contemporary  or  past,  ''primitive''  or  ''

civilized''
î¼Interested

in  different  aspects  of  humans

lives,
marriages,  political  systems,  economic  lives,  technology,  belief,  health
care systems, personality types, and languages.

including  family

î˜Unique Approach

î¼Holistic  - looks any phenomena from different vantage points.
î¼Comparative  -  understand  differences  and  similarities  across  time  and
...
î˜ Method of Research: qualitative research methods such as extended fieldwork,
focus  group  discussion,  participant  observation,  in-depth  and  key  informant
interviews.

1.6. Misconceptions about Anthropology
îŽ¢ Due  to  lack  of  appropriate  awareness  about  the  nature,  scope  and  subject
matter  of  Anthropology  ,  the  following  misconceptions  are  held  by  other
social scientists.
î˜Anthropology is limited to the study of "primitive" societies
î˜Anthropologists only study the rural people and rural areas.
î˜Anthropologists  are  only  interested  in  the  study  of  far  away,  remote  exotic

communities living in isolated areas

î˜Anthropology  is  to  study  in  order  to  keep  and  preserve  communities  far  from
...
îŽ¢ But, anthropology differs from other social sciences by its broad scope,

approach, perspective, unit of analysis and methods

1.8. The Contributions of Anthropology

î¼ Helps us to understand others culture and our own ways of life.
î¼ Gives us an insight into different ways and modes of life of human society
î¼ Helps  us  to  be  more  sensitive  and  appreciative  of  cultural  diversity  and
...
îŽ¢ Culture  is  a  system  of  learned  behavior  shared  and  transmitted  among  the

members of the group.

îŽ¢ Culture  is  a  collective  heritage  learned  by  individuals  and  passed  from  one
...
î˜It is a quality or attribute of a group rather than an individual.
î˜But not all shared attributes are culture; beyond its shared nature it must be

learned.

îŽ¢ Culture is Symbolic

î˜A symbol is something verbal or nonverbal, within a particular language or

culture that comes to stand for something else.

î˜There  need  be  no  obvious,  natural,  or  necessary  connection  between  the
...
îŽ¢ Culture is Integrated

î˜The parts of culture are interconnected with one another.
î˜Particular culture traits fit into the whole system and they tend to make sense

within that context.

î˜Change in one aspect will likely generate changes in other aspects.

îŽ¢ Culture Can be Adaptive and Maladaptive

î˜People adapt themselves to the environment using culture
î˜The ability to adapt themselves to practically any ecological condition makes

humans unique
îŽ¢ Culture is Dynamic

î˜Culture  is  changing  constantly  as  new  ideas  and  techniques  are  added  as
...
îŽ¢ It also includes our customs and tastes, attitudes and outlook, in brief, our ways

of acting, feeling and thinking

îŽ¢ Some of the aspects of non-material culture include:
îŽ¢ Values - are the standards by which member of a society define what is good or
...
îŽ¢ Norms vary in terms of their importance to a culture. These are:

î¼ Folkways - are norms that are not strictly enforced, such as not leaving your

seat for an elderly people inside a bus/taxi.

î¼ Mores  -  are  norms  that  are  believed  to  be  essential  to  core  values  and  we
...
îŽ¢ People  who  violate  mores  usually  severely  punished,  but  level  of    punishment
...
îŽ¢ Certain biological, psychological, social, and cultural features are;
...
îŽ¢ Cultural traits that span across all cultures

îŽ¢ Murdock has listed 73 elements known to all cultures  -  include cooking, division

of labor, greetings, music, language, law etc.

Generality

îŽ¢ Cultural traits that occur in many societies but not all of them.

Particularity
îŽ¢ Cultural traits that occur in specific forms in each society
...
îŽ¢ It  prevent  us  from  understanding  and  appreciating  another  culture,  prevent  open

communication and result in misunderstanding and mistrust.

B. Cultural Relativism
îŽ¢ It  suspends  value  judgment  and  views  about  the  behavior  of  people  from  the

perspective of their own culture.

îŽ¢ Every  culture  contains  its  own  unique  pattern  of  behavior  which  seem  alien  to  people

from other cultural backgrounds.

îŽ¢ A culture should be studied in terms of its own meanings and values
îŽ¢ Respect for cultural differences involve:
î¶ Appreciating cultural diversity;
î¶ Accepting and respecting other cultures;
î¶ Trying to understand every culture and its elements in terms of its own context and
...
be so in another
 ...
 C. Human Rights
îŽ¢ It  challenges  cultural  relativism  by  invoking  a  realm  of  justice  and  morality
beyond  and  superior  to  the  laws  and  customs  of  particular  countries,  cultures,
and religions.

îŽ¢ Human  rights  include  the  right  to  speak  freely,  to  hold  religious  beliefs  without
persecution, and to not be murdered, injured, or enslaved or imprisoned without
charge.

îŽ¢ Ethnographers  try  to  be  objective,  accurate,  and  sensitive  in  their  accounts  of

other cultures.

2.6. Culture Change
îŽ¢ Culture change occur as a result of the following Mechanisms:
î˜Diffusion  -  the  process  by  which  cultural  elements  are  borrowed  from  another
...
î˜Acculturation - the adoption of new traits or patterns as a result of continuous

contact with another culture.
î¼ The cultures of either or both groups may be changed by this contact.
î¼ This usually happens in situations of trade or colonialism.

î˜Invention  -  the  process  by  which  humans  innovate  and    creatively  finding

solutions to problems
î¼Faced  with  comparable  problems  and  challenges,  people  in  different

societies have innovated and changed

î˜Globalization - encompasses a series of processes working to promote change in a
world  in  which  nations  and  people  are  increasingly  interlinked  and  mutually
dependent.

î˜Economic  and  political  forces  promote  linkages,  as  well  as  modem  systems  of
...
îŽ¢ Cultural Alternatives: refer to the activities which the member of society may

freely choose to follow or not to follow.
î˜Several  alternatives  are  associated  with  a  particular  cultural  universal  thus

allowing personal choice.

î˜Choice is limited by the number of roles & the number of people available to

perform them.

îŽ¢ Cultural  Specialties:  refer  to  the  special  skills  or  abilities  and  behavior

associated with the cultural alternative.
î˜The alternatives are limited by the scope of the division of labor in society.

îŽ¢ Culture  Shock:  refers  to  the  psychological  maladjustment

individuals

experience when they came across the society different from their own culture.
31
...
îŽ¢ It refer to a cluster of related cultures occupying a certain geographical region.
îŽ¢ In the context of Ethiopia, we may come up with different culture are in relation

to subsistence. These are;
A. Plough culture area
îŽ¢ It  represents  those  parts  of  the  country  where  agriculture  is  predominantly  the

means of subsistence.

îŽ¢ Most of highland and central parts of the country serves as the backbone of the

economy is considered a plough culture.

îŽ¢ A subject of anthropological inquires over the past seven decades starting from

the 1950s.

îŽ¢ Some  of  the  ethnographers  who  studied  the  area  are  Donald  Levine,  Allen
...
Guraghe, Sidama and Gedeo areas

îŽ¢ Enset serves as a staple diet to the people who make use the plant in a

wide variety of forms for a living.

C. Pastoral Culture Area
îŽ¢ Found in the low land areas covering a large section of Afar in the Northwest,

Somali in the Southeast and Borena in Southern Ethiopia.

îŽ¢ Inhabitants rely significantly on their herds and cattle for a living.

îŽ¢ Mobility  of  people  and  herds  is  a  major  characteristic  feature  of  the  people
...
îŽ¢ It is a permanent legal union between a man and a woman.
îŽ¢ Its  main  purpose  is  to  create  new  social  relationships,  rights  and  obligations
between  the  spouses  and  their  kin,  and  to  establish  the  rights  and  status  of
children when they are born.

îŽ¢ The ritual of marriage marks a change in status for a man and a woman and the

acceptance by society as new legal family.

2.9.1.1 .Rules of Marriage
îŽ¢ Societies have rules that state whom one can and cannot marry
îŽ¢ The  most  common  form  of  prohibition  is,  mating  with  certain  type  of  kins  or
relatives that are defined by the society as being inappropriate sexual partners -
incest taboos.

34
îŽ¢ The most universal form of incest taboo involves mating between members of
...
îŽ¢ Reasons for the practice of exogamy got approval in most societies include:

î˜ Marriage within the group-members is considered as a marriage between a

brother and sister

î˜ Attraction between a male and female gets lost due to close relationship in a

small group.

î˜ Great  increase  of  energy  and  vigor  is  possible  in  the  progeny  if  marriage

binds two extremely distant persons

î˜Adaptive  value  as  it  links  people  into  a  wider  social  network  that  nurtures,

helps, and protects them in times of need

B. Endogamy
îŽ¢ It  requires  people  marry  within  their  own  social  group  (e.g.  their  own  tribe,

nationality, religion, race, community, social class etc).

îŽ¢ Religious groups such as the Amish, Mormons, Catholics, and Jews and castes in
...
supply some equivalent relative as a substitute.

2.9.1.3. Type of Marriage
îŽ¢ Monogamy:  the marriage of one man to one woman at a time
îŽ¢ Polygamy: is a marriage of a man or woman with two or more mates
îŽ¢ Polygamy can be of two types:

î¶ Polygyny: the marriage of a man to two or more women at a time
î¶ Polyandy: the marriage of a woman to two or more men at a time

îŽ¢ Sororal polygyny - a man marry two or more sisters at a time
îŽ¢ Non-sororal polygyny - when the co-wives are not sisters
Advantages & Disadvantages of Polygamous Marriage
Advantages

î¼ A means of protection of wealth, power & status
...
îŽ¢ Marriage  has  a  contract  includes  the  transfer  of  certain  rights  between  the
...
îŽ¢ Bride price has been seen as;
...
î±Neolocal  Residence:  the  Married  couple  forms  an  independent  place  of
...
is  a  minimal  social  unit  that  cooperated  economically  and  assumes

responsibilities for rearing children.

îŽ¢ It is the most important primary group in society.
îŽ¢ It is the most permanent and pervasive of all social institutions.
Types of Family Structure
îŽ¢ Nuclear Family: consisting of a husband and wife and their children
îŽ¢ It is common in modern societies
...
ensure survival of individuals in a society

îŽ¢ Social Function: creation and perpetuation of the society
îŽ¢ Educational  and  Socialization  Function:  personality,  emotional,  social  and

intellectual development of children

2.9.3. Kinship
îŽ¢ The  network  in  which  people  are  related  to  one  another  through  blood,
...
î¼ Through adoption: the principle of fictitious kinship.

2.9.4. Descent
îŽ¢ It refers the social recognition of the biological relationship that exists between the

individuals.

îŽ¢  The  rule  of  descent  refers  a  set  of  principles  by  which  an  individual  traces  his

descent.
î¶ Patrilineal descent  - descent traced solely through the male line

î¼Succession and inheritance pass through the male line

î¶ Matrilineal descent - descent traced solely through the female line

î¼Only females acquire the succession and inheritance

î¶ Cognatic  Descent  -   individuals  are  free  to  show  their  genealogical  links
...
îŽ¢ It is defined as a treatment of a person or social group as minor, insignificant or

peripheral.

îŽ¢ It  involves  the  exclusion  of  certain  groups  from  social  interactions,  marriage

relations, sharing food and drinks, and working and living together.
îŽ¢ There are marginalized social groups in every society and culture.
îŽ¢ Women,  children,  older  people,  and  people  with  disabilities  are  among

marginalized groups across the world.

îŽ¢ Religious, ethnic, and racial minorities are also among social groups marginalized

in different societies and cultures.

îŽ¢ Crafts workers such as tanners, potters, and ironsmiths are marginalized in many
...
îŽ¢ Vulnerable  groups  are  people  exposed  to  possibilities  of  attack,  harms  or

mistreatment.

îŽ¢ Minority groups refers to a small group of people within a community, region,

or country.

îŽ¢ Minority  groups  are  different  from  the  majority  population  in  terms  of  race,

religion, ethnicity, and language

îŽ¢ They can be ethnic minorities, religious minorities, or racial minorities in a given

community, region of country.

3.2. Gender-based Marginalization
îŽ¢ Gender inequality involves discrimination on a group of people based on their

gender.

îŽ¢ Women  are  exposed  to  social  and  economic  inequalities  involving  unfair

distribution of wealth, income and job opportunities.

îŽ¢ Women  and  girls  are  vulnerable  to  gender-based  violence  such  as  rape,  early
...
3.4. Type of Marginalization
îŽ¢ Spatial Marginalization  - live on the outskirts of villages, near to forests, on poor

land, around steep slopes.

îŽ¢ They are segregated at market places and they sell their goods at the outskirts

of markets.

îŽ¢ When they walk, they are expected to give way for others and walk on the lower

side of the road.

îŽ¢ Economic Marginalization - excluded from certain economic activities including
...
îŽ¢ Cultural Marginalization - manifested in negative stereotyping like:
î¼Occupational minorities are labelled as impure and polluting;
î¼They  are  accused  of  eating  animals  that  have  died  without  being

slaughtered;

î¼Occupational  minorities  are  also  considered  as  unreliable,  lacking

morality, respect and shame.

3.4. Age-based vulnerability
îŽ¢ It  is  susceptibility  of  people,  especially  children  and  older  people,  to  different

forms of attack, physical injuries and emotional harms.
...
îŽ¢ Girls  are  exposed  to  HTPs  like  female  genital  cutting  and  early/  child

marriage, in many parts of Ethiopia.

îŽ¢ Factors encouraging early marriage: social norms and economic factors

are the two major drivers of the practice.

3.4.2. Marginalization of older persons
îŽ¢ Age-based marginalization also affects older people with the age of 60
...
47
îŽ¢ Rural-urban  migration,  changes  in  values  and  life  style,  education  and
...
îŽ¢ They are marginalized because - social burden rather than social assets.
3.5. Religious and Ethnic Minorities
îŽ¢ There  are  several  examples  of  marginalization  and  discrimination

targeting religious and ethnic minorities in the world.

îŽ¢ Jewish  and Muslim Rohingyas suffered discrimination and persecution
...
îŽ¢ In  the  early  twentieth  century,  many  social  theorists  believe  that  ethnicity  and
nationalism  decrease  in  importance  and  vanish  as  a  result  of  modernization,
industrialization and individualism.

îŽ¢ But,  ethnicity  and  nationalism  grown  in  political  importance  in  the  world,

particularly since the Second World War.

îŽ¢ 35  of  the  37  armed  conflicts  in  the  world  in  1991  were  internal  conflicts,  and
...
îŽ¢ Ethnic and national identities become pertinent following the continuous
influx of labor migrants and refugees to Europe and North America, which
leads  the  establishment  of  new,  permanent  ethnic  minorities  in  these
areas.

îŽ¢ At  the  time  indigenous  populations  have  organized  themselves  politically,
and demand that their ethnic identities and territorial entitlements should be
recognized by the State.

îŽ¢ But  nowadays,  ethnicity  and  nationalism  is  a  very  contesting  issue  in

different parts of the world.

îŽ¢ The disappearance of the strong socialist state in the countries of Central

and Eastern Europe and

îŽ¢ Closer  economic,  political  and  cultural  integration    in  western  Europe
...
îŽ¢  In  other  words,  ethnic  groups  are  those  human  groups  that  entertain  a
subjective  belief  in  their  common  descent  because  of  similarities  or  physical
type or of customs.

îŽ¢ It also refers a collectivity of humans lived and acted together - a group of
...
generally, and the division of labor.

îŽ¢ Shared language and ritual are implicated in ethnicity: mutual intelligibility
...
îŽ¢ A categorical ascription is an ethnic ascription when it classifies a person
...
îŽ¢ His  emphasis  was  not  the  substance  or  content  of  ethnicity,  rather  upon
the  social  processes,  which  produce  and  reproduce  boundaries  of
identification and differentiation between ethnic collectivities.

îŽ¢ The  features  that  are  taken  into  account  are  not  the  sum  of  'objective'
differences, but only those which the actors themselves regard as significant
îŽ¢ Not  only  ecological  variations  mark  and  exaggerate  differences;  some
cultural  features  are  used  by  the  actors  as  signals  and  emblems  of
differences, others are ignored

îŽ¢ The cultural contents of ethnic dichotomies have two orders:
îŽ¢ (i) Overt signals or signs - the diacritical features that people look for and exhibit
to show identity such features as dress, language, house-form, or general style of
life, and

îŽ¢ (ii)  Basic  value  orientations:  the  standards  of  morality  and  excellence  by  which
...
model of ethnicity' can be summarized as:
î¼Ethnicity  is  a  matter  of  cultural  differentiation  -  identification  always

involves a dialectical interplay between similarity and difference.

î¼Ethnicity  is  a  matter  of  shared  meanings  -  but  it  is  also  produced  and
...
the  categorization  of  others,  and
identification.
...
56
î˜Eriksen  (2002),  states  that  ethnic  categories  created  out  of  the  very  contact
...
î¼ A myth of common ancestry that includes the idea of common origin in time

and place and that gives an ethnic group a sense of fictive kinship;

î¼ Shared historical memories, shared memories of a common pasts, including

heroes, events, and their commemoration;

î¼ Elements of common culture which include religion, customs, and language;
î¼ A link with a homeland, not necessarily its physical occupation by the ethnic
...
îŽ¢ Affiliation can be influenced by racial, natal, symbolic and cultural factors.
îŽ¢ Racial factors: the use of physiognomic and physical characteristics;
îŽ¢ Natal factors: include origins of individuals, their parents and kin;
îŽ¢ Symbolic  factors:  include  those  factors  that  typify  or  exemplify  an  ethnic  group

(e.g., holidays, foods, clothing, artifacts, etc.).

îŽ¢ On the individual level ethnicity is a social-psychological process, which gives an

individual a sense of belonging and identity.

îŽ¢ Individuals  place  themselves  in  one  or  another  community  internally  by  states  of
mind  and  feelings,  like  self-definitions  or  feelings  of  closeness,  and  externally  by
behavior appropriate to these feelings.

îŽ¢ Ethnic identity can be defined as a manner in which persons, on account of their
...
îŽ¢ We can distinguish external and internal aspects of ethnic identity.

îŽ¢ External  aspects  refer  to  observable  behaviors  both  cultural  and  social.

These are;

î¼Speaking an ethnic language and practicing ethnic traditions,

î¼Participation
friendships,

in  ethnic  personal  networks,  such  as  family  and

î¼Participation  in  ethnic  institutional  organizations,  such  as  churches,

schools, enterprises and media

î¼Participation in ethnic voluntary associations, such as clubs, 'societies,'

youth organizations and

î¼Participation  in  functions  sponsored  by  ethnic  organizations  such  as
...
îŽ¢ We can distinguish at least three types of internal aspects of identity: cognitive,

moral and affective.

4.4. Race : The Social Construction of Racial Identity

îŽ¢ Race is an elusive concept like ethnicity.

îŽ¢ Ethnicity/ethnic  identity  was  used  in  synonym  with  race  or  racial  identity,  which

complicated their relation.

Racial Types - Anthropological Perspectives

îŽ¢ Biologically, race is a group of organisms of the same species that share similar physical

and genetic attributes and specific geographic regions.
...
îŽ¢ Skin color, one of the most visible human characteristics, is a good example of

adaptation to a particular environment.

îŽ¢  The darkest skin appears in populations originating in tropical zones, such as

Africa and Asia.

îŽ¢ The  lightest  skin  is  traditionally  found  in  northern  Europe  because  over  time,
...
îŽ¢ In  colder  regions  warm-blooded  animals  will  have  stockier  bodies  than
their counterparts from warmer regions, because stockier bodies are more
...
î¼ Rather  than  races,  physical  anthropologists  more  focus  on  ancestry  -  the
...
îŽ¢ Like  any  human  can  acquire  any  language,  any  infant  can  acquire  any
...
in 1350 BC by skin color:

î¼Red-skinned: Egyptians
î¼Black-skinned: people south of Egypt,
î¼White-skinned those living north of the Mediterranean Sea, and
î¼Yellow-skinned people to the east.

îŽ¢ By  the  16th  century,  during  the  age  of  discovery,  Europeans  voyaging
around  the  world  were  encountering  many  previously  unknown  peoples
and developing racial classifications of their own.

îŽ¢ Because  skin  color  was  so  noticeable,  many  racial  classifications  were
...
îŽ¢ By  the  mid-1800s,  naturalists  began  using  a  method  of  describing  the
shape  of  the  head  called  the  cephalic  index,  a  ratio  measurement  of  the
length and width of the head to classify races.

î¼Dolichocephalic peoples had long and narrow heads, like most northern

Europeans, and

î¼Brachycephalic peoples tended to have broad heads, like many southern

Europeans.

îŽ¢ The  root  cause  of  all  this  problem  is  the  identification  of  human  types
based on biological determinism: the idea that physical traits were linked to
behavior.
...
îŽ¢ This  practice  became  known  as  eugenics,  and  the  Nazis  took  it  to  a

terrible extreme during World War II.

The Grand Illusion: Race, turns out, is arbitrary
îŽ¢ Over  the  years,  various  anthropologists  have  attempted  to  classify  the
...
îŽ¢ Although  Asians  look  pretty  clearly  different  from  Europeans  in  some
respects,  what  do  you  do  with  people  who  look  partly  Asian  and  partly
European?
...
îŽ¢ Cultures  differ  because  people  live  in  different  ecological,  economic,  social  or
...
îŽ¢ For sometime, it was common to divide humanity into four main races.
...
îŽ¢ Modern  genetics  abandon  race  and  tends  not  to  speak  of  it  due  to  two  main

reasons:
î˜There has been so much interbreeding between human populations. So it would

be meaningless to talk of fixed boundaries between races

î˜The distribution of hereditary physical traits does not follow clear boundaries

îŽ¢ Genetic studies concerning human variation show that humans are more than 99%

genetically alike.

îŽ¢ Surprisingly, of the 1% variation;

î¼  85%

is

found  within  any  human  population  or  group

town/village/tribal or ethnic group),
...
îŽ¢ Based  on  studies,  there  is    no  unifying  genetic  essence  for  people  of  the

same race when compared to people of different races.

îŽ¢ As  a  result,  use  of  race  as  a  system  of  human  categorization  lacks
...
îŽ¢ Different  anthropologists  and  other  scholars  have  different  views  on  the
...
îŽ¢ In  this  regard,  Max  Weber  (1992),  differentiated  between  racial  and
...
and cultural characteristics defined by outside groups.

îŽ¢ For  him  Ethnicity  is  ascribed  at  birth,  but  the  ethnic  group  normally
...
îŽ¢ These changes are related to the forces of modernity and globalization.
îŽ¢ Globalization  started  as  an  economic  phenomenon  and  end  up  as  a
...
îŽ¢ Banks  (1996)  explained  ethnicity  as  an  instrument  of  group  mobilization

for political and economic ends.

îŽ¢ For  him  ethnicity  is  something  that  can  be  changed,  constructed  or  even

manipulated to gain specific political and/or economic ends.

îŽ¢ Proponents  of  this  perspective  advocate  that  in  the  contexts  of  modern
...
îŽ¢ The  basic  notion  in  this  approach  is  that  ethnicity  is  something  that  is  being
...
îŽ¢ Perhaps  the  most  interesting  aspect  of  this  approach  is  its  subjectivist  stance,
which sees ethnicity as a social-psychological reality or a matter of perception of
"us"  and  "them"  in  contradistinction  to  looking  at  it  as  something  given,  which
exists objectively as it were "out there".

îŽ¢ By  this,  ethnicity  is  more  dependent  on  the  socio-psychological  experience  of
...
îŽ¢ Barth separated culture from the concept of ethnicity.
îŽ¢ For  him,  ethnic  boundaries  were  psychological  boundaries;  ethnic  culture  and  its

content were irrelevant.

îŽ¢ In  general,  constructivists  conceive  ethnicity  as  situational,  flexible  and  variable

dealing with inter-personal ethnicity without initially reifying a concept of culture.

îŽ¢ Jenkins (1997) further noted that, as far as the flow of individuals from one ethnic

group to another is possible, it is possible to argue that the boundaries of ethnicity

are permeable and osmotic.

îŽ¢  This  provoked  that  ethnicity  is  dynamic  that  changes  through  time  and  space;
...
îŽ¢ The  role  of  indigenous  governance  was  indispensable  before  the  advent  of  the

modern state system.

îŽ¢ Anthropologists  have  been  studying  indigenous  systems  of  governance  in
Ethiopia  and  other  parts  of  Africa  and  they  have  been  used  to  maintain  social
order across Ethiopian regions.

The Oromo Gadaa
îŽ¢ It  is  one  of  the  well-studied  indigenous  systems  of  governance  and  scholars
including Paul Baxter, Eike Haberland and Asmerom Legesse have been studying
the Oromo Gaada since the 1950s.

îŽ¢ Asmerom, a famous anthropologist, is widely known for his ethnographic studies
...
governance and dispute settlement among the Oromos.

îŽ¢ Political  power  is  transferred  from  one  generation  set  (Luuba)  to  another

every eight years.

îŽ¢ Gaada  officials  such  as  the  Abba  Gaada  and  Abba  Seera  (father  of  law)

serve for eight years and leave their position to the new generation.
îŽ¢ The system involves a continuous process of law making and revision.
îŽ¢ The law making process has rooms for wider participation of the people.
îŽ¢ Gumi  gaayo,  a  law  making  assembly  of  the  Borana  Oromo,  is  held  every
eight years to revising, adapting, making and publicizing the customary law
(seera) and custom (aadaa).

îŽ¢ The  system  of  governance  also  include  institutions  of  conflict  resolution
...
î¼  Roga, traditional leader next to the Abba Gada, and
î¼ Two levels of council of elders, Hulla Hayyicha and Songo Hayyicha.

îŽ¢ Conflicts are resolved by the Songo hayyicha at village level.
îŽ¢ When  disputes  are  not  settled  at  the  village  level,  referred  to  first  to  the  Hulla
...
îŽ¢ For  example  several  ethnic  groups  use  a  similar  term  with  slight  variations  to

refer to their customary law:
î¼Seera (Oromo),
î¼ Sera (Sidama),
î¼ Serra (Siltie),
î¼ Gordena Sera (Soddo Gurage),
î¼ Senago sera (Mesqan Gurage), and
î¼Seera (Gedeo).
...
indigenous  system  of  governance  embraces  the  dere  woga
(customary law) and the dubusha - the general assembly - it is the highest
body  and responsible to make and revise customary laws and resolve major
disputes that cannot be solved at the lower levels.

îŽ¢  The dubushas has three hierarchies:

î¼ The dere dubusha (at the top),

î¼ Sub-dere dubusha (at the middle), and

î¼Guta/neighborhood dubusha (at the village level).
...
îŽ¢ Conflicts  and  disputes  exist  in  every  society  and  may  arise  between
individuals,  groups  and  communities  within  the  same  or  different  ethnic
groups.

îŽ¢ There  are  different  indigenous  institutions  of  conflict  resolution  and

peacemaking across regions and cultures in Ethiopia.

îŽ¢ Some of them are:

î¼Customary dispute resolution mechanisms;
î¼Traditional mechanisms of conflict resolution;
î¼Grassroots justice systems; and
î¼Customary justice institutions.

îŽ¢ Study findings reveal variations and similarities among indigenous
...
î˜Experience in dispute resolution;
î˜Knowledge  of  customary  laws,  procedures,  norms  and  values  of  the

society;

î˜Impartiality, respect for rules and people;
î˜Ability of listening and speaking politely;
î˜Honesty and tolerance.

î¼ Focus on restoring social relationships, harmony, and peaceful coexistence.
îŽ¢ Indigenous  justice  systems  also  have  differences  in  terms  of  hierarchies,

procedures and level of complexities.

îŽ¢ Customary  justice  institutions  include  three  major  components.
...
î¼ Council  of  elders:  highly  respected  and  well-experienced  community  members

who have a detail knowledge of the customary laws.

î¼ Have personal qualities, truthfulness and experience in settling conflicts.
î¼ It has different names in various ethnic groups: Yehager Shimagile (Amhara),
Jaarsaa  Biyyaa  (Oromo),  Hayyicha  (Gedeo),  Dere  Cima  (Gamo),  Deira  Cimma
(Wolayita), and Cimuma (Burji).

î¼ Customary courts: are public assemblies that serve two major purposes:

î˜ Hearing, discussing and settling disputes, and
î˜ Revising, adapting, and making laws.

The Three Structures of Gamo Customary Justice System

î¼The  Dere  Woga:  a  comprehensive  body  of  rules  and  procedures  that
govern  issues  including  inheritance,  property  ownership,  marriage  and
86
...
î¼They  are  expected  to  have  a  sound  knowledge  of  the  customary  laws,

norms and values of the community.

î¼Dere dubusha: the biggest customary court and has two major functions:

î˜Hearing, discussing and resolving disputes, and
î˜Revising and making laws.

î¼ Dere  dubusha  is  a  sacred  place  where  supernatural  power  exists  and  truth

prevails.

î¼It  is  a  place  where  curses  are  uttered  in  its  name;  justice  is  delivered;

and important assemblies are held.

Strengths and Limitations of Customary Justice Institutions
îŽ¢ Strengths of Customary Justice Institutions

î¼ Incur limited cost in terms of time and resources/money;
î¼ Conflict  resolution  process  are  held  in  public  spaces  and  different  parties
...
î¼ Rely  on  respect  for  elders,  the  tradition  of  forgiveness,  transferring

compensations, embedded in indigenous beliefs
îŽ¢ Limitations of Customary Justice Institutions

î¼ They  are  dominated  by  men  and  women  are  excluded  from  participation  at

customary courts and assemblies with few exceptions.

î¼ Their  potential  in  resolving  inter-ethnic  conflicts  and  restoring  long-lasting

peace is very limited.

5.3. Inter-ethnic Conflict Resolution
îŽ¢ Most of the time indigenous institution are weak in resolving inter-ethnic conflicts.
îŽ¢ But  there  are  some  examples  of  inter-ethnic  conflict  resolution  institutions  in
...
îŽ¢  In  the  area  conflict  often  arises  due  to  dispute  over  grazing  land  or  water

resources.

îŽ¢ When  conflict  arises  between  parties  from  two  ethnic  groups,  notable  and
bilingual  elders  from  Tigray  and  Afar  come  together  to  resolve  the  dispute  and
restore peaceful relations.

îŽ¢ Inter-ethnic conflict resolution mechanisms also exist when conflicts arise among

Afar, Issa, Tigrayans and Argobba.

îŽ¢ The  mechanisms  have  different  names  like  Xinto  among  the  Afar,  Edible  among
...
î¼ If  a  man  kills  another  man  in  a  fight,  the  incident  trigger  the  feeling  of

revenge among the relatives of the murdered man.

î¼ In  such  tense  situation,  the  wife  of  the  killer  requests  the  Debarte

intervention.

î¼ The Debarte quickly start their intervention to stop the act of revenge.
î¼ They  beg  the  relatives/family  of  the  murdered  man  to  give  up  revenge  and

consider forgiveness

î¼  Finally they give the way for elders to start the peace-making process

5.5. Legal Pluralism: Interrelations between Customary, Religious
and State Legal Systems
91
îŽ¢ Legal  pluralism  refers  to  the  existence  of  two  or  more  legal  or  justice
...
îŽ¢ Multiple  legal  institutions,  including  customary  laws  and  courts,  state  laws
and courts, and religious laws and courts (e.g., the Sharia Law) work side-by-
side in most parts of the country.

îŽ¢ The FDRE Constitution provides ample space for religious and customary

laws and courts to address personal and family cases.

îŽ¢ This is because a single legal system does not have a capability to address

all legal cases and maintaining peace and order.

îŽ¢ Hence, different justice institutions work side-by-side in most parts of the

country, especially in remote and rural areas.

îŽ¢ These

include;  state/formal
...
îŽ¢ IKS  is  defined  as  a  technical  insight  of  wisdom  gained  and
developed by people in a particular locality through years of careful
observation and experimentation.

îŽ¢ It is embodied in culture and is described as an integrated pattern

of human knowledge, beliefs and behavior.

îŽ¢ It  consists  of  language,  ideas,  beliefs,  customs,  taboos,  codes,
...
îŽ¢  This  culture  is  passed  down  for  generations  and  provides  a
holistic view of how to use natural resources based on traditional
...
Indigenous Peoples
îŽ¢ It refers to a specific group of people occupying a certain geographic area

for many generations.

îŽ¢ Indigenous people possess, practice and protect a total sum of knowledge
livelihood
...
îŽ¢ Academic  definitions  focus  on:  living  in  tradition-based  cultures,  having
political  autonomy  prior  to  colonialism,  and  seeking  to  preserve  cultural
integrity in the present (Corntassel, 2003).

îŽ¢ In  sum,  despite  the  lack  of  universal  definition  for  the  concept  of
indigenous peoples, the United Nations Permanent Forum on Indigenous
Issues (UNPFII) sets out distinguishing features.

îŽ¢ This includes the:

î¼Self-identification  as  Indigenous  peoples  at  the  individual  level  and
...
î¼Maintain  and  reproduce  their  ancestral  environments  and  systems  as
...
îŽ¢ For Kwaku and Morena (2010), IK is a unique local knowledge to a given culture

or society.

îŽ¢ IK exists in rural and urban societies as part of life that their livelihood depends

on specific skills and knowledge for survival.

îŽ¢ The World Bank refers IK as a large body of knowledge and skills which is
developed  outside  the  formal  system  including  development  planning,
environmental  assessment,  resource  management,  local  conservation  of
biological resources, and conflict resolution.

îŽ¢ IK has different but closely related names such as 'folk knowledge', 'local
'indigenous
'traditional
...
îŽ¢ In sum, IK is the knowledge that people in a given community have developed over

time, and that continues to develop.

îŽ¢ It  is  based  on  experience,  often  tested  over  centuries  of  use,  adapted  to  local

culture and environment, dynamic and changing.

6.1.3. Features of Indigenous Knowledge
îŽ¢ Ellen and Harris (1996) identified the following special features of indigenous

knowledge that distinguish it broadly from other knowledge.
î¼Local,  in  that  it  is  rooted  in  a  particular  community  and  situated  within
...
î¼ Learned through repetition, which is a defining characteristic of tradition even
in  the  retention  and

is  added.  Repetition  aids

when  new  knowledge
reinforcement of IK.

î¼ Constantly  changing,  being  produced  as  well  as  reproduced,  discovered  as
...
îŽ¢ In  Ethiopia  Debo  and  Jige  are  important  uniting  forces  in  communal  activities.
Members  of  the  community  unit  to  provide  essential  inputs,  including  direct
labor to operations.

îŽ¢ This deployment of manpower is strongly supported by IKS, which is composed
of technologies, rules, information, approaches, and relationships that are vital to
sustainable development.

îŽ¢ According  to  Paula  Puffer  (1995),  indigenous  /  local  knowledge  helps  to  find

best solution to a development challenges.

îŽ¢ Familiarity  with  local  knowledge  can  help  extensionists  and  researchers
...
100
îŽ¢ IK offers local people and their development workers further options in designing
...
îŽ¢ However,  not  all  indigenous practices  are  beneficial  to  sustainable development;

and provide the right solution for a given problem.

îŽ¢ Hence,  before  adopting  IK,  integrating  and  disseminating  into  development

programs, practices need to be scrutinized for their appropriateness.

6.3. Indigenous Knowledge and Development
îŽ¢ IK passes from one generation to the next and enable people to survive, manage
like  animals,  plants,  rivers,

their  natural  resources  and  the  ecosystems
environment, economic, cultural and political organization.

îŽ¢ IK  is  relevant  to  development  process  such  as  agriculture,  animal  husbandry,
traditional  medicine,  saving  and  credit,  community  development,  poverty
alleviation, and peaceful coexistence.

îŽ¢ IK  helps  to  identify  cost-effective  and  sustainable  mechanisms  for  poverty
...
î¼Improve health and
î¼Promote a sense of cultural pride within the community.
...
îŽ¢ According to the 1998/99 World Development Report, knowledge not capital, is

the key to sustainable social and economic development.

îŽ¢ Building on local knowledge is the first step to mobilize capital.

îŽ¢ The  challenge  for  the  development  community  is  to  find  better  ways  to  learn
102
...
îŽ¢ In  sum,  indigenous  knowledge  with  western  based  knowledge,  helps  to  create

culturally acceptable development solutions.

6.4. Preservation, Challenges and Limitations of IK
îŽ¢ IK, passed from generation to generation orally, is in danger of being lost unless it is

formally documented and preserved.

îŽ¢ The future of IK is uncertain and the loss of IK would impoverish society because,
just as the world needs genetic diversity of species, it needs diversity of knowledge
systems.

îŽ¢ The rapid change in the way of life of local communities has largely accounted

for the loss of IK.

îŽ¢ Younger  generations  underestimate  the  utility  of  IK  systems  because  of  the

influence of modem technology and education.

îŽ¢ Since  IK  is  essential  to  development,  it  must  be  gathered,  organized  and
...
î¼ Modernization  and  industrialization  threatens  the  preservation  and  continued

development of IK systems

î¼ IK can be eroded by wider economic and social forces. The growth of national
and international markets, the imposition of educational and religious systems
...
rely on is wrong or even harmful.

îŽ¢ Practices  based  on,  mistaken  beliefs,  faulty  experimentation,  or
104
...
6.5. The Erosion of Indigenous Knowledge Systems
îŽ¢ The recent and current rate of loss of IK is accelerating by;

î¼ Rapid population growth,
î¼ Growth of international markets
î¼ Educational systems,
î¼ Environmental degradation
î¼ Rapid modernization and
î¼ Cultural homogenization

îŽ¢ In  some  countries,  official  propaganda  depicts
...
105
îŽ¢  Some local people and communities have lost confidence in their ability to help
