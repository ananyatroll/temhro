...
| --------- | --- | --- | ---------- | ------- | ------- | --- | ------- | --- | --- |
| âœ“ Explain |     | the | scientific |         | methods |     | briefly |     |     |
...
| who | were | able |     | to logically |     | assess |     | the | most | probable |     | creation |     |
| --- | ---- | ---- | --- | ------------ | --- | ------ | --- | --- | ---- | -------- | --- | -------- | --- |
story.
...
different forms of life that occur today on planet earth have been
...
|     | spontaneously |                | from      | any         | kind |             | of non-living |       |      | matter. |            | One     | of the |
|     | firm          | believers      | in        | spontaneous |      |             | generation    |       |      | was     | Aristotle, |         | the    |
|     | Greek         | philosopher    |           | (384-322    |      | BC).        |               |       |      |         |            |         |        |
3. Theory of Catastrophism: It is simply a modification of the
|     | theory      | of Special |           | Creation. |      | It  | states |     | that | there |          | have       | been |
| --- | ----------- | ---------- | --------- | --------- | ---- | --- | ------ | --- | ---- | ----- | -------- | ---------- | ---- |
...
| ---- | --------- | --- | --- | ---- | ------- | -------- | --- | --- | ----- | --- | --- | --- | --- |
4. Cosmozoic Theory (Theory of Panspermia): according to this
theory, life has reached this planet Earth from other heavenly
| bodies |      | such |      | as  | meteorites, |     | in   | the       | form |     | of highly | resistance |         |
| ------ | ---- | ---- | ---- | --- | ----------- | --- | ---- | --------- | ---- | --- | --------- | ---------- | ------- |
| spores |      | of   | some |     | organisms.  |     | This | idea      | was  |     | proposed  | by         | Richter |
| in     | 1865 |      | and  |     | supported   |     | by   | Arrhenius |      |     | (1908)    | and        | other   |
...
| ------------- | ------ | --- | ------------------- | --- | ------- | --------- |
this theory, Origin of life on earth is the result of a slow and
| gradual  | process | of  | chemical      | evolution | that | probably |
| -------- | ------- | --- | ------------- | --------- | ---- | -------- |
| occurred | about   | 3.8 | billion years | ago.      |      |          |
This theory was proposed independently by two scientists - A. I.
Oparin, a Russian scientist in 1923 and J.B.S Haldane, an English
scientist, in 1928.
...
| âœ“ Mind     | contributes |      |     |       | effectiveness |     |      | and | scope |        |         |     |
âœ“
...
| ----------- | --------- | ------ | ---- | -------------- | ------- | -------- | --------- | ---------- | ------ | --------- | ------- | ------------ | ------ | ------ | ---- |
|             | helping   |        | them |                | to      | maintain |           | a constant |        | internal  |         | environment, |        |        |      |
|             | or        | steady |      | state.         |         |          |           |            |        |           |         |              |        |        |      |
...
| ---------- | --- | --------- | --- | --- | ----- | -------- | --- | --- | ------ | --------- | --- |
â–
of life (bio-molecules) that are basically found in a living cell
| and | categorized |     |     | as organic |     | and | inorganic |     | molecules |     | in  |
| --- | ----------- | --- | --- | ---------- | --- | --- | --------- | --- | --------- | --- | --- |
general.
| Each | member |     | of the | groups |     | is vital | for | every | single | organism |     |
| ---- | ------ | --- | ------ | ------ | --- | -------- | --- | ----- | ------ | -------- | --- |
â–
on Earth.
...
â–
nature.
They are the main source and storage of energy in the body.
â–
They serve also as structural component of cell membrane.
â–
The general molecular formula of carbohydrate is CnH2nOn
or (CH2O)n, where n > 3.
...
| ----------- | ---------- | ------------- | ------- | ------------- | ----------- |
| Dehydration | synthesis: |               | joining | two molecules | by removing |
water
| Hydrolysis: | splitting | two | molecules | by adding | water |
| ----------- | --------- | --- | --------- | --------- | ----- |

Classification and Structure of carbohydrate
â– Classification
Carbohydrates occur in four main size classes:
â–ª Monosaccharaides,
â–ª Disaccharides, and
â–ª Polysaccharides
Monosaccharaides
| âž¢ Monosaccharaides |         |      | also   | called simple | sugars.  |           |     |
| ------------------ | ------- | ---- | ------ | ------------- | -------- | --------- | --- |
| âž¢ They             | consist | of a | single | polyhydroxy   | aldehyde | or ketone |     |
units.
âž¢
| The    | most abundant |      | monosaccharaides |               | in nature | are the | 6-  |
| ------ | ------------- | ---- | ---------------- | ------------- | --------- | ------- | --- |
...
| --- | --------- | ------------- | ------- | ----------- | --------- | ---- | ----- | ---------- | --- | --------- | ------------ | -------- | ------------ | --- | ------- | ---- |
|     | human     |               | cells.  |             |           |      |       |            |     |           |              |          |              |     |         |      |
| â–   | Its       | concentration |         |             |           | in   | the   | blood      |     | is about  |              | 1 gdm-3. |              |     |         |      |
| â–   | The       |               | small   |             | size      | and  |       | solubility |     |           | in           | water    | of           |     | glucose |      |
|     | molecules |               |         |             | allows    |      | them  |            | to  | pass      |              | through  |              | the |         | cell |
|     | membrane  |               |         |             | into      | the  | cell. |            |     |           |              |          |              |     |         |      |
| â–   | Energy    |               |         | is released |           |      | when  |            | the | molecules |              | are      | metabolized. |     |         |      |
|     | Two       |               | glucose |             | molecules |      |       | react      |     | to        | form         | the      | disaccharide |     |         |      |
maltose.
| â–   | Starch  |     |     | and    | cellulose |     |     | are | polysaccharides |     |     |     | made |     | up  | of  |
| --- | ------- | --- | --- | ------ | --------- | --- | --- | --- | --------------- | --- | --- | --- | ---- | --- | --- | --- |
|     | glucose |     |     | units. |           |     |     |     |                 |     |     |     |      |     |     |     |
...
| --- | --------- | --- | ---- | ------ | ---- | ---- | ------- | -------- | --- | ---- | --- | --- | ------------ | --- | --- |
| â–   | Galactose |     |      | reacts | with |      | glucose |          | to  | make |     | the | disaccharide |     |     |
lactose.
â–
|     | However,  |     | glucose  |     | and |      | galactose |      | cannot |      | be  | easily | converted   |     |     |
| --- | --------- | --- | -------- | --- | --- | ---- | --------- | ---- | ------ | ---- | --- | ------ | ----------- | --- | --- |
|     | into      | one | another. |     |     |      |           |      |        |      |     |        |             |     |     |
| âž¢   | Galactose |     | cannot   |     |     | play | the       | same |        | part |     | in     | respiration |     | as  |
glucose.
Fructose
âž¢
|     | Fructose, |     | glucose  |     | and |          | galactose |     | are | all       | hexoses. |     |              |         |     |
| --- | --------- | --- | -------- | --- | --- | -------- | --------- | --- | --- | --------- | -------- | --- | ------------ | ------- | --- |
| âž¢   | However,  |     | whereas  |     |     | glucose  |           |     | and | galactose |          |     | are          | aldoses |     |
|     | (reducing |     | sugars), |     |     | fructose |           | is  | a   | ketose    |          | (a  | non-reducing |         |     |
sugar).
| âž¢   | Fructose |     | reacts |     | with |     | glucose |     | to  | make |     | the | disaccharide |     |     |
| --- | -------- | --- | ------ | --- | ---- | --- | ------- | --- | --- | ---- | --- | --- | ------------ | --- | --- |
sucrose

Disaccharides
| â–   | Most | sugars |     | found |     | in  | nature |     | are | disaccharides. |     |     |     |     |     |
| --- | ---- | ------ | --- | ----- | --- | --- | ------ | --- | --- | -------------- | --- | --- | --- | --- | --- |
â– Disaccharides are soluble in water, but they are too big to
|     | pass      | through |     | the     | cell |      | membrane |     |                 | by  | diffusion. |      |           |           |        |
| --- | --------- | ------- | --- | ------- | ---- | ---- | -------- | --- | --------------- | --- | ---------- | ---- | --------- | --------- | ------ |
| â–   | They      |         | are | broken  |      | down |          |     | in              | the | small      |      | intestine |           | during |
|     | digestion |         | to  | give    | the  |      | smaller  |     | monosaccharides |     |            |      |           | that pass | into   |
|     | the       | blood   | and | through |      |      | cell     |     | membranes       |     |            | into | cells.    |           |        |
â–
|     | A condensation   |           |     |          |     | reaction  |         |          | takes |               | place   |     | by             | releasing    | water |
| --- | ---------------- | --------- | --- | -------- | --- | --------- | ------- | -------- | ----- | ------------- | ------- | --- | -------------- | ------------ | ----- |
|     | and              | process   |     | requires |     |           | energy. |          |       |               |         |     |                |              |       |
| â–   | A glycosidic     |           |     | bond     |     | forms     |         | and      | holds |               | the     | two | monosaccharide |              |       |
|     | units            | together. |     |          |     |           |         |          |       |               |         |     |                |              |       |
| â–   | The              | three     |     | most     |     | important |         |          |       | disaccharides |         |     |                | are sucrose, |       |
|     | lactose          |           | and | maltose. |     |           |         |          |       |               |         |     |                |              |       |
| â–   | They             |           | are | formed   |     | from      |         | the      |       | a forms       |         | of  | the            | appropriate  |       |
|     | monosaccharides. |           |     |          |     | Sucrose   |         | is       | a     | non-reducing  |         |     |                | sugar.       |       |
| â–   | Lactose          |           | and | maltose  |     |           | are     | reducing |       |               | sugars. |     |                |              |       |
...
â– This is called condensation polymerisation, and the building
...
| --- | --------- | --- | --- | --- | ---- | ---- | --------- | --- | --------- | --- | --- | --- | --- | --- |
â–
| Amylopectin |     |     |     | is  | a   | branched |     | polymer |     | of  | glucose | and | It  | is  |
| ----------- | --- | --- | --- | --- | --- | -------- | --- | ------- | --- | --- | ------- | --- | --- | --- |
â–
...
fungal cells (Animal starch).
â–ª Like amylopectin glycogen is a
branched polysaccharide of D-
glucose units in Î± - (1, 4)
linkages, but it is highly
branched.
â–ª Glycogen is amylopectin with
very short distances between
the branching side-chains.
â–ª Starch from plants is
hydrolysed in the body to
produce glucose.
â–ª Glucose passes into the cell
and is used in metabolism.
â–ª Inside the cell, glucose can be
polymerised to make glycogen
which acts as a carbohydrate
energy store.
...
| polar     |     | organic |     | solvents  |     | such    | us    | benzene, |      |                      |
for life that are
| chloroform, |     |     |     | and ether. |     |     |     |     |     |     |
| ----------- | --- | --- | --- | ---------- | --- | --- | --- | --- | --- | --- |
They are present in all living organisms. composed mostly of
â–
| The | group |     | includes |     | fats, | oils, | waxes |     | and |     |
| --- | ----- | --- | -------- | --- | ----- | ----- | ----- | --- | --- | --- |
C, H, O.
.
| related |     | compounds |     |     |     |     |     |     |     |     |
...
| ------- | --- | --- | -------- | --- | --- | --------- | --- | --- | --- | --- |
Phospholipids
| I. They   | are | efficient  |     | energy      |     | sources. |     |     |     | â–ª   |
| --------- | --- | ---------- | --- | ----------- | --- | -------- | --- | --- | --- | --- |
| II. Serve |     | as thermal |     | insulators. |     |          |     |     |     |     |
Steroids
â–ª
| III.They |     | are | structural |     | components |     |     | of  | the |     |
| -------- | --- | --- | ---------- | --- | ---------- | --- | --- | --- | --- | --- |
Waxes
| cell membrane.  |     |            |          |            |     |           |           |          |       | â–ª   |
| --------------- | --- | ---------- | -------- | ---------- | --- | --------- | --------- | -------- | ----- | --- |
| IV. Serve       |     |            | as       | precursors |     | for       |           | hormones |       |     |
| (steroid        |     | hormones). |          |            |     |           |           |          |       |     |
...
â–
| The | different |     | is  | made | from | their | ways |     | of storing |     | lipids. |     |     |
| --- | --------- | --- | --- | ---- | ---- | ----- | ---- | --- | ---------- | --- | ------- | --- | --- |
...
| -------- | ---- | --- | ------ | ------ | ----- | --------------- | ------ | --- | ----- | ------- | ----- | --- | ------ |
| â– Lipids | that |     | have   | at     | least | one             | double |     | bond  | between |       |     | carbon |
...
| called |     | amino |      | acids. |         |     |        |     |      |          |           |     |
| ------ | --- | ----- | ---- | ------ | ------- | --- | ------ | --- | ---- | -------- | --------- | --- |
| Amino  |     | acids | have | a      | central |     | carbon |     | atom | like the | one shown |     |
â–
| in Fig.    | 2.3. |          |     |        |     |           |     |         |              |       |            |     |
| ---------- | ---- | -------- | --- | ------ | --- | --------- | --- | ------- | ------------ | ----- | ---------- | --- |
| â– Proteins |      | are      |     | made   | of  | different |     |         | combinations |       | of all     | 20  |
| different  |      | amino    |     | acids. |     |           |     |         |              |       |            |     |
| Several    |      | covalent |     | bonds  |     | called    |     | peptide |              | bonds | join amino |     |
â–
...
| atoms       |     | arranged |           | as  | shown |          | in      | Fig. |
2.5.
| â– There          |          | are    | six        | major       |       | nucleotides, |         |       |
| ---------------- | -------- | ------ | ---------- | ----------- | ----- | ------------ | ------- | ----- |
| all of           | which    |        | have       |             | three |              | units   | a     |
| phosphate,       |          |        | a          | nitrogenous |       |              |         | base, |
| and              | a ribose |        | sugar.     |             |       |              |         |       |
| â– There          |          | are    | two        | types       |       | of           | nucleic |       |
...
| -------- | --- | --- | ------- | --- | --------- | --- | --- | --- | ---- | --- | --- | ------ | --- | -------- | --- |
â–
| amounts |     | for metabolic |         |     | activities. |     |       |     |      |     |      |     |     |      |     |
| ------- | --- | ------------- | ------- | --- | ----------- | --- | ----- | --- | ---- | --- | ---- | --- | --- | ---- | --- |
| Vitamin |     | D             | is made |     | by          |     | cells | in  | your |     | skin |     | and | Some | B   |
â–
| vitamins     |          | and        | vitamin         |     | K   | are         | produced |     |     |         | by     | bacteria |     | living   | in  |
| ------------ | -------- | ---------- | --------------- | --- | --- | ----------- | -------- | --- | --- | ------- | ------ | -------- | --- | -------- | --- |
| the large    |          | intestine. |                 |     |     |             |          |     |     |         |        |          |     |          |     |
| â– Sufficient |          | quantities |                 |     | of  | most        | vitamins |     |     |         | cannot |          | be  | made     | by  |
| the body,    |          | but        | a well-balanced |     |     |             | diet     |     | can | provide |        |          | the | vitamins |     |
| that         | are      | needed.    |                 |     |     |             |          |     |     |         |        |          |     |          |     |
...
â–
| the      | body. | Foods  |     | providing |     |     | an  |     | adequate |     |     | level |     | of these  |     |
| -------- | ----- | ------ | --- | --------- | --- | --- | --- | --- | -------- | --- | --- | ----- | --- | --------- | --- |
| vitamins |       | should | be  | included  |     |     | in  | a   | person's |     |     | diet  | on  | a regular |     |
basis.
...
It is one of the most plentiful and essential of compounds, which
â–
is a tasteless and odourless, existing in gaseous, liquid, and solid
states.
2.7. Minerals
Minerals are inorganic compounds used by the body as building
â–
| material, | and | they | are | involved | with metabolic |     | functions. |     |     |     |
| --------- | --- | ---- | --- | -------- | -------------- | --- | ---------- | --- | --- | --- |
âž¢ For example, the mineral iron is needed to make Hemoglobin and
it binds to Hemoglobin in red blood cells and is delivered to body
| cells      | as blood | circulates |       | in the    | body. |           |     |           |     |     |
| ---------- | -------- | ---------- | ----- | --------- | ----- | --------- | --- | --------- | --- | --- |
| â– Calcium, |          | and        | other | minerals, | is an | important |     | component |     | of  |
bones and is involved with muscle and nerve functions and they
...
Or it is the basic unit of life which can perform life processes.
...
Eukaryote: have membrane bounded organelle in cytoplasm
â–ª
Prokaryote: do not have membrane bounded organelle
â–ª
2 kinds of organelle
Membranous organelles: Endoplasmic reticulum (Rough and Smooth), Golgi
1)
bodies,
mitochondria, chloroplasts, nucleus, lysosomes, peroxisomes and vacuoles
Non-membranous organelles: ribosomes (70s and 80s), centrosomes, cilia
2)
...
A) The nucleus
â–ª is distinctly oval or spherically shaped largest central structure surrounded by a double-layered
membrane
â–ª Contains genetic materials: DNA and RNA
DNA
...
Chromatin:
="colored material"
is easily stained for viewing with microscope
is composed mainly of coils of DNA bound to basic protein called histones.
Nucleoli:
actively engage in synthesizing of ribosomes
does not have a limiting membrane
Contains large amounts of RNA and protein of the type found in ribosomes
c

B) The Cytoplasm:
Interior region of a cell which is not occupied by nucleus
Contains organelles dispersed within a complex jelly like marrow called the
cytosol
i. Endoplasmic reticulum (ER)
is a fluid-filled membrane system extensively present throughout
the cytosol
is 2 in type: smooth and the rough ER
The rough Endoplasmic Reticulum:
contains dark particles called ribosomes that produce protein
...
ii. The Golgi complex:
is associated with the ER
Contains sets of flattened, curved,
membrane- enclosed sacs, or
cisternae, stacked in layers.
Functions
â–ª Processing the raw material into
finished products
â–ª Sorting and directing finished product
to their final destination
â–ª The smooth ER of the liver and
kidney cells are responsible for the
detoxification and inactivation of
drugs.
â–ª In skeletal muscle cells, a modified
The Golgi complex form of smooth ER stores Ca2+ to
be released for muscle contraction
c
...
iv. Peroxisomes:
Is membrane-enclosed sacs containing oxidative enzymes and catalase that detoxify various
â–ª
wastes.
Are found both in plant and animal cells
â–ª
used for removing reactive compounds from the cytoplasm that create H O as a
â–ª
2 2
byproduct
Then. H O is decomposed into harmless water and oxygen by catalase
â–ª
2 2
c
...
ways
have their own unique DNA called
mitochondrial DNA.
have the ability to replicate themselves
Mitochondrial structure
c

vi. Chloroplasts
â–ª are useful organelles among
plastids
â–ª participate in the process of
photosynthesis
â–ª are located in outer surface
of the cell to receive enough
light.
â–ª are green colored due to the
chlorophyll pigments found in
...
vii .Vesicles
are membrane bound sacs that are used to store or transport
â–ª
substances around the cell.
Lysosomes are actually Vesicles.
â–ª
viii. Vacuoles
are essentially larger Vesicles are formed by the joining together
â–ª
of many Vesicles.
are membrane bound organelles that have no specific shape and
â–ª
contain water with a number of different compounds within it.
In plant cells, vacuoles are important in maintaining Turgor
â–ª
Pressure.
c
...
Microtubule
â–ª is the largest of the group; slender, long, hollow tubes composed of a globular protein molecule
tubulin
â–ª Provide asymmetrical shape to the cell
Microfilaments
â–ª are important to cellular contractile system and as mechanical
stiffeners.
â–ª are the smallest of the cytoskeleton composed of protein molecule actin having a globular shape
similar to tubulin
â–ª Generally, cytoskeletons determine/ provide the:
â–ª shape of a cell
â–ª structural support
â–ª organizing its contents
â–ª substances movement through cell (cilia, flagella and intracytoplasmic vesicles), and
â–ª Contribute to movements of the cell as a whole.
c

C) Plasma/cell membrane
is extremely thin layer of lipids and
â–ª
proteins forming outermost
boundary of living cell
encloses the intracellular fluid
â–ª
(ICF).
...
Structure of the cell membrane middle layer.
are made up of lipids and proteins
â–ª
plus small amount of
carbohydrates
c

Phospholipids have a polar charged head having a negatively charged
â–ª
phosphate group and two non-polar (electrically neutral) fatty acid tails.
The polar end
â–ª
â–ª is hydrophilic (water loving)
â–ª Can interact with water molecule
â–ª is also polar
The non-polar end
â–ª
â–ª is hydrophobic (water fearing)
â–ª will not mix with water.
The lipid is fluid in nature.
â–ª
Cholesterol provides to the fluidity as well as the stability
â–ª
cholesterol lies in between the phosphate molecules, preventing the fatty acid
â–ª
chain from packing together and crystallizing that could decrease fluidity of
the membrane.
Lipid bilayer
â–ª
â–ª forms the basic structure of the membrane
â–ª is a barrier to passage of water soluble substances
â–ª is responsible for the fluidity of the membrane
c
...
7.
contact
Membrane Carbohydrate Roles
Recognition of self and cell-to-
1)
cell interactions
Membrane proteins
Surface markers
...
Cells are very diverse in their
â–ª
â–ª size,
â–ª shape and
â–ª their internal structure
3.1.3.1 Cell Shape
Nerve cells have long extensions
â–ª
Skin cells are flat
â–ª
Egg cells are oval in shape
â–ª
3.1.3.2 Cell Size
Most are microscopic
â–ª
Some are macroscopic Example,
â–ª
egg of birds/reptiles and a neuron
cell of giraffe, which is 2 meters in
...
Diffusion of molecules (lighter one diffuses rapidly)
4. distance through which diffusion
must take place
Movement along electrical
gradient
The simultaneous existence of an
electrical and concentration (chemical)
gradient for a particular ion is referred
to as an electro-chemical gradient.
Concentration gradient (A) and difussion (B)
c
...
3. Competition: closely related compounds may compete
for carrier protein
Facilitated Diffusion
â–ª uses a carrier protein to facilitate the transfer of a particular
substance
â–ª Still it is passive
â–ª Do not utilize energy
Osmosis
â–ª is the net diffusion of water down its own concentration
gradient. Water can readily
permeate the plasma membrane
â–ª Is diffusion
â–ª Driving force is concentration gradient
c

Na+-K+-pump plays three important roles
1. It establishes sodium and potassium
concentration gradients across the plasma
membrane of all cells; these gradients are
important in the nerve and muscle to generate
electrical signals.
2. It helps regulate cell volume by controlling
the concentration of solutes inside the cell and
thus minimizing osmotic effects that would
induce swelling or shrinking of the cell.
3. The energy used to run the pump also
Active transport
...
opposite direction.
â–ª May or may not use carrier proteins
Example: Na-K pump use carrier protein
c
...
â–ª Endocytosis and exocytosis are active
processes involving the bulk transport of
materials through membranes, either in to
cells (endocytosis)or out of cells
(exocytosis).
â–ª Endocytosis
â–ª occurs by an in folding or extension of cell
surface membrane to form a vesicle
or vacuole
â–ª is of two types
â–ª Phagocytosis (cell eating)
â–ª Pinocytosis (cell drink)
Exocytosis
â–ª
â–ª is the reverse process of endocytosis.
â–ª Is used to remove wastes from cells
Exocytosis
â–ª Is involved to secret enzymes
â–ª Is used to export materials needed for cell
wall synthesis
c
...
Metabolism
| â–ª is     | the | sum     |        | of chemical |     |          |     | reactions |     | that takes       | place | within |
| -------- | --- | ------- | ------ | ----------- | --- | -------- | --- | --------- | --- | ---------------- | ----- | ------ |
| each     |     | cell of | a      | living      |     | organism |     |           |     |                  |       |        |
| provides |     |         | energy |             | for | vital    |     | processes |     | and synthesizing |       | of new |
â–ª
| organic |             | materials. |     |           |           |       |     |           |       |               |     |     |
| ------- | ----------- | ---------- | --- | --------- | --------- | ----- | --- | --------- | ----- | ------------- | --- | --- |
| â–ª can   | be          | divided    |     | into      |           | 2     |     |           |       |               |     |     |
|         | â–ª catabolic |            |     | reactions |           |       |     |           |       |               |     |     |
|         | â–ªconvert    |            |     | nutrients |           |       | to  | energy    |       |               |     |     |
|         | â–ªBreaking   |            |     | dawn      |           | large |     | to small  |       |               |     |     |
|         | â–ª anabolic  |            |     | reactions |           |       |     |           |       |               |     |     |
|         | â–ª           | lead       | to  | the       | synthesis |       |     | of larger |       | biomolecules. |     |     |
|         | â–ªRequires   |            |     | energy    |           |       | in  | different | forms |               |     |     |

4.2. Enzymes and their role in metabolism
| Most | chemical |     |     | reactions |     |     | need | a   | catalyst |     | to  | get |     | them | started. |     |
| ---- | -------- | --- | --- | --------- | --- | --- | ---- | --- | -------- | --- | --- | --- | --- | ---- | -------- | --- |
â–
In many cases, heat may be a catalyst, but this is inefficient
â–
| because |     | heat |     | cannot |     | be  | applied |     | to  | molecules |     |     | in  | a   | controlled |     |
| ------- | --- | ---- | --- | ------ | --- | --- | ------- | --- | --- | --------- | --- | --- | --- | --- | ---------- | --- |
fashion.
| â– Thus, | most     |     |     | chemical |     | reactions |           |     | require |      |     | biological |     |             | catalyst |     |
| ------- | -------- | --- | --- | -------- | --- | --------- | --------- | --- | ------- | ---- | --- | ---------- | --- | ----------- | -------- | --- |
| called  | enzymes. |     |     |          |     |           |           |     |         |      |     |            |     |             |          |     |
| Enzymes |          |     | are | protein  |     |           | catalysts |     |         | that |     | speed      |     | biochemical |          |     |
â–
| reactions |     | by    |           | facilitating |            |     | the | molecular |     |     | rearrangements |            |     |     |     | that |
| --------- | --- | ----- | --------- | ------------ | ---------- | --- | --- | --------- | --- | --- | -------------- | ---------- | --- | --- | --- | ---- |
| support   |     | cell  | function. |              |            |     |     |           |     |     |                |            |     |     |     |      |
| Enzymes   |     | speed |           | up           | (catalyze) |     |     | chemical  |     |     |                | reactions; |     |     | in  | some |
â–
| cases, |        | enzymes |      | can |          | make | a    | chemical |     |         | reaction |     |     | millions |     | of  |
| ------ | ------ | ------- | ---- | --- | -------- | ---- | ---- | -------- | --- | ------- | -------- | --- | --- | -------- | --- | --- |
...
| -------------- | ------- | ------ | ----- | -------- | --------- | --------- | ----- | ------------- | -------- | ---------- | ---------- | ---------- | ----- | -------- | ------- | --- |
| building       |         | up     | and   |          | breaking  |           | down  |               | cellular |            | components |            |       |          | must    | be  |
| monitored      |         |        | and   | balanced |           |           | in    | a coordinated |          |            |            | fashion.   |       |          |         |     |
| â–To            | achieve |        | this  |          | goal,     | cells     |       | organize      |          |            | reactions  |            |       | into     | various |     |
| enzyme-powered |         |        |       |          | pathways. |           |       |               |          |            |            |            |       |          |         |     |
| â–Enzymes       |         |        | speed |          | up        | reactions |       |               | by       | lowering   |            | activation |       |          | energy. |     |
| Many           | enzymes |        |       | change   |           |           | shape | when          |          | substrates |            |            | bind. |          |         |     |
| â–This          | is      | termed |       |          | "induced  |           |       | fit",         | meaning  |            |            | that       |       | the      | precise |     |
orientation of the enzyme required for catalytic activity can
| be  | induced |     | by  | the | binding |     |     | of the | substrate |     |     |     |     |     |     |     |
| --- | ------- | --- | --- | --- | ------- | --- | --- | ------ | --------- | --- | --- | --- | --- | --- | --- | --- |

4.2.1 Chemical nature and classification of enzymes
| All | known |     | enzymes |     |     |     | are | proteins |     |     | with |     | the | exception |     |     | of  |
| --- | ----- | --- | ------- | --- | --- | --- | --- | -------- | --- | --- | ---- | --- | --- | --------- | --- | --- | --- |
â–
| recently |             | discovered |     |     |         | RNA  |              | enzymes.  |          |        |         |        |           |             |     |      |     |
| -------- | ----------- | ---------- | --- | --- | ------- | ---- | ------------ | --------- | -------- | ------ | ------- | ------ | --------- | ----------- | --- | ---- | --- |
| â– Some   |             | enzymes    |     |     | may     |      | additionally |           |          |        | contain |        | a         | non-protein |     |      |     |
| group.   |             | Enzymes    |     |     | are     | high |              | molecular |          | weight |         |        | compounds |             |     | made |     |
| up       | principally |            |     | of  | chains  |      |              | of        | amino    | acids  |         | linked |           | together    |     |      | by  |
| peptide  |             | bonds.     |     |     |         |      |              |           |          |        |         |        |           |             |     |      |     |
...
| Thus,       | on        |     | the        | basis |         | of       |       | differences |              | in       | chemical |      |             | nature,     |          |     | the |
â–
...
amino acid residues. Digestive enzymes such as pepsin, and
...
â–
enzymic reactions are monovalent (K+) and divalent cations
(Mg++, Mn++ and Cu++).
Isoenzymes (Isozymes): At one time it was believed that
â–
...
| -------- | -------- | --------- | --- | ---- | --- | -------- | --- | --- | ---- | ------- | --- | --- | ---- |
| the      | product. |           |     |      |     |          |     |     |      |         |     |     |      |
â– An enzyme attracts substrates to its active site, catalyzes the
...
Changing these alter the rate of reaction caused by the
â–
enzyme.
In nature, organisms adjust the conditions of their enzymes
â–
to produce an optimum rate of reaction, where necessary,
or they may have enzymes which are adapted to function
well in extreme conditions where they live.
Temperature
â–
Increasing temperature increases the kinetic energy that
â–
molecules possess.
In a fluid, this means that there are more random collisions
âž¢
between molecules per unit time.
Since enzymes catalyse reactions by randomly colliding with
âž¢
...
Controlling these factors in a cell is one way that an
âž¢
...
âž¢
and inhibition can therefore not be reversed. Irreversible
inhibitors often contain reactive functional groups.
Irreversible inhibition is different from reversible enzyme
âž¢
inactivation.
...
and structural proteins in many cellular processes, including
...
glucose C6H12O6, into pyruvate, CH3COCOOâˆ’ + H+.
...
pathway per glucose.
â– Substrate-level phosphorylation is the mechanism to produce ATP
during glycolysis.

Biochemical logic for the presence of regulatory steps
â– The existence of more than one point of regulation indicates that
intermediates between those points enter and leave the glycolysis
pathway by other processes.
â– For example, in the first regulated step, hexokinase converts
...
| â–   | In biosynthesis, |       |            |            | simple |            |     | compounds |           |        | are |      | modified, |      |     | converted |      |     |
...
| âž¢ DNA     | molecules, |                |     | which    |     | are    | composed |     |       | of   | nucleotides |     |     |
...
| ------------ | ---------- | ------- | ------ | --- | ---------- | -------------- | --------------- | --- | ------- | ---------- | -------- | ------ | --------- | --------- | ------ | ---- |
| sound        |            | waves.  |        |     |            |                |                 |     |         |            |          |        |           |           |        |      |
| â– Similarly, |            |         | some   |     | autotrophs |                |                 |     | convert |            |          | light  |           | energy    |        | into |
| chemical     |            |         | energy |     | through    |                | photosynthesis. |     |         |            |          |        |           |           |        |      |
| The          | importance |         |        |     | of         | photosynthesis |                 |     |         |            |          |        |           |           |        |      |
| â– The        | processes  |         |        |     | of all     | organisms,     |                 |     | from    |            | bacteria |        |           | to humans |        |      |
| require      |            |         | energy |     | and        | to             | get this        |     | energy, |            | many     |        | organisms |           | access |      |
| stored       |            | energy  |        | by  | eating     |                | food.           |     |         |            |          |        |           |           |        |      |
...
â–
outer space (sunlight) and converts it into chemical energy
in the form of Glyceraldehyde3-phosphate (G3P), which
in turn can be made into sugars and other organic
...
| â– How |     | long |     | lasting |     | and | stable |     | are | those |     |     | covalent |     |
| ----- | --- | ---- | --- | ------- | --- | --- | ------ | --- | --- | ----- | --- | --- | -------- | --- |
bonds?
...
| --------- | ------ | --- | -------- | -------------- | ---------- | --- | --- | -------- | --- | ------ | --- | ------- | -------- | ----- |
| and       | stored |     | by       | photosynthesis |            |     |     | almost   |     | 200    |     | million |          | years |
ago.
Photoautotrophs
âž¢
...
| âž¢ Chemoautotrophs: |            |     |           |           | are            | very     | interesting |          |            |        | group      |         | of  | bacteria |     |     |
...
| to warm |     |     | up. |     |     |     |     |     |     |     |     |     |     |     |     |     |
| ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
â– Photosynthesis is vital because it evolved as a way to store
the energy in solar radiation (the photo part) as high energy
...
| â– The      | other |         | type     |       | is         | termed          |                | as  | anoxygenic |            |     |           | photosynthesis. |     |     |          |     |
...
| â– Photosynthesis |            |            |               | occurs       |         |         | in       | the    |
| ---------------- | ---------- | ---------- | ------------- | ------------ | ------- | ------- | -------- | ------ |
| chloroplasts;    |            |            | specifically, |              |         | in the  |          | grana  |
| and              | stroma     |            | regions.      |              |         |         |          |        |
| â– The            | grana      |            | is the        | innermost    |         |         | portion  | of     |
| the              | organelle; |            |               | a collection |         |         | of       | disc-  |
| shaped           |            | membranes, |               |              | stacked |         |          | into   |
| columns          |            | like       | plates.       |              |         |         |          |        |
| â– The            | individual |            |               | discs        |         | are     |          | called |
...
| -------------------- | ------- | --- | ---- | ------ | ----------- | --------- | ------- | --- | ------ | -------- | --- | ------ | ----- | --------- | ----- | --- |
| â– There              |         | is  | also |        | a           | bacterial |         |     |        | variant  |     |        | aptly |           | named |     |
...
| are              | xanthophyll |         |        |     | (yellow)     |      |        |                  | and      | carotene |          |     |        | (orange)        |             |        | from |
| which            |             | carrots |        | get | their        |      | color. |                  |          |          |          |     |        |                 |             |        |      |
...
Antennae
| Pigment |     |     | molecules |     |     |     | are | associated |     |     |     | with |     | proteins, |     |     | which |
| ------- | --- | --- | --------- | --- | --- | --- | --- | ---------- | --- | --- | --- | ---- | --- | --------- | --- | --- | ----- |
â–
| allow       |       | them     |            | the       | flexibility |     |       | to  | move |            |       | toward |          | light       | and | toward    |     |
| ----------- | ----- | -------- | ---------- | --------- | ----------- | --- | ----- | --- | ---- | ---------- | ----- | ------ | -------- | ----------- | --- | --------- | --- |
| one         |       | another. |            |           |             |     |       |     |      |            |       |        |          |             |     |           |     |
| â– A         | large |          | collection |           |             |     | of    | 100 | to   |            | 5,000 |        | pigment  |             |     | molecules |     |
...
â– The reactions of plant photosynthesis are divided into those that
| require | the   | presence |     |           | of sunlight |      | and those |     | that do          | not. |     |     |       |
| ------- | ----- | -------- | --- | --------- | ----------- | ---- | --------- | --- | ---------------- | ---- | --- | --- | ----- |
| Both    | types |          | of  | reactions |             | take | place     |     | in chloroplasts: |      |     |     | light |
â–
| dependent       |     | reactions |         |           | in  | the | thylakoid |     | and    | light-independent |       |      |     |
| --------------- | --- | --------- | ------- | --------- | --- | --- | --------- | --- | ------ | ----------------- | ----- | ---- | --- |
| reactions       | in  | the       | stroma. |           |     |     |           |     |        |                   |       |      |     |
| Light-dependent |     |           |         | reactions |     |     | :When     | a   | photon | of                | light | hits | the |
â–
reaction center, a pigment molecule such as chlorophyll releases
an electron.
...
| produce | ATP |        | (adenosine |        |     | triphosphate, |     |     | a source |     | of  | chemical |     |
| ------- | --- | ------ | ---------- | ------ | --- | ------------- | --- | --- | -------- | --- | --- | -------- | --- |
| energy  | for | cells) | and        | NADPH. |     |               |     |     |          |     |     |          |     |
...
| ATP                 |       | and  | NADPH,     |        | which  |           |     | are     | the | rich    |        | energy    |      | sources |           |       | that |
| drive               |       | dark | reactions. |        |        |           |     |         |     |         |        |           |      |         |           |       |      |
| Although            |       |      | NADPH      |        |        | and       |     | ATP     |     | provide |        | cells     |      | with    |           | large |      |
âž¢
| amounts |     |          | of  | energy,     | these |     | molecules |     |         | are            | not |       | stable |     | enough |     | to  |
| ------- | --- | -------- | --- | ----------- | ----- | --- | --------- | --- | ------- | -------------- | --- | ----- | ------ | --- | ------ | --- | --- |
| store   |     | chemical |     | energy      |       | for | long      |     | periods |                | of  | time. |        |     |        |     |     |
...
| â– These | reactions | use water | and catalysts. |
| ------- | --------- | --------- | -------------- |
â– The carbon atoms from carbon dioxide are ''fixed,'' when they are
built into organic molecules that ultimately form three-carbon sugars.
...
| -------------- | --- | ------- | --- | -------- | --- | --- | ------- | --- | ----- | --- | ------ | --- | ---- |
| chemical       |     | energy. |     |          |     |     |         |     |       |     |        |     |      |
â– For example, plants in hot, dry environments are subject to
...
| --------------- | ------ | ------- | ---- | ------ | --------- | ----------- | ----------- | ------ | ------ | ---------- | --------- | --- | ------------- | --- | --- | ------- | --- |
| carbon          |        | dioxide |      |        | into      |             | four-carbon |        |        |            | compounds |     |               |     |     | instead |     |
| of three-carbon |        |         |      |        | molecules |             |             |        | during |            |           | the | Calvin        |     |     | cycle.  |     |
...
| â–   | The    | CAM        |          | pathway |                |           |          | occurs           |     | in       | water |         | conserving   |     |              | plants  | that  |
|     | live   | in         | deserts, |         | salt           |           | marshes, |                  |     | and      | other |         | environments |     |              |         | where |
|     | access |            | to water |         | is             | limited.  |          |                  |     |          |       |         |              |     |              |         |       |
| â–   | CAM    |            | plants,  |         | such           |           | as       | cacti,           |     | orchids, |       |         | and          | the | pineapple    |         |       |
|     | allow  | carbon     |          |         | dioxide        |           | to       | enter            |     | The      |       | leaves  | only         |     | at night,    |         | when  |
|     | the    | atmosphere |          |         |                | is cooler |          |                  | and | more     |       | humid.  |              |     |              |         |       |
...
4.4. Metabolic disorders, diagnosis and
treatments
| Metabolism |     |     | is the |     | breaking | down | of food |     | to its | simpler |     |
| ---------- | --- | --- | ------ | --- | -------- | ---- | ------- | --- | ------ | ------- | --- |
â–
| components: |     |           | proteins, |       | carbohydrates |       | (or sugars), |           | and | fats.  |     |
| ----------- | --- | --------- | --------- | ----- | ------------- | ----- | ------------ | --------- | --- | ------ | --- |
| Metabolic   |     | disorders |           | occur | when          | these | normal       | processes |     | become |     |
â–
disrupted.
â– Disorders in metabolism can be inherited, in which case they
...
| ------ | ------ | --- | -------------- | --- | --- | --- | --- | --- | --- | --- | --- |
â– Metabolic diseases can also occur when the liver or pancreas do
...
pyruvate metabolism disorders, von Gierkeâ€Ÿs disease,
McArdle disease, Pompes disease, and Forbesâ€Ÿ disease.
Fatty acid oxidation defects; examples include Gaucherâ€Ÿs
âž¢
disease, Niemann-Pick disease, Fabryâ€Ÿs disease, and medium-
...
Kidney failure, Pneumonia, respiratory failure, or collapsed
âž¢
lung
...
| obesity       |     | (especially    |           |     | abdominal |     |          | obesity), |     | high         |     | blood |     | pressure, |       |
| ------------- | --- | -------------- | --------- | --- | --------- | --- | -------- | --------- | --- | ------------ | --- | ----- | --- | --------- | ----- |
| and lipid     |     | abnormalities. |           |     |           |     |          |           |     |              |     |       |     |           |       |
| Specifically, |     |                | metabolic |     |           |     | syndrome |           |     | is diagnosed |     |       | if  | any       | three |
â–
| of the |     | following |     | five |     | markers |     | are |     | present: |     |     |     |     |     |
| ------ | --- | --------- | --- | ---- | --- | ------- | --- | --- | --- | -------- | --- | --- | --- | --- | --- |
â–ª Elevated waist circumference: 40 inches or more for men; 35
...
women
â–ª Elevated blood pressure: 130/85 mm Hg or higher or are already
...
| --- | --- | -------- | --- | --------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
â– Inborn errors of metabolism (inherited metabolic disorders)
|     | are       | often    | treated     |                  |     | with |          | nutritional |          |          | counselling |           |     | and        | support,  |     |
| --- | --------- | -------- | ----------- | ---------------- | --- | ---- | -------- | ----------- | -------- | -------- | ----------- | --------- | --- | ---------- | --------- | --- |
|     | periodic  |          | assessment, |                  |     |      | physical |             | therapy, |          |             | and other |     | supportive |           |     |
|     | care      | options. |             |                  |     |      |          |             |          |          |             |           |     |            |           |     |
| â–   | Multiple  |          | treatment   |                  |     |      | options  |             | are      |          | available   |           | for |            | inherited |     |
|     | metabolic |          | disorders   |                  |     | and  |          | examples    |          | include: |             |           |     |            |           |     |
|     | bone      | marrow   |             | transplantation, |     |      |          |             |          |          |             |           |     |            |           |     |
âž¢
| âž¢   | enzyme |         | replacement |     |          |     | therapy |           | in  | selected |     | patients, |     |     |     |     |
| --- | ------ | ------- | ----------- | --- | -------- | --- | ------- | --------- | --- | -------- | --- | --------- | --- | --- | --- | --- |
|     | gene   | therapy |             | in  | selected |     |         | patients, |     |          |     |           |     |     |     |     |
âž¢
| âž¢   | medications     |     |         | to  | reduce           |     | symptoms, |      |     | such |             | as pain   | or  | low          | blood   |     |
| --- | --------------- | --- | ------- | --- | ---------------- | --- | --------- | ---- | --- | ---- | ----------- | --------- | --- | ------------ | ------- | --- |
|     | sugar,          |     | mineral |     | supplementation, |     |           |      |     |      | nutritional |           |     | counselling, |         |     |
...
âœ“ Genetics is a field of biology that studies how traits are passed
| from | parents |     | to  | their | offspring. |     |     |     |     |     |     |
| ---- | ------- | --- | --- | ----- | ---------- | --- | --- | --- | --- | --- | --- |
âœ“ The passing of traits from parents to offspring is known as
| heredity;   |       | therefore, |            |         | genetics |     | is           | the study | of heredity. |      |        |
| ----------- | ----- | ---------- | ---------- | ------- | -------- | --- | ------------ | --------- | ------------ | ---- | ------ |
| âœ“ The       | basic |            | components |         |          | of  | genetics     |           | are DNA,     | RNA, | genes, |
| chromosomes |       |            | and        | genetic |          |     | inheritance. |           |              |      |        |
âœ“ DNA molecules hold all the genetic information for almost all
organisms.
âœ“ A gene is one particular section of a DNA molecule that tells a
| cell      | to  | perform |      | one | specific |          |     | task. | Heredity | is what | makes |
| --------- | --- | ------- | ---- | --- | -------- | -------- | --- | ----- | -------- | ------- | ----- |
...
âœ“
|     | DNA | stands |     | for | deoxyribonucleic |     |     |     |     | acid | and | double |     | helix. |     |
| --- | --- | ------ | --- | --- | ---------------- | --- | --- | --- | --- | ---- | --- | ------ | --- | ------ | --- |
âœ“
|     | DNA         | molecule |          |      | contains   |     | a        | code |          | that can |       | be     | used    | by       | a cell |
| --- | ----------- | -------- | -------- | ---- | ---------- | --- | -------- | ---- | -------- | -------- | ----- | ------ | ------- | -------- | ------ |
|     | to express  |          | certain  |      | genes.     |     |          |      |          |          |       |        |         |          |        |
| âœ“   | Specific    |          | sections |      |            | of  | a        | DNA  |          | molecule |       |        | provide |          | the    |
|     | information |          |          | to   | build      |     | specific |      | proteins |          | which |        | can     | then     | be     |
|     | used        | by       | a cell   |      | to express |     | the      |      | desired  | gene.    |       |        |         |          |        |
...
âœ“ The ability of DNA to make copy of itself (DNA-replication)
| is the | basis     | for | reproduction | and inheritance. |     |      |           |       |
| ------ | --------- | --- | ------------ | ---------------- | --- | ---- | --------- | ----- |
| âœ“ DNA  | structure |     | is double    | helix            | and | must | replicate | semi- |
conservatively.
...
âž¢ Code for protein synthesis is specified by DNA and has to be
| sent  | to ribosome. |      |             |     |             |     |      |          |             |
| ----- | ------------ | ---- | ----------- | --- | ----------- | --- | ---- | -------- | ----------- |
| âž¢ DNA | is a         | huge | molecule    |     | and remains |     | in   | nucleus  | to assemble |
| amino | acids        | in   | the correct |     | sequence    | to  | form | protein. |             |
âž¢
...
| --- | -------- | --- | ------ | --------- | --- | --- | --- | --- | --- |
iv. iv. Ribosome read mRNA code and assembles amino acids presented
...
Mutations
âœ“ Mutation is the alteration of the nucleotide sequence of the
| genome |       | of    | an organism,    |     |       | virus,   | or   | extrachromosomal |          |            | DNA.  |     |     |
| ------ | ----- | ----- | --------------- | --- | ----- | -------- | ---- | ---------------- | -------- | ---------- | ----- | --- | --- |
|        | 1.    | Point | mutations-      |     |       | changes  | that | involves         |          | a single   | base. |     |     |
...
| --- | ------------ | --------- | --------- | --- | ------- | ---------- | ------ | ----------- | ------- | --------- | ------ | -------- | ------- | ----- |
|     | over         | long      | periods,  |     |         | with       | new    | forms       |         | replacing | old    | ones.    |         |       |
| â–   | As           | evolution |           | has |         | progressed |        | new         |         | species   | are    | arising, |         | the   |
|     | biodiversity |           |           | of  | the     | planet     |        | increasing, |         |           | larger | and      |         | more  |
|     | complex      |           | organisms |     |         | replaced   |        | the         | smaller |           | and    | some     | species |       |
|     | has          | get       | extinct.  |     |         |            |        |             |         |           |        |          |         |       |
â–
...
|     | natural |     | selection. |     |     |     |     |     |     |     |     |     |     |     |
| --- | ------- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
â– The theory of evolution is based on the idea that all species
|     | are | related |     | and | gradually |     | change |     | over | time. |     |     |     |     |
| --- | --- | ------- | --- | --- | --------- | --- | ------ | --- | ---- | ----- | --- | --- | --- | --- |

â‘
|     | Evolution  |          |     | can            | also |            | be  | the |         | change      |           | in  | genetic |       | composition |           | of a |
| --- | ---------- | -------- | --- | -------------- | ---- | ---------- | --- | --- | ------- | ----------- | --------- | --- | ------- | ----- | ----------- | --------- | ---- |
|     | population |          |     | over           |      | successive |     |     |         | generations |           |     |         | which | may         | be caused |      |
|     | by         | meiosis, |     | hybridization, |      |            |     |     | natural |             | selection |     |         | or    | mutation.   |           |      |
â‘
|     | This      | leads |     | to        | a     | sequence |             |        |     | of events |      |     | by     | which | the     | population |       |
| --- | --------- | ----- | --- | --------- | ----- | -------- | ----------- | ------ | --- | --------- | ---- | --- | ------ | ----- | ------- | ---------- | ----- |
|     | diverges  |       |     | from      | other |          | populations |        |     |           | of   | the | same   |       | species | and        | may   |
|     | lead      | to    | the | origin    |       | of       | a           | new    |     | species.  |      |     |        |       |         |            |       |
| â–   | Theories  |       |     | about     |       | the      |             | origin |     | of        | life | on  | Earth. |       | The     | theory     | of    |
|     | evolution |       |     | describes |       |          | how         |        | the | various   |      |     | forms  |       | of life | on         | earth |
(including humans) emerged and developed. There are five main
|     | theories |     | of  | the | origin |     | of  | life |     | on Earth: |     |     |     |     |     |     |     |
| --- | -------- | --- | --- | --- | ------ | --- | --- | ---- | --- | --------- | --- | --- | --- | --- | --- | --- | --- |
â–ª
|     |     |     |     | special     |     | creationism |      |            |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | ----------- | --- | ----------- | ---- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|     |     | â–ª   |     | spontaneous |     |             |      | generation |     |     |     |     |     |     |     |     |     |
|     |     | â–ª   |     | eternity    |     | of          | life |            |     |     |     |     |     |     |     |     |     |
|     |     | â–ª   |     | cosmozoan   |     |             |      | theory     |     |     |     |     |     |     |     |     |     |
â–ª
|     |     |     |     | biochemical |     |     |     | origin |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | ----------- | --- | --- | --- | ------ | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ---------- | ----------- | --- | --- | --- | --- | --- | --- |
âž¢ Special creation theory states that the different forms of life on
| earth | were | created | by a Supreme | Being/ | God/ | at once | with six |
| ----- | ---- | ------- | ------------ | ------ | ---- | ------- | -------- |
days.
âž¢ Special creation is always linked to religion and mainly focused
on spiritual matters that cannot be seen, touched or measured
effectively.
...
â– Suggests that life can evolve 'spontaneously' from non-living
|     | objects. |     | E.g. people |     | believed |     |     | that | rotting | meat | turned | into |
| --- | -------- | --- | ----------- | --- | -------- | --- | --- | ---- | ------- | ---- | ------ | ---- |
flies.
| C)  | Eternity | of  | life |     |     |     |     |     |     |     |     |     |
| --- | -------- | --- | ---- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
â– The theory of eternity of life states that the universe has always
|     | existed | and | that | there |     | has | always | been | life | in the universe. |     |     |
| --- | ------- | --- | ---- | ----- | --- | --- | ------ | ---- | ---- | ---------------- | --- | --- |
â– There is no beginning and no end to life on earth and so life is

| D) Cosmozoan | Theory |     |     |     |     |     |     |     |
| ------------ | ------ | --- | --- | --- | --- | --- | --- | --- |
â– States that life on the earth originally came from elsewhere in the
universe (possibly from another planet). E.g. Meteorites brought
| bacterial | spores, | germs | to the | earth. |     |     |     |     |
| --------- | ------- | ----- | ------ | ------ | --- | --- | --- | --- |
â– This theory did not gain any significant support because it lacks
evidence and it is strongly linked to the â€žeternity of lifeâ€Ÿ theory of
| the origin     | life.  |     |     |     |     |     |     |     |
| -------------- | ------ | --- | --- | --- | --- | --- | --- | --- |
| E) Biochemical | theory |     |     |     |     |     |     |     |
â– It suggests that life on earth originated as a result of a number of
| biochemical | reactions    |     | producing |        | organic | molecules, |     | which |
| ----------- | ------------ | --- | --------- | ------ | ------- | ---------- | --- | ----- |
| combined    | (associated) |     | to form   | cells. |         |            |     |       |
â–
This theory is also called abiogenesis; states life originates from
| chemical | inanimate |     | (abiotic | substances). |     | The | two | scientists |
| -------- | --------- | --- | -------- | ------------ | --- | --- | --- | ---------- |
...
â‘ Oparin suggested that the atmosphere of the primitive earth
|     | contained |     | NH3, |     |     | H2, | water |     | vapour |     | (H2O |     | (g)) | and |     | CH4. |     | He  |
| --- | --------- | --- | ---- | --- | --- | --- | ----- | --- | ------ | --- | ---- | --- | ---- | --- | --- | ---- | --- | --- |
suggested that at high temperature (above boiling point), these
gases could have undergone a series of chemical reactions and
|     | might | have |     |     | formed |     |     | colloidal |     | aggregates |     |     |     | or  | coacervates |     |     |     |
| --- | ----- | ---- | --- | --- | ------ | --- | --- | --------- | --- | ---------- | --- | --- | --- | --- | ----------- | --- | --- | --- |
(collections of droplets that composed of molecules of different

âœ“ types). Oparin considered that these coacervates were able to
...
|     | small  |         | polymers. |         |            |         |     |         |        |           |           |             |         |           |          |         |     |       |
| âœ“   | In     | 1953,   |           | Stanley |            | Miller  |     |         | tested |           | the       | biochemical |         |           |          | theory. |     | He    |
applied electrical sparks repeatedly through a mixture of gases
|     | (NH3,      |     | water, |     | H2  | and |       | CH4) | that |     | were    |     | represent |     |     | the | primitive |     |
| --- | ---------- | --- | ------ | --- | --- | --- | ----- | ---- | ---- | --- | ------- | --- | --------- | --- | --- | --- | --------- | --- |
|     | atmosphere |     |        |     | of  | the | earth |      | (no  |     | oxygen) |     | connected |     |     |     | a flask   | of  |
|     | heated     |     | water. |     |     |     |       |      |      |     |         |     |           |     |     |     |           |     |

â– Miller leaving the equipment for longer periods of time, a larger
...
| -------- | ----------- | ------------ | --- | ------ | ---- | --------- | --------- | --- | -------- | ------- | --- | --------- | --- | ------ | ---- |
| â–        | There       | have         |     | been   |      |           | many      |     | theories |         | of  | evolution |     | that   | have |
|          | explained:- |              | how |        | does |           | evolution |     |          | happen? |     | And what  |     | drives | the  |
|          | population  |              | to  | become |      |           | a new     |     | species? |         |     |           |     |        |      |
| A.       | Lamarck     | Theory       |     |        | of   | evolution |           |     |          |         |     |           |     |        |      |
â–
In the 19th century (1809), Lamarck published a paper entitled
|     | Philosophic |     |     | â€žZoologiqueâ€Ÿ |       |      |        | in      | which |     | he described     |            | the | two-part |        |
| --- | ----------- | --- | --- | ------------ | ----- | ---- | ------ | ------- | ----- | --- | ---------------- | ---------- | --- | -------- | ------ |
|     | mechanism   |     |     | by           | which |      | change |         | was   |     | gradually        | introduced |     | into     | the    |
|     | species     | and |     | passed       |       | down |        | through |       |     | the generations. |            |     | This     | theory |
is also called â€žtheory of transformationâ€Ÿ or Lamarckism. The two
|     | parts | of Lamarck |     |     | theory |     | are: |     |     |     |     |     |     |     |     |
| --- | ----- | ---------- | --- | --- | ------ | --- | ---- | --- | --- | --- | --- | --- | --- | --- | --- |
â–
|     |     | Use and     |     | disuse |          |     |     |        |     |     |     |     |     |     |     |
| --- | --- | ----------- | --- | ------ | -------- | --- | --- | ------ | --- | --- | --- | --- | --- | --- | --- |
...
| ---- | --------- | ------- | --------- | ---- | ------- | --- | --- |
â–ª Example, According Lamarck, giraffe had short neck but they
| stretched | their | neck        | to reach | high | branches, | developed | an  |
| --------- | ----- | ----------- | -------- | ---- | --------- | --------- | --- |
| elongated | neck  | use theory. |          |      |           |           |     |
â–ª The wings of penguins would have become smaller than those of
...
| ---------- | ----- | --- | ---- | --------- | --- | ---- | ---- | ------ | --- | --- | --- |
â– Note: - Nowadays, Lamarckâ€Ÿs theories are not accepted because
| the environmental |       |     | changes       |         | that | were | believed |            | by Lamarck |           | have |
| ----------------- | ----- | --- | ------------- | ------- | ---- | ---- | -------- | ---------- | ---------- | --------- | ---- |
| brought           | about |     | the           | changes |      | in   | the      | phenotypes |            | (Physical |      |
| appearance)       |       | of  | the organisms |         |      | have | no       | effect     | on their   | gametes   |      |
| and hence         | their |     | heredity.     |         |      |      |          |            |            |           |      |

| B.  | Charles   |       | Darwin |          | and        | Natural |            | Selection |     |        |     |           |         |          |         |         |
| --- | --------- | ----- | ------ | -------- | ---------- | ------- | ---------- | --------- | --- | ------ | --- | --------- | ------- | -------- | ------- | ------- |
| â‘   | In        | 1858, |        | both     |            | Charles |            | Darwin    |     | and    |     | Alfred    |         | Wallace  |         | jointly |
|     | published |       |        | a        | scientific |         |            | paper     |     | that   |     | proposed  |         |          | species | were    |
|     | modified  |       |        | by       | natural    |         | selection. |           |     | Darwin |     |           | visited |          | five    | of the  |
|     | Galapagos |       |        | Islands, |            | made    |            | drawings, |     | and    |     | collected |         | species. |         |         |
â‘ In particular, Darwin studied the finches found on the different
...
E.g. He suggested that some finches had evolved into insect eaters
...
|     | next    | generation. |           |     |            |              |       |      |        |            |         |          |     |       |           |     |     |     |
â–
|     | Now       |     | days | genes  |     | and    |     | gene    | action |     | are        | the |     | driving |     |     | force | of  |
| --- | --------- | --- | ---- | ------ | --- | ------ | --- | ------- | ------ | --- | ---------- | --- | --- | ------- | --- | --- | ----- | --- |
|     | evolution |     |      | in the |     | theory | of  | Natural |        |     | selection. |     |     |         |     |     |       |     |
â– A Gene pool is all the alleles in the population. It might be
|     | evolve |     | a   | population |     |     | into |     | a new |     | species. |     | Suppose |     |     | an  |     | allele |
| --- | ------ | --- | --- | ---------- | --- | --- | ---- | --- | ----- | --- | -------- | --- | ------- | --- | --- | --- | --- | ------ |
determines a feature that gives an organism an advantage in its
environment.
...
| ---- | ---- | ----- | ------------ | ------ | -------- | -------- | -------- | ----- | --------- |
| upon | the  | first | moving       | object | after    | they are | hatched. |       |           |
...
â‘
Infectious diseases and Immunity
âž¢ Infectious diseases:-
ï† Are diseases caused by infectious agents like bacteria,
viruses, fungi, protozoa, helminthes & prions
ï† It occurs as the result of interactions b/n pathogenic
(disease-producing) microorganisms and the host.

â‘ A pathogen must accomplish the following steps in order to
cause infectious disease :-
ï‚ Pathogens must be able to enter the host body
ï‚ Adhere to specific host cells
ï‚ Invade and colonize host tissues
ï‚ It must metabolize and multiply on or in the host tissue.
ï‚ It must resist host defenses
ï‚ It must damage the host. (i.e. via production of toxins or
destructive enzymes ).
...
| ----------------- | --------- | ----------- | ------ | ---------------- | -------- | -------- | ----- | ---- |
| ï† Pathogenicity:- |           | The ability | of     | Mos              | to cause | disease  |       |      |
| ï† Virulence:-     | refers    | to a        | degree | of pathogenicity |          |          |       |      |
| âž¢ virulent        | Pathogens |             | causes | significant      |          | disease, | while | an a |
| virulent          | causes    | reduced     | or no  | disease          |          |          |       |      |

â‘ Pathogens  are classified based on their pathogenicity:-
Primary pathogen is microbe or virus that causes disease in
1.
healthy individual (i.e. Immunocompetent )
| 2. Opportunistic |     | pathogen | (opportunist) |     | causes | disease | only |
| ---------------- | --- | -------- | ------------- | --- | ------ | ------- | ---- |
when body's innate or adaptive defenses are compromised (i.e.
Immunocompromized).
â‘ Patterns of infection------In a host, 2 basic patterns of infection
| a)Localized | infection:- |     | Pathogen | replication | remains |     |     |
| ----------- | ----------- | --- | -------- | ----------- | ------- | --- | --- |
localized near the site of entry - e.g. skin, respiratory or the GI tract
...
ï†Septicemia: growth of bacteria in the blood
ï†Toxemia: toxins in the blood
ï†Viremia: viruses in the blood

â‘ Persistent infection
âž¢ The majority of infections are cleared but certain pathogens may
| cause   | persistent    | infections. |     |     |
| ------- | ------------- | ----------- | --- | --- |
| â‘ Types | of persistent | infection   |     |     |
âž¢ Chronic infections---are those in which replicating Phatogenes
| can | be continuously | detected |     |     |
| --- | --------------- | -------- | --- | --- |
âž¢ Latent infections----are those in which the pathogen persists in
the time.
| an occult | (hidden) | form | most | of  |
| --------- | -------- | ---- | ---- | --- |

| â‘ Routes of  | entry/Exit of pathogens  in humans |     |     |     |
| ------------ | ---------------------------------- | --- | --- | --- |
âž¢ Respiratory Tract
âž¢ GI Tract
âž¢ Skin
| âž¢ Urogenital |     | Tract  |     |     |
| ------------ | --- | ------ | --- | --- |
âž¢ Conjunctiva
âž¢ blood borne: by: Needles, insect vectors, blood Transfusion
â‘ Transmission of Phatogens :- The process of transfer of Pathogens
| between | hosts | is referred | to as | transmission |
| ------- | ----- | ----------- | ----- | ------------ |
âž¢ Generally, there are 3 types pathogen transmission in animals
...
| --- | -------------- | --- | ------------ | --- | ----------- | --- | ---------------- | --- | --- | --- | -------------- | --- |
|     |                | E.g | -Toxoplasma, |     |             |     | Cytomegalovirus; |     |     |     | HBV            |     |
C. Zoonoses--- infectious agent is transmitted from an animal other
|     | than                  | a human, |     |     | to a  | human.        |     |     |     |      |     |     |
| --- | --------------------- | -------- | --- | --- | ----- | ------------- | --- | --- | --- | ---- | --- | --- |
|     | - E.g                 | Rabies   |     |     | virus | (Rhabdovirus) |     |     | --- | Dog, | fox |     |
|     | - Cryptosporidium---- |          |     |     |       |               | Cow |     |     |      |     |     |

â‘Causative agent of infectious disease
âž¢ Common pathogens known as causative agents for different
...
protozoa
worms
âž¢ They vary in their size, shape, function, genetic content.

.
1 Bacteria
âž¢ Unicellular prokaryotic organisms, having  circular genomes,
âž¢ ds DNA that is associated with much less protein.
âž¢ Reproduce by binary fission.
âž¢ The most common morphologies are bacillus (rod-shaped),
| coccus | (spherical), or spirillum |     |     | (helical rods).  |     |     |     |     |
| ------ | ------------------------- | --- | --- | ---------------- | --- | --- | --- | --- |
â‘ 2 classes based on their cell wall structures(Gram stain rxn)
...
| tuberculosis, | upper | respiratory | tract infection, | & STI | .   |
| ------------- | ----- | ----------- | ---------------- | ----- | --- |
â‘ Bacterial infections can be treated with antibiotics

|     | 2. Viruses - |     |     |     | Infect all types of organisms  |     |     |     |     |     |     |     |     |     |     |     |     |
| --- | ------------ | --- | --- | --- | ------------------------------ | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
âž¢
They are  not organisms themselves b/c  apart from a host cell,
have no metabolism & cannot reproduce.
| âž¢   | Composed     |        |             | of  | a       | viral             | nucleic   | acid      |            | &    | surrounded |      |         | by      | a        | protein |     |
| --- | ------------ | ------ | ----------- | --- | ------- | ----------------- | --------- | --------- | ---------- | ---- | ---------- | ---- | ------- | ------- | -------- | ------- | --- |
|     | coat         | called |             | a   | capsid; |                   | in some   |           | additional |      |            |      | outer   | lipid   |          | Layer   |     |
|     | called       |        | envelope    |     |         |                   |           |           |            |      |            |      |         |         |          |         |     |
| âž¢   | viruses      |        | classified  |     |         | based             | on        | shape,    |            | size | &          | type | of      | genome. |          |         |     |
| âž¢   | E.g.         | .      | Classifying |     |         | based             | on genome |           |            | (as  | DNA        |      | &       | RNA     | viruses) |         |     |
| âž¢   | DNA          |        | viruses     |     | -       | herpes            | viruses   |           | that       |      | cause      |      | chicken |         | pox,     | cold    |     |
|     | sores        |        | & poxvirus  |     |         | that              | causes    | smallpox. |            |      |            |      |         |         |          |         |     |
| âž¢   | RNA          |        | viruses     |     |         | - Paramyxoviruses |           |           |            |      | causes     |      | flu,    |         | measles  |         | &   |
|     | Retroviruses |        |             |     | that    | cause             | AIDS.     |           |            |      |            |      |         |         |          |         |     |

3. Fungi
âž¢ Eukaryotic, heterotrophic organisms that have rigid cellulose/
chitin-based cell walls
âž¢ Reproduce primarily by forming spores
âž¢ Most are multicellular, although some, such as yeasts, are
unicellular.
âž¢ Examples of diseases caused by fungi are ringworm &
histoplasmosis (a mild to severe lung infection transmitted by
...
âž¢ Do not have cell walls, they are capable of a variety of rapid and flexible
movements.
âž¢ Acquired through contaminated food or water or by the bite of an infected
| arthropod | such | as a mosquito. |     |     |
| --------- | ---- | -------------- | --- | --- |
âž¢ Diarrheal disease can be caused by two common protozoan parasites,
| Giardia | lamblia | and Cryptosporidium |     | parvum. |
| ------- | ------- | ------------------- | --- | ------- |
âž¢ Malaria, a tropical illness that causes 300 million to 500 million
cases of disease annually, is caused by different species of the
| protozoan | Plasmodium. |     |     |     |
| --------- | ----------- | --- | --- | --- |

5. Helminths
âž¢ They are simple, multicellular invertebrate animals
âž¢ some of which are infectious parasites.
...
ï†The true roots of the study of the immune system date
from 1796 by the work of an English physician,
Edward Jenner and
ï†Louis Pasteur (established the cause of infectious
diseases and the medical basis for immunization).
...
1. Nonspecific (Innate) Defense Mechanisms : defense that protect us
...
| --- | ------------- | --- | --- | ------------ | --- | --- | -------- | --- | --- | ---------- | --- | --- |
specialized lymphocytes called T cells; effective against bact.
and viruses located within phagocytic or infected host cells and
|     | against | fungi, | protozoa |     |     |     |     |     |     |     |     |     |
| --- | ------- | ------ | -------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

â‘ Adverse immune reactions /responses
âž¢ They can occur and cause adverse effects or severe tissue
damaging reactions (immunopathology) due to several reasons
such as:-
â–ª Exaggerated immune response
â–ª producing inappropriate immune response against self
components.
â–ª Due to failure of appropriate recognition mechanism.
âž¢ The three types of immunological disorders:-
1. Hypersensitivity
...
Figure 12-2
y immunological mechanisms that cause tissue damage

2.
Autoimmunity:- Results from a failure or breakdown of the
mechanisms normally responsible for maintaining self-tolerance in B
cells, T cells, or both.
â‘ Autoimmune disease can be divided into:
â‘ organ-specific & systemic
âž¢ Organ specific are target only one organ. E.g. Type 1 diabetes
damages the pancreas.
âž¢ Systemic is therefore affects multiple organs& have a tendency
to become chronic b/c the autoantigens can never be cleared E.g.
systemic lupus erythematous (SLE), affect the whole body.


3.
Tumor Immunology
In most organs and tissues of a mature animal, a balance
â‘
is usually maintained between cell renewal and cell death.
â‘ Under normal circumstances, the production of new
cells is regulated so that the number of any particular
type of cell remains constant.
â‘ Some times, though, cells arise that no longer respond to
normal growth-control mechanisms.
â‘ These cells give rise to clones of cells that can expand to
a considerable size, producing a Tumor, or neoplasm.

â‘ Tumor is
â‘Two types of tumor
âž¢ A tumor that is not capable of indefinite growth & does not
invade the healthy surrounding tissue extensively is benign.
âž¢ A tumor that continues to grow and becomes progressively
invasive is malignant; the term cancer refers specifically to a
malignant tumor.

4. Immunodeficiency diseases
â‘ Immunodeficiency (ID)- occur when one or more components of
the immune system is defective
â‘ Classified as primary or secondary
Primary: caused by mutations affecting any of a large number of
genes that control the expression and activities of immune
response.
Secondary: are acquired as a consequence of other diseases, or are
secondary to environmental factors such as starvation, or are an
adverse consequences of medical intervention
END of UNIT 6
...
âœ“ What is Taxonomy?
âœ“ How diversified organisms the world are managed to be studied?
âœ“ Explain the differences between classification, nomenclature and
identification
...
| i. Classification: |     |     | Is       | ordering/assignment |            |               | of organisms |            | into |
| ------------------ | --- | --- | -------- | ------------------- | ---------- | ------------- | ------------ | ---------- | ---- |
| hierarchy          |     | of  | ranks    | or                  | categories | distinguished |              | by certain |      |
| characters;        |     | or  | based on | similarities        |            | and/or        | differences. |            |      |
ii. Nomenclature: Is the naming of groups of organisms and the
| rules | governing |     | the application |     | of  | the names. |     |     |     |
| ----- | --------- | --- | --------------- | --- | --- | ---------- | --- | --- | --- |
iii. Identification: Is the naming of an organism or a specimen by
| reference |     | to  | an already |     | existent | classification. |     | It involves |     |
| --------- | --- | --- | ---------- | --- | -------- | --------------- | --- | ----------- | --- |
referring an individual specimen to a previously classified and
named system.

7.1. Early Attempts to Classify Organisms
Brainstorming questions:
1. How taxonomy is growing as a science?
2. What are the specific contributions of early naturalists for the
...
âž¢ Aristotle: was a Greek philosopher who contributed most extensively to the
development of the modern biology.
âœ“ He viewed life was hierarchical and he classified organisms, mainly history of
Animals.
âž¢ Theophrastus: was a keen observer and was the first taxonomist to write down a
classification in a permanent and logical form. For this reason, he was called the
father of
Botany by Linnaeus.
âœ“ As to him, any given organisms is either A or not A.
âœ“ According to his classification system, there are no any intermediate organisms.
...
definite morphological criteria mainly on the basis of habit, fruits, seeds,
| and ovaries | and their | position. |     |     |     |     |
| ----------- | --------- | --------- | --- | --- | --- | --- |
âž¢ Linnaeus and Post Linnaean Classifications Linnaeus produced
important books that he classified all known animals, plants and minerals.
âœ“ Linnaeus was the father of modern taxonomy, and his classification system
was popular largely because its simplicity and was artificial.

âž¢ Adanson is most remembered for championing the idea that in classification one
should use a great range of characters covering all aspects of the organisms.
âž¢ Lamarck is best known for his theory of evolution, Lamarckism, whereby
characters acquired during life become inherited.
âž¢ The evolutionary theory of Darwin had little immediate impact on classifications of
organisms.
âž¢ The previous classifications were based on morphological similarities or
dissimilarities.
âž¢ However, the early classification systems were broad and vague as indicated by
generic terms like animals, worms, sedges, grasses and trees, etcetera.

7.2. Modern Views of Classification (Schemes of Classification)
1. What are the modern views of classification?
2. How the modern views of classification are based up on?
âž¢ Unlike the early classifications the modern classification system of
diversified organisms is depend up on the combined evidence of
morphology, ultrastructure and molecular phylogeny.
âž¢ In classification, though it is organisms that are being classified,
their characters /character states are used to classify or categorize
organisms.
...
classification.
âœ“ only one or at most a few characters are selected for use in
making comparison among organisms i.e. a few characters are involved.
...
| -------- | ------ | --- | ------ | --------- | --- |
âœ“ Adanson and De Jussieu are good examples of natural classification system.

| 7.2.3. Phyletic | or Evolutionary |     | classification |     | system |
| --------------- | --------------- | --- | -------------- | --- | ------ |
âž¢ It is a classification that aims at reconstructing a sequence starting with the
most primitive character and ending with the most advanced or derived
character.
âž¢ It ensures that each taxon recognized as a monophyletic i.e. has arisen by
| the diversification |                | of a single | ancestor. |     |     |
| ------------------- | -------------- | ----------- | --------- | --- | --- |
| 7.2.4. Phenetics    | classification |             | system    |     |     |
âž¢ This is a classification where similarity/resemblance is determined based
| on a set | of phenotypic | characteristics |     | of organisms. |     |
| -------- | ------------- | --------------- | --- | ------------- | --- |
âž¢

| 7.2.5. | Phylogenetic |     | or cladistics |     | classification |     | system |     |
| ------ | ------------ | --- | ------------- | --- | -------------- | --- | ------ | --- |
âž¢
| It         | is  | the             | concepts |           | and | methods  | of            | determining |
| ---------- | --- | --------------- | -------- | --------- | --- | -------- | ------------- | ----------- |
| similarity |     | by constructing |          | branching |     | patterns | of evolution. |             |
âž¢ Once the cladogram or tree of life is generated, it is possible to
| construct |     | classification |     | based | upon | the cladogram. |     |     |
| --------- | --- | -------------- | --- | ----- | ---- | -------------- | --- | --- |
7.3. Domains of Life and the Hierarchical System of Classification
. What are the major domains of life?
1
2. How organisms are arranged in the hierarchical classification?
3. Discuss about the different kingdom concepts, and which
...
| ------------- | ----- | -------- | ---- | ------------ | ------ | --- |
classification.
âž¢ The three domains are identified and organized based on the
difference between eukaryotes and prokaryotes (Domain Archae bacteria,
| Eubacteria and | Eukarya). |     |     |     |     |     |
| -------------- | --------- | --- | --- | --- | --- | --- |

| Diagrammatical |                | representation |     |     | of mammal |     | and | insect | and |
| -------------- | -------------- | -------------- | --- | --- | --------- | --- | --- | ------ | --- |
| hierarchical   | classification |                |     |     |           |     |     |        |     |
In a hierarchical system, we start at the bottom with individuals
| (species) | and | end | up at | the top | with | one | all-embracing |     | taxon |
| --------- | --- | --- | ----- | ------- | ---- | --- | ------------- | --- | ----- |
(Domain).

| The major | levels |     | in the hierarchy | are | the following |     |     |     |
| --------- | ------ | --- | ---------------- | --- | ------------- | --- | --- | --- |
âž¢
Species are a series of recognizably similar individuals distinct
| from | other | species; |     |     |     |     |     |     |
| ---- | ----- | -------- | --- | --- | --- | --- | --- | --- |
...
âž¢ In biology, Kingdom (Latin: regnum, pl. regna) is a taxonomic rank, which is the
highest rank or in the more recent three-domain system, it is the second rank below
| the    | Domain. |         |                  |         |        |            |
| ------ | ------- | ------- | ---------------- | ------- | ------ | ---------- |
| i) The | Two-    | Kingdom | Concept/Approach |         |        |            |
| âœ“ The  | two     | kingdom | concept          | existed | before | the 1950s. |
âœ“ This concept was classifying organisms based up on the cell wall present versus
| absent            |     | (Kingdom | Plantae | and Animalia) |     |     |
| ----------------- | --- | -------- | ------- | ------------- | --- | --- |
| ii) Three-Kingdom |     |          | Concept |               |     |     |
âœ“ This kingdom concept/approach classifies all organisms in to three Kingdoms
| (kingdom |     | Plantae, | Animalia | and | Protista) |     |
| -------- | --- | -------- | -------- | --- | --------- | --- |
âœ“ (Kingdom Protista is for the intermediates, like some algae and protozoa, which
| behave   |              | like both | plants  | and animals) |     |     |
| -------- | ------------ | --------- | ------- | ------------ | --- | --- |
| iii) The | Four-Kingdom |           | Concept |              |     |     |
âœ“ Kingdom Plantae, Animal, Protista and Fungi. Fungi are organisms
| that | do  | have both | plant | and animal | characteristics. |     |
| ---- | --- | --------- | ----- | ---------- | ---------------- | --- |

| iv) The | Five-Kingdom | Concept |     |     |     |
| ------- | ------------ | ------- | --- | --- | --- |
âž¢ After the invention of the Transmission Electron Microscope (TEM), some
biologists were able to investigate the composition of the cell.
âž¢ The five kingdoms are Kingdom Monera, kingdom Fungi, kingdom Protista,
| kingdom | Plantae     | and kingdom | Animalia |     |     |
| ------- | ----------- | ----------- | -------- | --- | --- |
| vi) The | Six-Kingdom | Concept     |          |     |     |
âž¢ This concept classifies first kingdom monera in to two groups based on the
| nucleus | and other | organelles | have or | lacking | a membrane. |
| ------- | --------- | ---------- | ------- | ------- | ----------- |

7.4. Binomial Nomenclature
1. What is the binomial nomenclature?
2. How the binomial nomenclature is applicable for organisms?
3. What are the preconditions for giving binomial nomenclature for
organisms?
4. What is the purpose of giving scientific names for organisms?
5. What are characteristics scientific names?
6. What are operative principles of nomenclature?
7. How authorities of scientific names are cited?

| âž¢ Nomenclature |     | is the      | naming   | of     | organisms | and | the | rules |
| -------------- | --- | ----------- | -------- | ------ | --------- | --- | --- | ----- |
| governing      | the | application | of these | names. |           |     |     |       |
âž¢
| The            | rules        | of nomenclature |                | begin | from     | Linnausâ€Ÿs |     | of   |
| -------------- | ------------ | --------------- | -------------- | ----- | -------- | --------- | --- | ---- |
...
| --------- | ----- | --- | --- | ------- | ---------- | ------------ | --- | --------- | ------ | ------ | ----- | ------------ | --------- | ------ | ----------- | --- | --- | ---- |
| âž¢         | Name  |     |     | is      | a          | conventional |     |           |        | symbol |       | or code      |           | that   | serves      |     |     | as a |
|           | means |     |     |         |            | of           |     | reference |        |        |       | and          |           | avoids |             |     |     | the  |
|           | need  |     | for |         | continuous |              |     |           | use    |        | of an | inconvenient |           |        | descriptive |     |     |      |
phrase
| âž¢   | It           | is  |           | used |       | for          | act      |     | as      | vehicle |        | of       | communication, |        |        |         |     | to  |
| --- | ------------ | --- | --------- | ---- | ----- | ------------ | -------- | --- | ------- | ------- | ------ | -------- | -------------- | ------ | ------ | ------- | --- | --- |
|     | universalize |     |           |      |       | the          | organism |     |         |         | and to | avoid    |                | any    | names. |         |     |     |
| âž¢   | The          |     | Code      |      | of    | nomenclature |          |     |         |         | tries  | to avoid |                |        | the    | defects |     | of  |
|     | vernacular   |     |           |      |       | names        |          |     | and     |         | for    | this     |                | reason |        | sets    |     | of  |
|     | rules        |     | have      |      | been  |              | drawn    |     |         | up.     |        |          |                |        |        |         |     |     |
| âž¢   | Scientific   |     |           |      | names |              |          | are | written |         | in     | Latin    | form           |        | as     | well    | as  | in  |
|     | Latin        |     | alphabet. |      |       |              |          |     |         |         |        |          |                |        |        |         |     |     |

| 7.4.2. International |     | Code nomenclature |     |     |     |     |     |     |
| -------------------- | --- | ----------------- | --- | --- | --- | --- | --- | --- |
âž¢ The code is a rulebook that contains principles, rules and recommendations which
| form  |               |                  |     |     |     |     |     | the |
| ----- | ------------- | ---------------- | --- | --- | --- | --- | --- | --- |
| basis | of the system | of nomenclature. |     |     |     |     |     |     |
7.4.3. International Organizations & Unions for the Stabilization of Changes
| âž¢ ICBN: | International | Botanical | Congress;      |               |     |     |     |     |
| ------- | ------------- | --------- | -------------- | ------------- | --- | --- | --- | --- |
| âž¢ ICZN: | International | Congress  | for Zoological | Nomenclature. |     |     |     |     |
âž¢ ICTF : The International Commission for the Taxonomy of Fungi
| 7.4.4. Names | of taxa | (the rank | of the genus | and above) |     |     |     |     |
| ------------ | ------- | --------- | ------------ | ---------- | --- | --- | --- | --- |
âž¢
The family names consist of one term only and called uninominal names. Family
| names       | are          | written    | with                  | a capital |     | initial  | letter. | E.g. |
| ----------- | ------------ | ---------- | --------------------- | --------- | --- | -------- | ------- | ---- |
| Asteraceae, | Lamiaceae.   |            |                       |           |     |          |         |      |
| âž¢ Names     | of           | the genera | are                   | uninomial | and | singular | nouns   | and  |
| written     | with capital | initial    | letter. E.g. Hagenia, | Datura    |     |          |         |      |
âž¢ Names of the species consist of two terms, and called binomial
...
Chapter 8: Ecology & Conservation of Natural Resources(3 Hrs)
8.1 Definitions of ecological terms & Basic concepts of Ecology
âœ“ What is Ecology?
âœ“ Why we study Ecology?
...
âž¢ laboratory experiments that analyze processes such as predation rates in
controlled settings; or
âž¢ field experiments, such as testing how plants grow in their natural setting
but with different levels of light, water, & other inputs.

â–ª Ecological terminologies & their definitions
The following are ecological terms, very essential to understand
the general concept of ecology.
1. Abiotic: all non-living components in the biosphere, e.g., air,
water, soil, climate.
2. Biotic: all the living components in the biosphere: animals,
plants, micro-organisms, etc.
3. Autotrophic: when an organism is able to produce its own
food using abiotic components.
4. Biosphere: it is the global sum of all ecosystems, & is the
zone where all living organisms live on earth. Or,
âž¢ It is the whole portion of Earth colonized by living things.

5. Biome: the biosphere is divided into millions of biomes, based on
the specific climate of each region, where the climate determines
...
other for survival.
8. Herbivores: are animals that only eat plants, e.g., buck, cows,
goats, sheep, rabbits, etc.
9. Heterotrophic: when an organism is unable to produce its own
food, & must eat other organisms.
10. Omnivores: are animals that eat both plant & animal matter, e.g.,
humans, pigs, baboons.
...
e.g., marine ecology, tropical ecology, freshwater ecology

a) Hierarchical structure of ecological systems (Figure 1)
1) Organism: fundamental unit of ecology. No smaller unit in biology
has an independent life in the environment.
2) Population: A group of organisms consisting of a number of different
populations that live in defined area & interact with each other.
3) Community: A group of organisms consisting of a number of different
species that live in an area & interact with each other
...
1) Population ecology (or Autecology)
â– It is concerned with population growth including birth rates & death
rates, fluctuation, spread & interactions (scientific study of
relationships between organisms of the same species).
2) Community ecology (or Synecology)
o Community ecology is the scientific study of relationships between (b/n)
organisms of different species.
3) Ecosystems ecology, having to do with the structure & function of the
entire suite of microbes, plants, & animals, & their abiotic environment, &
how the parts interact to generate the whole.
This branch of ecology often focuses on the energy & nutrient flows of
ecosystems, & when this approach is combined with computer analysis &
simulation, it is often called systems ecology.

4) Evolutionary ecology: which may operate at any of these levels but
most commonly at the physiological or population level, is a rich
& dynamic area of ecology focusing on attempting to
understand how natural selection developed the structure &
function of the organisms & ecosystems at any of these levels.
5) Conservation ecology: -it deals with methods of proper management
of natural resources such as land, water, forests, sea, mines,
etc., for the benefit of human beings.
8.3 Aquatic & terrestrial ecosystems
â– A natural ecosystem is an assemblage of plants & animals, which
functions as a unit & is capable of maintaining its identity such as
| forest,     | grassland,   | an estuary. |         |           |              |            |
| ----------- | ------------ | ----------- | ------- | --------- | ------------ | ---------- |
| âœ“ human     | intervention |             | is an   | example   | of a natural | ecosystem. |
| â– A natural | ecosystem    | is          | totally | dependent | on solar     | energy.    |

| â–   | There | are         | two | main categories |     | of  | ecosystems. |     |     |
| --- | ----- | ----------- | --- | --------------- | --- | --- | ----------- | --- | --- |
|     | 1)    | Aquatic     |     | ecosystem       |     |     |             |     |     |
...
a) Marine ecosystems cover about 71% of the earth's surface &
|     | contain | about |     | 97% of | the planet's |     | water. |     |     |
| --- | ------- | ----- | --- | ------ | ------------ | --- | ------ | --- | --- |
â– They are distinguished from freshwater ecosystems by the presence
|     | of dissolved |     |     | compounds, | especially |     | salts, | in the | water. |
| --- | ------------ | --- | --- | ---------- | ---------- | --- | ------ | ------ | ------ |
...
â–ª Other lotic ecosystems-freshwater wetlands: Marshes & swamps:
â– Wetlands are valued wildlife habitats of migratory birds, beaver,
otters, muskrats, & game fishes; they provide natural flood control
& serve as groundwater recharging areas.
â– Grass like plants dominate in marshes, while woody trees &/or
shrubs dominate in swamps.
â–ª Estuaries: are where fresh & salt water meet.
i. Estuaries are among the most fertile ecosystems in the world
ii. Temperate estuaries usually contain salt marshes which are
important in preventing flood damage during storm surges
iii. Mangrove forests are the tropical equivalent of salt marshes; they
cover nearly 70% of tropical coastlines.
âž¢ Mangroves are breeding ground & nurseries for several
commercially important fishes, shellfish, & birds.
âž¢ They also help prevent coastal erosion & provide a barrier
against the ocean during storms/hurricanes.

2) Terrestrial ecosystems
â– Question: write the different ecosystems with their basic features
â– Terrestrial ecosystems include:
a) Forests
b) Grasslands,
c) Farmland
d) Deserts &
e) tundra
a) Forests: are large areas supporting rich growth of trees.
â– Depending on the climate & type of trees, forests are generally
grouped into:
i. Tropical rain forests
ii. Temperate deciduous forests
iii. Boreal or north coniferous forests include

8.4 Energy flow through ecosystems
â– Energy flows into ecosystems from outside source, sun.
â– Energy flows through ecosystem with the help of producers, food
chains & food webs.
â– Energy leaves ecosystems as a result of metabolic activities (mostly
by aerobic respiration) of each organism.
â– The transfer of energy from plants through a series of organisms by
eating & being eaten constitutes food chains.
â– At each transfer, a large proportion of energy is lost in the form of
heat.
â– These food chains are not isolated sequences, but are interconnected
with each other. This interlocking pattern is known as the food web.
Figure 2: A diagram
showing how energy flows
in an ecosystem

8.4.1 The food chains & trophic levels
â– The transfer of food - energy from plants to animals & then to other
animals by successive stage of feeding is called a food chain.
â– A food chain is also defined as "the sequence of organisms that are
related to each other for their source of food."
â– In an ecosystem, energy is transferred through a series of organisms,
each feeding on the preceding organisms & providing raw materials &
energy for the next organisms.
â– Each stage of the food chain or food web is known as trophic level.
â– The first trophic level is occupied by the autotrophic organisms, so
they are called producers.
âœ“ E.g., plants sheep man
â– Hence, green plants occupy the first level, herbivores the 2nd level,
carnivores the 3rd level & secondary carnivores the 4th level.
â– These trophic levels together form the ecological pyramid.

â–ª In nature, basically two types of food chains are recognized:
1) grazing food chain &
2) detritus food chain
1) Grazing food chain: starts from the living green plants & goes to
grazing herbivores & on to the carnivores.
â– Ecosystems with such type of food chain are directly dependent on
an influx of solar radiation.
â– Thus, this type of food chain depends on autotrophic energy
capture & the movement of this energy to herbivores.
â– Most of the ecosystems in nature follow this type of food chain.
â–ª The following are examples of grazing food chain:
âœ“ Aquatic food chain: Phytoplanktons zooplanktons fish
âœ“ Terrestrial food chain :Grasses Rabbit fox

2) Detritus food chain
â– The organic wastes, exudates & dead matter derived from the grazing food
chain are generally termed as detritus.
â– The energy contained in this detritus is not lost to the ecosystem as a whole;
...
â– The detritus food chain represents an exceedingly important component in the
energy flow of an ecosystem.
â– Indeed in some ecosystems, considerably more energy flows through the
detritus food chain than through the grazing food chain.
â– The organisms of the detritus food chain are many & include algae, bacteria,
slime molds, actinomycetes, fungi, protozoa, insects, mites, crustacea,
centipedes, molluscs, rotifers, annelid worms, & nematodes. E.g.,
âœ“Dead OM bacteria protozoan nematode
...
â– If the linkages in the chains that make up the web of life are disrupted due to
human activities that lead to the extinction of species, the web will breaks
down.
b
e
w
...
8.4.3 Ecosystem productivity
â– Productivity in land ecosystems generally rises with temperature about 30oC,
after which it declines, & is positively correlated with moisture.
â– On land primary productivity is highest in warm, wet zones in the tropics
where tropical forest biomes are located.
â– In contrast, desert scrub ecosystems have the lowest productivity because
their climates are extremely hot & dry.
A. Primary production
â– The flow of energy through a terrestrial ecosystem starts with the harnessing
of sunlight by green plants, a process that in itself demands the expenditure
of energy.
â– A plant gets its start by living on the food energy stored in the seed until it
produces leaves.

â– Energy accumulated by plants is called primary production, because it is the
first & basic form of energy stored.
â– Total energy assimilated by the plant is gross primary production.
â– Plants, like all other organisms, must expend energy in production,
maintenance, & reproduction.
â– This energy is produced by the process of respiration which liberates energy.
Energy remaining after respiration & stored as organic matter is net primary
production.
â– Net primary production can be described by the following equation:
âœ“ Net primary production (NPP) = gross primary production (GPP) - respiration
by the autotroph (R).
âœ“ Production is expressed in kilocalories per square meter (kcal/m2) & can also
expressed in grams per square meter (g/m2).

B. Secondary production
â– Net primary production is the energy available to the heterotrophic
component of the ecosystem.
â– The energy left over from maintenance & respiration goes into
production, including both the growth of new tissues & the
production of young.
â– This net energy of production is called secondary production.
Activities:
1. How does energy flow occur from one organism to another?
2. How many trophic levels can an ecosystem support?
3. Why do primary consumers get more energy than secondary consumers?
4. How much energy does a consumer obtain from producer?

8.4.4 Ecological pyramid
â– Ecological pyramid is the graphic representation of the number, biomass &
energy of the successive trophic levels of an ecosystem.
â– The concept of ecological pyramid was first described by Charles Elton.
â– Ecological pyramids represent the trophic structure (feeding relationships) &
trophic function (efficiency of energy transfer through biotic components) of
an ecosystem.
â–ª Types of ecological pyramid
a) Pyramid of number depicts the number of individual organisms at
different trophic levels of food chain.
b) Pyramid of biomass depicts the amount of biomass at different trophic levels of
food chain or the total weight of living matter per unit area present in the
ecosystem.
c) Pyramid of energy depicts the amount of energy at different trophic levels of food
chain.

8.5 Cycling of Materials (Nutrients)
â– Every ecosystem has several interrelated mechanisms that affect
human life.
â– These are the water, carbon, oxygen, nitrogen & energy cycles.
â– While every ecosystem is controlled by these cycles, in each
ecosystem its abiotic & biotic features are distinct from each other.
â– All the functions of the ecosystem are in some way related to the
growth & regeneration of its plant & animal species.
â– These linked processes can be depicted as the various cycles.
â– These processes depend on energy from sunlight.
â– During photosynthesis, CO is taken up by plants & oxygen is
2
released. Animals depend on this oxygen for their respiration.
â– The water cycle depends on the rainfall, which is necessary for
plants & animals to live.
â– Our own lives are closely linked to the proper functioning of these
cycles of life.
â– If human activities go on altering them, humanity cannot survive on
our earth.

Figure 6: An illustration showing water cycle

Figure 7: The Carbon Cycle

Figure 8: Phosphorus cycle

Figure 9: Nitrogen cycle

8.6 Conservation of natural resources
â‘ Principles of conservation of natural resources
â– The principles/strategies for conservation & sustainable use of
natural resources, it should be developed at a local level & be
adapted to local ecosystems, cultures, values & social & economic
conditions.
| â– Where    | necessary, | networks | of     | protected | areas,      |     | corridors | &   |
| ---------- | ---------- | -------- | ------ | --------- | ----------- | --- | --------- | --- |
| integrated | management | zones    | should | be        | established |     | first.    |     |
â– These principles & strategies are getting acceptance worldwide for
their effectiveness in sustainable natural resource management.
| â– Natural | resource | management |     | refers | to the | management |     | of  |
| --------- | -------- | ---------- | --- | ------ | ------ | ---------- | --- | --- |
natural resources such as land, water, soil, plants & animals, with a
particular focus on how management affects the quality of life for
| both present | & future | generations. |     |     |     |     |     |     |
| ------------ | -------- | ------------ | --- | --- | --- | --- | --- | --- |

â– The major strategies of natural resource management are in-situ &
ex-situ or both conservation methods.
â– The main principles of conservation of NRs are making decisions
| under | various |     | government |     |     | & public |     | participations, |     | revenue |
| ----- | ------- | --- | ---------- | --- | --- | -------- | --- | --------------- | --- | ------- |
protection policies, an insurance scheme incentivizing to diversify
& conserve natural resources, adopt alternative resource utilization
| strategies,     |         | & apply   |              | integrated |             | resources    |     | management |            | policies |
| --------------- | ------- | --------- | ------------ | ---------- | ----------- | ------------ | --- | ---------- | ---------- | -------- |
| among           | various |           | institutions |            | &           | individuals. |     |            |            |          |
| â– Additionally, |         | promoting |              |            | responsible |              | &   | effective  | governance |          |
| mechanisms      |         | are       | also         | better     |             | methods      | for | resource   | management |          |
principles.
â– The underpinning processes must also be participatory& involve all
key stakeholders, men, women, public & private sectors & civil
society.

8.7 Environmental pollution & public health
â– Developmental activities such as construction, transportation &
manufacturing not only deplete the natural resources but also
produce large amount of wastes that leads to pollution of air, water,
...
âœ“ Water pollution
âœ“ Soil pollution
âœ“ Thermal pollution
âœ“ Radiation pollution

â‘ Prevention and control of industrial pollution
â–ª Industrial pollution can be greatly reduced by:
...
b) Employing environment friendly industrial processes so that
emission of pollutants and hazardous waste is minimized.
c) Installing devices which reduce release of pollutants.
âœ“ Devices like filters, electrostatic precipitators, inertial collectors,
scrubbers, gravel bed filters or dry scrubbers are used to reduce
release of polluntants.

â‘ Control of vehicular pollution
â– The emission standards for automobiles have been set, which if
| followed | will | reduce | the | pollution. |     |
| -------- | ---- | ------ | --- | ---------- | --- |
â– Standards have been set for the durability of catalytic converters
| which | reduce | vehicular |     | emission. |     |
| ----- | ------ | --------- | --- | --------- | --- |
âœ“ In cities like Delhi, motor vehicles need to obtain Pollution under
| Control | (PUC) | certificate |     | at regular | intervals. |
| ------- | ----- | ----------- | --- | ---------- | ---------- |
âœ“ The price of diesel is much cheaper than petrol, which promotes use
of diesel. To reduce emission of sulphur dioxide, sulphur content in
| diesel | has been | reduced |     | to 0.05%. |     |
| ------ | -------- | ------- | --- | --------- | --- |
âœ“ Earlier lead in the form of tetraethyl lead was added in the petrol to
...
â‘ Control of water pollution
â– The following measures can be adopted to control water pollution:
(a) The water requirement should be minimized by altering the
techniques involved.
(b) Water should be reused with or without treatment.
(c) Recycling of water after treatment should be practiced to the
maximum extent possible.
(d) The quantity of waste water discharge should be minimized.

â‘ Control of soil pollution
â– Indiscriminate disposal of solid waste should be avoided.
â– To control soil pollution, it is essential to stop the use of plastic bags
and instead use bags of degradable materials like paper and cloth.
â– Sewage should be treated properly before using as fertilizer and
landfills.
â– The organic matter from domestic, agricultural and other waste
should be segregated and subjected to vermicomposting which
generates useful manure as a byproduct.
â– The industrial wastes prior to disposal should be properly treated
for removing hazardous materials.
â– Biomedical waste should be separately collected and incinerated in
proper incinerators.
...
plant nutrition, plant pathology, dendrology, phytochemistry,
| cell       | biology, |             | histology, |     | phytopathology, |     |     | phytogeography, |     |
| ---------- | -------- | ----------- | ---------- | --- | --------------- | --- | --- | --------------- | --- |
...
|     | Anabaena,         |             | Spirullin, |     |       | Oscilatotia, |            |       |         | etc.    |       |          |          |     |            |         |     |
| â–   | Chlorophyta:      |             |            | a   | group |              | of         | green |         | algae   |       | includes |          |     | Spirogyra, |         |     |
|     | Volvox,           | Oedogonium, |            |     |       |              | Chlorella, |       | and     | others. |       |          |          |     |            |         |     |
| â–   | Phaeophyta:       |             |            | a   | group |              |            | of    | brown   |         | algae |          | includes |     |            | Fucus,  |     |
|     | Laminaria,        |             | Sargassum, |     |       |              | Ectocarpus |       |         |         |       |          |          |     |            |         |     |
â–
|     | Rhodophyta: |     |               | a        | group      |     | of  | red    |     | algae      | includes |             |      | Polysiphonia, |     |         |     |
| --- | ----------- | --- | ------------- | -------- | ---------- | --- | --- | ------ | --- | ---------- | -------- | ----------- | ---- | ------------- | --- | ------- | --- |
|     | Coralline,  |     | etc.          |          |            |     |     |        |     |            |          |             |      |               |     |         |     |
| â–   | Charophyta: |     |               | Commonly |            |     |     | known  |     |            | as       | stoneworts, |      |               |     | usually |     |
|     | preferred   |     | less          |          | oxygenated |     |     |        | &   | hard       |          | water       |      | (Ca           |     | and     | Mg  |
|     | carbonates) |     | areas.Example |          |            |     |     | Chara, |     | Vaucheria, |          |             | etc. |               |     |         |     |
â–
|     | Euglenophyta: |         |     |     | Unicellular |     |     | fresh |     | water |     | algae, |     | plant-animal |     |     |     |
| --- | ------------- | ------- | --- | --- | ----------- | --- | --- | ----- | --- | ----- | --- | ------ | --- | ------------ | --- | --- | --- |
...
| ------------------------------------- | --- | -------------------------------------------------- | --- | --- | --------------------- | --- |
| (Liverworts) 2. Class Anthocertopsida |     |                                                    |     |     | (Hornworts) 3. Class  |     |
| Bryopsida                             |     | (Mosses)                                           |     |     |                       |     |
...
| ----------------- | ------------ | --- | ----- | ------ | ----- | ----------- | ------------- | ------- | ------ | --------------- | --- | ----- |
| is differentiated |              |     | into  | roots, |       | stems       |               | and     | leaves | or shoot        |     |       |
| The               | leaves       | of  | seed  | plants |       | are         | megaphyllous. |         |        |                 |     |       |
| The               | gametophytes |     |       |        | (male |             | and           | female) |        | are protected   |     | from  |
desiccation and injury by the protective covering of the ovules
| called | integuments |     |      | and    |     | later | embryo        |     | is  | protected | by the | seed |
| ------ | ----------- | --- | ---- | ------ | --- | ----- | ------------- | --- | --- | --------- | ------ | ---- |
| coat   | ortesta.    |     |      |        |     |       |               |     |     |           |        |      |
| The    | leaves      | of  | seed | plants |     | are   | megaphyllous. |     |     |           |        |      |
...
|             |       | â–Phylum |              | Radiata  |     |                  |     |                |     |
â–Acoelomate
|     |     |         |     |          | Bilateria | (flatworm  | and    | nemertines) |        |
| --- | --- | ------- | --- | -------- | --------- | ---------- | ------ | ----------- | ------ |
|     |     | â–Phylum |     | Nematoda |           |            |        |             |        |
|     |     | â–Phylum |     | Annelida |           | (segmented | worms, | bristle     | worms) |
|     |     | â–Phylum |     | Mollusca |           |            |        |             |        |
â–Phylum
Arthropoda
|     |     | â–Phylum |     | Echinodermata |     |     |     |     |     |
| --- | --- | ------- | --- | ------------- | --- | --- | --- | --- | --- |
...
|        | Class      |              | Nuda       |      | and  |         | Class           | Tentaculata |      |             |            |          |               |     |             |           |     |
...
âœ“ Mammals
| â–   | Hair     | provide    |       | Endothermy, |              |     |         | and | insulation, |          |           |     |      |         |       |        |      |
| --- | -------- | ---------- | ----- | ----------- | ------------ | --- | ------- | --- | ----------- | -------- | --------- | --- | ---- | ------- | ----- | ------ | ---- |
| â–   | Mammary  |            |       | Glands,     |              |     | secrete |     | milk,       | assured  |           | a   | food | supply  |       | during |      |
|     | the      | precarious |       |             | early        |     | life    | of  | the         | newborn. |           |     |      |         |       |        |      |
| â–   | Internal |            | fetal |             | development. |     |         |     |             | Among    | placental |     |      | mammals |       |        | (the |
|     | most     | common     |       |             | type)        |     | the     |     | circulatory |          | system    |     | of   | the     | fetus |        | and  |
mother become intimately intertwined within a placenta, where
|     | exchange |     | of  | nutrients |     |     | and |     | waste | products |     | can | occur. |     |     |     |     |
| --- | -------- | --- | --- | --------- | --- | --- | --- | --- | ----- | -------- | --- | --- | ------ | --- | --- | --- | --- |
