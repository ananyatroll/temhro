...
and
ïƒ˜attempts to introduce the
ïƒ˜fundamental concepts of logic and
ïƒ˜methods of logical argumentation and
reasoning and critical thinking
ïƒ˜critical thinking is the reasonable, reflective,
...
| ïƒ˜ constructive  |     |          | side:-  |     |   it     | attempts     | to  |     | formulate  |     |
| --------------- | --- | -------- | ------- | --- | -------- | ------------ | --- | --- | ---------- | --- |
| rational        |     | answers  |         | to  | certain  | fundamental  |     |     | questions  |     |
concerning
| ïƒ¼ the nature of reality,               |     |     |     |     |     |     |     |     |     |     |
| -------------------------------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ïƒ¼ the nature of value, and             |     |     |     |     |     |     |     |     |     |     |
| ïƒ¼ the nature of knowledge and truth.   |     |     |     |     |     |     |     |     |     |     |
ïƒ˜ critical  side -it  deals  with  giving  a  rational  critic,
...
world as a whole.
ïƒ˜Philosophy seeks to combine the conclusions of the
...
have sought answers.
ïƒ˜ Philosophy presses its inquiry into the deepest
...
| ïƒ˜   | It           | deals  | about  |     | the  |           | origin,  |     | nature,  |     |          | and  |
| --- | ------------ | ------ | ------ | --- | ---- | --------- | -------- | --- | -------- | --- | -------- | ---- |
|     | development  |        |        | of  | the  | universe  |          |     | as       | an  | orderly  |      |
system.
| ïƒ˜   | E.g.  | How  |     | did  | the  | universe  |     |     | originate  |     |     | and  |
| --- | ----- | ---- | --- | ---- | ---- | --------- | --- | --- | ---------- | --- | --- | ---- |
...
ïƒ˜ How do we justify our values?
ïƒ˜ What is the relationship between values and
knowledge?
ï¶Axiology deals three areas, namely Ethics,
...
principle?
ïƒ˜ Are moral principles universal, conditional or
unconditional?
ïƒ˜ What is the ultimate foundation of moral principles? The
...
raised by Logic:
ï¶What is an argument; What does it mean to argue?
ï¶What makes an argument valid or invalid
ï¶What is a sound argument?
ï¶What relation do premise and conclusion have in
argument?
ï¶How can we formulate and evaluate an argument?
...
ïƒ˜philosophy can assist us to actualize ourselves
by promoting the ideal of self-actualization.
ïƒ¼self-actualization
...
ïƒ˜criteria for evaluating the arguments of others and
ïƒ˜guides in constructing arguments of our own.
...
| ïƒ˜It  | helps  | us  | to  distinguish  |     | good  | arguments  |     | from  | bad  |
| ---- | ------ | --- | ---------------- | --- | ----- | ---------- | --- | ----- | ---- |
arguments
| ïƒ˜ It  | helps  | us  | to  understand  |     | and  | identify  | the  | common  |     |
| ----- | ------ | --- | --------------- | --- | ---- | --------- | ---- | ------- | --- |
...
| ï¶   | Not all passages that contain two or  |                 |      |     |        |     |             |     |          | more  |           | statements  |      |       |
| --- | ------------------------------------- | --------------- | ---- | --- | ------ | --- | ----------- | --- | -------- | ----- | --------- | ----------- | ---- | ----- |
|     | are                                   | argumentative.  |      |     | There  |     | are         |     | various  |       | passages  |             |      | that  |
|     | contain                               |                 | two  | or  | more   |     | statements  |     |          |       | but       |             | are  | not   |
argumentative.
| ï¶   | Argumentative  |     |           | passages  |     | are    |     | distinguished  |     |     |        | from  |          | such  |
| --- | -------------- | --- | --------- | --------- | --- | ------ | --- | -------------- | --- | --- | ------ | ----- | -------- | ----- |
...
from something.
| ï¶It  | is  | an  | objective  |     |     | feature  |     | of  | an  | argument  |     |
| ---- | --- | --- | ---------- | --- | --- | -------- | --- | --- | --- | --------- | --- |
...
ï¶ It  exists  if  there  is  an  inferential  relationship  between
the statements in a passage, but the passage contains no
| indicator words.  |          |              |               | e.g.   |          |      |            |      |                 |             |            |
| ----------------- | -------- | ------------ | ------------- | ------ | -------- | ---- | ---------- | ---- | --------------- | ----------- | ---------- |
| ïƒ˜The              | genetic  |              | modification  |        |          | of   | food       |      | is  risky       |             | business.  |
...
consumer.
ï¶ The  mere  occurrence  of  an  indicator  word  is  by  no
means a guarantee for the presence of an argument.
ï¶ Thus,  we  need  to  make  sure  that  the  existing  indicator
...
ïƒ˜ Also conditional statements are not evaluated as true or
...
ïƒ˜ Conditional statements are especially important in logic
...
ïƒ˜ However, a little reflection reveals that these two
statements say exactly the same thing.
ïƒ˜ Generally, non-argumentative passages may contain
components that resemble the premises and conclusions of
arguments, but they do not have an inferential claim.

| ïƒ˜ However,      |     |     | some  |      | passages      | like  | expository  |     |              | passages,  |     |     |
| --------------- | --- | --- | ----- | ---- | ------------- | ----- | ----------- | --- | ------------ | ---------- | --- | --- |
...
ïƒ˜ If the conclusion actually does follow with strict necessity
...
Forms
ïƒ˜ Five  examples  of  such  forms  or  kinds  of  argumentation
| are  | arguments  |     |     | based  | on  | mathematics,  |     |     | arguments  |     |     | from  |
| ---- | ---------- | --- | --- | ------ | --- | ------------- | --- | --- | ---------- | --- | --- | ----- |
definition, and syllogisms.
               Argument based on mathematics
| ïƒ˜ Arguments  |     |     | in    | pure    | mathematics  |     |             | are  | deductive  |          |     | and   |
| ------------ | --- | --- | ----- | ------- | ------------ | --- | ----------- | ---- | ---------- | -------- | --- | ----- |
...
| ïƒ˜It  | is  | an  | argument  |     |     | in  | which  |     | the  | conclusion  |     |     | is  |
| ---- | --- | --- | --------- | --- | --- | --- | ------ | --- | ---- | ----------- | --- | --- | --- |
claimed to depend merely up on the definition of
| some  |     | words  |     | or  | phrase  |     | used  |     | in  | the  | premise  |     | or  |
| ----- | --- | ------ | --- | --- | ------- | --- | ----- | --- | --- | ---- | -------- | --- | --- |
conclusion. example,
ïƒ˜Angel is honest; therefore, Angel tells the truth.
ïƒ˜Kebede is a physician; therefore, he is a doctor.
              Arguments based on Syllogisms
| ïƒ˜Syllogisms  |     |     | are  |     | arguments  |     |     | consisting  |     |     | of  | exactly  |     |
| ------------ | --- | --- | ---- | --- | ---------- | --- | --- | ----------- | --- | --- | --- | -------- | --- |
two premises and one conclusion.
ïƒ˜Syllogisms can be categorized into three groups;
...
| ïƒ˜ We  | have  | to  | take  | into  | consideration  |     |     | that  | deductive  |     |
| ----- | ----- | --- | ----- | ----- | -------------- | --- | --- | ----- | ---------- | --- |
argument  not  always  proceeds  from  the  general  to  the
| particular  |     | and  | inductive  |     | arguments  |     | proceed  |     | from  | the  |
| ----------- | --- | ---- | ---------- | --- | ---------- | --- | -------- | --- | ----- | ---- |
particular to the general.
ïƒ˜ This  is  because  there  are  some  deductive  or  inductive
...
ïƒ˜Here is an inductive argument that proceeds from
the general to the particular:
ïƒ˜All emeralds previously found have been green.
...
ïƒ˜ To tell stories,
ïƒ˜ to ask questions,
ïƒ˜ to guess at answers,
ïƒ˜ to form hypotheses,
ïƒ˜ to launch verbal assaults,
ïƒ˜ to tell jokes,
ïƒ˜ to give directions,
ïƒ˜ to sing songs,
| ïƒ˜ to  | issue  | commands  |     | and  | to greet  | someone  | and  |     |
| ----- | ------ | --------- | --- | ---- | --------- | -------- | ---- | --- |
so on.

| ïƒ˜ In     | general,  | language    |     | has         | three  | linguistic  |            | functions  |      |
| -------- | --------- | ----------- | --- | ----------- | ------ | ----------- | ---------- | ---------- | ---- |
| namely,  |           | expressive  |     | (emotive),  |        |             | directive  |            | and  |
cognitive (informative) function.
| ïƒ˜ Of      | these  | functions  |           | of  | language,  |              | the  | cognitive  |     |
| --------- | ------ | ---------- | --------- | --- | ---------- | ------------ | ---- | ---------- | --- |
| function  |        | of         | language  |     | is         | a  relevant  |      | and        | an  |
important for logic
Expressive (Emotive) Function
     A.
ïƒ˜ It  is  a  function  of  language  which  is  important  for
...
Hawassa. (False)
ïƒ¼Lake Tana is found in Amhara region. (True)

ïƒ˜ The reason why we study about definitions is
| ïƒ¼   | words have meanings.                       |        |      |          |     |     |          |     |        |          |     |
| --- | ------------------------------------------ | ------ | ---- | -------- | --- | --- | -------- | --- | ------ | -------- | --- |
| ïƒ¼   | Meanings are conveyed through definitions  |        |      |          |     |     |          |     |        |          |     |
| ïƒ¼   | Some                                       | times  | the  | meaning  |     | of  | certain  |     | words  | in  the  |     |
argument is vague or ambiguous.
ïƒ˜ On the other hand logic evaluates arguments, and
| an  | argument  |     | consists  |     | of  | a  group  |     | of  | statements,  |     |     |
| --- | --------- | --- | --------- | --- | --- | --------- | --- | --- | ------------ | --- | --- |
and statements are made up of words.
ïƒ˜ Meaning of term
| ïƒ˜   | Term  is any word or arrangement of words  |      |        |     |     |      |          |     |     |     |     |
| --- | ------------------------------------------ | ---- | ------ | --- | --- | ---- | -------- | --- | --- | --- | --- |
|     | that                                       | may  | serve  |     | as  | the  | subject  |     |     | of  | a   |
statement.
| ïƒ˜   | Terms  | consist  |     | of  | proper  |     | names,  |     | common  |     |     |
| --- | ------ | -------- | --- | --- | ------- | --- | ------- | --- | ------- | --- | --- |
...
of words. Examples
| ïƒ˜dictatorial,  |            |     | run      | quickly,  |            |     | above  |       | and     | beyond,  |      |
| -------------- | ---------- | --- | -------- | --------- | ---------- | --- | ------ | ----- | ------- | -------- | ---- |
...
Terms
| ïƒ˜   | The  | intentional  |     |     |     | meaning,  |     |     | is  | also  | known  |     |     | as  |
| --- | ---- | ------------ | --- | --- | --- | --------- | --- | --- | --- | ----- | ------ | --- | --- | --- |
connotation,   refers to the qualities or attributes that
the term connotes.
| ïƒ˜   | The       | extensional  |          |     | meaning,  |     |     | is       | also  | called  | denotation,  |      |       |     |
| --- | --------- | ------------ | -------- | --- | --------- | --- | --- | -------- | ----- | ------- | ------------ | ---- | ----- | --- |
...
ïƒ˜ The  meaning  of  the second example is based on its class
...
ïƒ˜The denotation of a term remains the same from
person to person. For example,
|     | ïƒ˜The  | denotation  |     |     | (extensional  |     |     |     | meaning)  |     |     | of  human  |     |     | being  |     |
| --- | ----- | ----------- | --- | --- | ------------- | --- | --- | --- | --------- | --- | --- | ---------- | --- | --- | ------ | --- |
refers  to  all  human  being  in  the  universe,  on  which
everybody agrees.
| ïƒ˜This  |             | term  |         | either    |      | constantly  |          |         |     | fluctuating  |          |       |      | as     | some  |     |
| ------ | ----------- | ----- | ------- | --------- | ---- | ----------- | -------- | ------- | --- | ------------ | -------- | ----- | ---- | ------ | ----- | --- |
...
| ïƒ˜They  | do  | not  | have  |     | objective  |     |     |     | references  |     |     |     | that  |     | could  |     |
| ------ | --- | ---- | ----- | --- | ---------- | --- | --- | --- | ----------- | --- | --- | --- | ----- | --- | ------ | --- |
...
ïƒ˜ Example:
ïƒ˜Satan is an evil sprit that causes people to suffer.
|     | ïƒ˜Dinosaur  |     |     |     | is  | an  | extinct  |     | reptile  |     | of  | the  |     | Mesozoic  |     |
| --- | ---------- | --- | --- | --- | --- | --- | -------- | --- | -------- | --- | --- | ---- | --- | --------- | --- |
era.
ïƒ˜Terms  may  be  put  in  the  order  of  depending  on  the
increase  or  decrease  of  attributes  and  sets  of  things
added to the term being defined.
| ïƒ˜Increasing  |     |     |     |     | intension,  |     |     |     | increasing  |     |     |     |     | extension,  |     |
| ------------ | --- | --- | --- | --- | ----------- | --- | --- | --- | ----------- | --- | --- | --- | --- | ----------- | --- |
decreasing intension, and decreasing extension

ïƒ˜If the member of a class of things decrease, then the
...
ïƒ˜If the member of a class size gets larger with each
...
ïƒ˜The Latin term definiendum is the word or group of
...
| --- | ---- | --- | ------ | --- | ---------- | --- | --- | --- | ----------- | --- | --- | --- | --- | ---- | ---------- | --- | --- | ---- |
phrases;
ïƒ¼To avoid obscurity(insignificance),unintelligibility(un
|     |     | clearness),  |     |     |     | subjectivity(bias)  |     |     |     |     |     | ,   | and  |     | complexity  |     |     | of  |
| --- | --- | ------------ | --- | --- | --- | ------------------- | --- | --- | --- | --- | --- | --- | ---- | --- | ----------- | --- | --- | --- |
words;
ïƒ¼To
|     |     |     | introduce  |     |     |     | new  | words  |     | and  |     | to  | persuade(ecourage)  |     |     |     |     |     |
| --- | --- | --- | ---------- | --- | --- | --- | ---- | ------ | --- | ---- | --- | --- | ------------------- | --- | --- | --- | --- | --- |
others;
|     | ïƒ¼To  |     |     | avoid  |     |     | useless  |     |     | controversies,  |     |     |     |     |     | disputes,  |     |     |
| --- | ---- | --- | --- | ------ | --- | --- | -------- | --- | --- | --------------- | --- | --- | --- | --- | --- | ---------- | --- | --- |
disagreements and conflicts over the meaning of terms
|     |     | ,words,  |     |     | phrases  |     | and  | passages  |     |     | which  |     |     | considered  |     |     | as  | an  |
| --- | --- | -------- | --- | --- | -------- | --- | ---- | --------- | --- | --- | ------ | --- | --- | ----------- | --- | --- | --- | --- |
argument;
|     | ïƒ¼To  |     | prevent  |     |     | incorrect  |     |     | reasoning;  |     |     |     | and  |     | to  develop  |     |     | the  |
| --- | ---- | --- | -------- | --- | --- | ---------- | --- | --- | ----------- | --- | --- | --- | ---- | --- | ------------ | --- | --- | ---- |
ability to reason logically.

| ïƒ˜There   | are  |     | five          |     | different  |     |     | types     |     | of  | definitions,  |     |     |
| -------- | ---- | --- | ------------- | --- | ---------- | --- | --- | --------- | --- | --- | ------------- | --- | --- |
| namely,  |      |     | Stipulative,  |     |            |     |     | Lexical,  |     |     | PrÃ©cising,    |     |     |
Theoretical, and Persuasive Definitions.
       A. Stipulative  Definition
| ïƒ˜Stipulative  |     |     | definition  |     |     |     | assigns  |     | a   | meaning  |     | to  | a   |
| ------------- | --- | --- | ----------- | --- | --- | --- | -------- | --- | --- | -------- | --- | --- | --- |
word for the first time. This may involve either
| creating  |     | a   | new  | word  |     |     | or  | giving  | a   | new  | meaning  |     |     |
| --------- | --- | --- | ---- | ----- | --- | --- | --- | ------- | --- | ---- | -------- | --- | --- |
to an old word.
| ïƒ˜The       | purpose  |          |     | of  | a   | stipulative  |             |     | definition  |         |     | is     | to  |
| ---------- | -------- | -------- | --- | --- | --- | ------------ | ----------- | --- | ----------- | ------- | --- | ------ | --- |
| introduce  |          | unusual  |     |     |     | or           | unfamiliar  |     |             | words,  |     | which  |     |
have no pervious meaning in the language.

| ïƒ˜Stipulative  |           |     |     |     | definition  |     |     |       | is  |     | used  |        | to  |     | introduce  |     |             |     |     | new  |     |
| ------------- | --------- | --- | --- | --- | ----------- | --- | --- | ----- | --- | --- | ----- | ------ | --- | --- | ---------- | --- | ----------- | --- | --- | ---- | --- |
...
ï¶ A word is vague
ï¶ If  it  is  so  imprecise  and  unclear,  that  is,  it  is
...
ï¶ We can not tell with any degree of precision who rich
is or how we counted as rich.

      C. PrÃ©cising Definition
ïƒ˜A prÃ©cising definition provides a more precise,
...
prÃ©cising definition.

| ïƒ˜PrÃ©cising  |     |     |     | definition  |     |     |       | used  |     |           | to  | clarify  |     |               |     | a   | highly  |     |     |
| ----------- | --- | --- | --- | ----------- | --- | --- | ----- | ----- | --- | --------- | --- | -------- | --- | ------------- | --- | --- | ------- | --- | --- |
...
| --- | --- | ---------- | --- | --- | ----------- | --- | --- | --- | -------- | --- | --- | ----- | --- | --- | --- | ------------ | --- | --- | --- |
definition in that
|     | ïƒ˜Stipulative  |     |     |     |     | definition  |     |     |     |     | involves  |     |     |     |     | a   | purely  |     |     |
| --- | ------------- | --- | --- | --- | --- | ----------- | --- | --- | --- | --- | --------- | --- | --- | --- | --- | --- | ------- | --- | --- |
arbitrary assignment of meaning
|     | ïƒ˜The  |     | assignment  |     |     |     | of  |     | meaning  |     |     |     | in  |     | a   | prÃ©cising  |     |     |     |
| --- | ----- | --- | ----------- | --- | --- | --- | --- | --- | -------- | --- | --- | --- | --- | --- | --- | ---------- | --- | --- | --- |
definition is not at all arbitrary.
| ïƒ˜Care      |     |     | must  |     | be          | taken  |     |     | that  |     | the          |     | meaning  |     |     |     |     | in   | a   |
| ---------- | --- | --- | ----- | --- | ----------- | ------ | --- | --- | ----- | --- | ------------ | --- | -------- | --- | --- | --- | --- | ---- | --- |
| prÃ©cising  |     |     |       |     | definition  |        |     |     | is    |     | appropriate  |     |          |     |     |     |     | and  |     |
...
| ïƒ˜In         | other  | words,  |              | it  | gives  |     | us           | the  |     | way    | of  | seeing  |      | or  |
| ----------- | ------ | ------- | ------------ | --- | ------ | --- | ------------ | ---- | --- | ------ | --- | ------- | ---- | --- |
...
| --- | ------------------------------------------ | ----------- | ------------------------- | --- | --- | ----------- | --- | --- | ---------- | --- | --- | ------------ | --- |
| ïƒ˜   | The purpose of Persuasive definition is:   |             |                           |     |     |             |     |     |            |     |     |              |     |
|     | ïƒ¼                                          | persuading  |                           |     | or  | convincing  |     |     | listeners  |     |     | or  readers  |     |
...
| ïƒ˜ This  |     | definition  |     | may  | exaggerate  |     |     | or  | diminish  |     |
| ------- | --- | ----------- | --- | ---- | ----------- | --- | --- | --- | --------- | --- |
the definiendum.
...
Definitions
ïƒ˜ Extensional definitions provide meaning to a term by
listing examples to the term which is being defined -
definiendum. It is indicating the members of the class
ïƒ˜ There are at least three ways of indicating the members
of a class:
ïƒ¼ by pointing physically to them,
ïƒ¼ by naming them individually, and
ïƒ¼ by naming them in groups.

| ïƒ˜   | Thus,      |     | based  |               | on  | this  | we       |              | identify  |                | three  |               | different  |     |     |
| --- | ---------- | --- | ------ | ------------- | --- | ----- | -------- | ------------ | --------- | -------------- | ------ | ------------- | ---------- | --- | --- |
...
individually.
naming
ïƒ˜ It assigns a meaning to a term by
individually
the members of the class the term
...
| ïƒ˜   | A definition by subclass assigns a meaning to a  |     |         |     |     |             |     |     |     |     |      |        |
| --- | ------------------------------------------------ | --- | ------- | --- | --- | ----------- | --- | --- | --- | --- | ---- | ------ |
...
Definitions
| ïƒ˜ Intentional    |     | or  connotative  |     | definition  | provides  |            |       | a   |
| ---------------- | --- | ---------------- | --- | ----------- | --------- | ---------- | ----- | --- |
| meaning          | to  | a  term          | by  | describing  | the       | essential  |       |     |
| characteristics  |     | or  features     |     | possessed   | by        | the        | term  |     |
being defined.
ïƒ˜ Kinds of intentional definitions includes:
ïƒ˜ Synonymous Definition,
ïƒ˜ Etymological Definition,
...
Operational Definition
       C.
| ïƒ˜  It        | assigns  |               | a  meaning  |     |             | to          | a  word     |     | by   | specifying  |      |     |
| ------------ | -------- | ------------- | ----------- | --- | ----------- | ----------- | ----------- | --- | ---- | ----------- | ---- | --- |
...
| ïƒ˜ A  |             |     |     |     |        |      |             |     |     |           |     |
construct.
| ïƒ˜ The    |     | step  | is    | Simply  |       | select  | a   | term      | that  | is   | more  |
| -------- | --- | ----- | ----- | ------- | ----- | ------- | --- | --------- | ----- | ---- | ----- |
...
| ïƒ˜   | Lexical  | definitions  |     |     | are  | typically  |     | definitions  |     |     |
| --- | -------- | ------------ | --- | --- | ---- | ---------- | --- | ------------ | --- | --- |
by genus and difference, but they also often
include etymological definitions.
| ïƒ˜   | Operational  |     |     | definition  |     | can  |     | serve  | as  | the  |
| --- | ------------ | --- | --- | ----------- | --- | ---- | --- | ------ | --- | ---- |
method for constructing stipulative, lexical,
|     | prÃ©cising,  |      | and  | persuasive  |     |          | definitions, but  |     |           | it  |
| --- | ----------- | ---- | ---- | ----------- | --- | -------- | ----------------- | --- | --------- | --- |
|     | could       | not  | be   | used        | to  | produce  |                   | a   | complete  |     |
lexical definition.
| ïƒ˜   | Synonymous  |     |     | definition  |     | may  |     | be  | used  | to  |
| --- | ----------- | --- | --- | ----------- | --- | ---- | --- | --- | ----- | --- |
produce only lexical definitions.

| ïƒ˜   | Synonymous   |              | definition  |              | cannot  |          |     | be       |     | used    |     | to   |
| --- | ------------ | ------------ | ----------- | ------------ | ------- | -------- | --- | -------- | --- | ------- | --- | ---- |
|     | produce      | stipulative  |             | definitions  |         |          |     | because  |     |         |     | the  |
|     | definiendum  |              | must        | have         | a       | meaning  |     |          |     | before  |     | a    |
synonymous definition.
| ïƒ˜   | Also Synonymous can not be used to construct  |     |               |     |           |      |            |     |             |     |       |     |
| --- | --------------------------------------------- | --- | ------------- | --- | --------- | ---- | ---------- | --- | ----------- | --- | ----- | --- |
|     | prÃ©cising,                                    |     | theoretical,  |     |           | and  |            |     | persuasive  |     |       |     |
...
| ïƒ˜ A            | definition  |     | should  |           | be             | grammatically  |              |            | correct.  |      |
| -------------- | ----------- | --- | ------- | --------- | -------------- | -------------- | ------------ | ---------- | --------- | ---- |
...
ïƒ˜Thus, a correct definition attempts to point out the
...
too little.
| ïƒ˜In  | other  |     | words,  |     | a   | good  | or  | correct  |     |     | definition  |     |     |
| ---- | ------ | --- | ------- | --- | --- | ----- | --- | -------- | --- | --- | ----------- | --- | --- |
...
ïƒ˜ A definition is too broad if the definiens applies to
...
ïƒ˜A definition is too narrow if the definiendum applies to
...
| ïƒ˜The  | first  |     | definition  |     | would  | exclude  |     | ostriches,  |     |
| ----- | ------ | --- | ----------- | --- | ------ | -------- | --- | ----------- | --- |
which cannot fly.
| ïƒ˜In  | the  | second  |     | definition  | the  | term  | gun  | is  defined  |     |
| ---- | ---- | ------- | --- | ----------- | ---- | ----- | ---- | ------------ | --- |
...
| ïƒ˜  Some    |     | words,  |        | however,     |     | are         | intrinsically  |     |        |
| ---------- | --- | ------- | ------ | ------------ | --- | ----------- | -------------- | --- | ------ |
...
ambiguous language.
| ïƒ˜A  |        | definition  |     |     |             | is  | figurative  |     |              |     | when  |     | it  | involves  |     |       |     | and  |     |
| --- | ------ | ----------- | --- | --- | ----------- | --- | ----------- | --- | ------------ | --- | ----- | --- | --- | --------- | --- | ----- | --- | ---- | --- |
|     | based  |             | on  |     | metaphors.  |     |             |     | A  metaphor  |     |       |     |     | is  a     |     | word  |     | or   | a   |
phrase used in the imaginative way.
ïƒ˜A definition is figurative when it also tends to paint
...
ïƒ˜A  definition  is  Obscure  if  its  meaning  is  hidden  as  a
...
.
ïƒ˜ Affective  terminology  is  an  expression  that  influences
...
.
| ïƒ˜A  |              |     | reference  |     |        | to  |     | the        |     | context  |     |           |     | is  | important  |     |     |      |
| --- | ------------ | --- | ---------- | --- | ------ | --- | --- | ---------- | --- | -------- | --- | --------- | --- | --- | ---------- | --- | --- | ---- |
...
| ïƒ˜Involving  |     |     | or  | exercising  |     | skilled  |     | judgment  |     | or  |
| ----------- | --- | --- | --- | ----------- | --- | -------- | --- | --------- | --- | --- |
...
ïƒ˜ Critical  thinking  is  a  process  or  journey  that  helps
us
| ïƒ¼   | To      | arrive  |               | at  | the  | most  |       | useful,  |             | helpful,  | and     | most  |      |
| --- | ------- | ------- | ------------- | --- | ---- | ----- | ----- | -------- | ----------- | --------- | ------- | ----- | ---- |
|     | likely  |         | destinations  |     |      |       | when  |          | evaluating  |           | claims  |       | for  |
scientific truth
| ïƒ¼   | To  | formulate  |     |     | and  |     | present  |     | convincing  |     | reasons  |     | in  |
| --- | --- | ---------- | --- | --- | ---- | --- | -------- | --- | ----------- | --- | -------- | --- | --- |
support of conclusions; and
| ïƒ¼   | To  | make  |     | reasonable,  |     |     |     | intelligent  |     | decisions  |     | about  |     |
| --- | --- | ----- | --- | ------------ | --- | --- | --- | ------------ | --- | ---------- | --- | ------ | --- |
what to believe and what to do.
ïƒ˜ Critical thinking, thus, is thinking clearly, thinking
| fairly,  |     | thinking  |     |     | rationally,  |     |     |     | thinking  |     | objectively,  |     |     |
| -------- | --- | --------- | --- | --- | ------------ | --- | --- | --- | --------- | --- | ------------- | --- | --- |
and thinking independently
ïƒ˜ Therefore, the aim of critical thinking is to arrive
| at  | well-reasoned,  |     |     |     |     | considered,  |     |     |     | and  | justifiable  |     |     |
| --- | --------------- | --- | --- | --- | --- | ------------ | --- | --- | --- | ---- | ------------ | --- | --- |
conclusions.

ïƒ˜ The American philosopher, John Dewey, has defined
...
ïƒ˜Robert Ennis-defined critical thinking as
| ïƒ¼reasonable,  |     |     | reflective  |     |     | thinking  |     | that  | is  | focused  |     | on  |
| ------------- | --- | --- | ----------- | --- | --- | --------- | --- | ----- | --- | -------- | --- | --- |
.
...
ïƒ˜Logic
|     | tells  | us  | that  | if  a  | person  | holds  | inconsistent  |     |
| --- | ------ | --- | ----- | ------ | ------- | ------ | ------------- | --- |
beliefs, at least one of those beliefs must be false.
ïƒ˜There are two kinds of inconsistency that should be avoided.
ïƒ˜Logical
|     |     | Inconsistency,  |     |     | which  | involves  | saying  | or  |
| --- | --- | --------------- | --- | --- | ------ | --------- | ------- | --- |
believing  inconsistent  things  (i.e.,  things  that  cannot
both or all be true) about a particular matter.
| ïƒ˜Practical  |     | Inconsistency,  |     |     | which  | involves  | saying  | one  |
| ----------- | --- | --------------- | --- | --- | ------ | --------- | ------- | ---- |
...
thinking is logical.
| ïƒ˜   | To         |     | think  |     | logically  |     |       |     |     |     | is   | to  |           | reason  |     |     |     | correctly,  |       |
| --- | ---------- | --- | ------ | --- | ---------- | --- | ----- | --- | --- | --- | ---- | --- | --------- | ------- | --- | --- | --- | ----------- | ----- |
...
argument.
| ïƒ˜   | In  | other  | words,  |     | it  should  |     |     | be  | formed  |     | in  | such  | a   |
| --- | --- | ------ | ------- | --- | ----------- | --- | --- | --- | ------- | --- | --- | ----- | --- |
way that
|     | ïƒ¼   | The  | conclusion  |     | either  |     | follows  |     | necessarily  |     |     | from  | its  |
| --- | --- | ---- | ----------- | --- | ------- | --- | -------- | --- | ------------ | --- | --- | ----- | ---- |
...
arguer.
| ïƒ˜If     | there  | is      | any  | question       |        | about  |      | the      | argument,  |       | the  |
| ------- | ------ | ------- | ---- | -------------- | ------ | ------ | ---- | -------- | ---------- | ----- | ---- |
...
| ïƒ˜   | If         | practical   |     |     |     | considerations  |           |            |      |         | seem  |          | to     | require  |               |      |        | a  more   |     |
| --- | ---------- | ----------- | --- | --- | --- | --------------- | --------- | ---------- | ---- | ------- | ----- | -------- | ------ | -------- | ------------- | ---- | ------ | --------- | --- |
...
those grounds.
ïƒ˜ If  suitable  evidence  is  so  lacking  that  one  has  no
...
ïƒ˜An issue should be considered resolved if the
argument is
ïƒ¼a structurally sound
ïƒ¼uses relevant and acceptable reasons
ïƒ¼provide sufficient grounds to justify the
conclusion and
ïƒ¼include an effective rebuttal to all serious
criticisms and/or the position it supports
.

Characteristics of Critical Thinking
Basic Traits of Critical Thinkers
| ïƒ˜There  |      |             | are  | some  |         | dispositions  |      |         | and  |       | attitudes,  |        |     | skills    |     |
| ------- | ---- | ----------- | ---- | ----- | ------- | ------------- | ---- | ------- | ---- | ----- | ----------- | ------ | --- | --------- | --- |
|         | and  | abilities,  |      |       | habits  |               | and  | values  |      | that  |             | every  |     | critical  |     |
person should manifest.
Critical thinkers:
| ïƒ¼   | Are honest with themselves, acknowledging what  |     |        |     |        |     |              |     |     |        |     |               |     |     |     |
| --- | ----------------------------------------------- | --- | ------ | --- | ------ | --- | ------------ | --- | --- | ------ | --- | ------------- | --- | --- | --- |
|     | they                                            |     | don't  |     | know,  |     | recognizing  |     |     | their  |     | limitations,  |     |     |     |
and being watchful of their own errors.
| ïƒ¼   | Regard  |     |     | problems  |     |     | and  | controversial  |     |     |     |     | issues  |     | as  |
| --- | ------- | --- | --- | --------- | --- | --- | ---- | -------------- | --- | --- | --- | --- | ------- | --- | --- |
exciting/stimulating challenges.
| ïƒ¼   | Strive  |     | for  |          | understanding,  |       |              |     | keep  |      | curiosity  |      |        | alive,  |     |
| --- | ------- | --- | ---- | -------- | --------------- | ----- | ------------ | --- | ----- | ---- | ---------- | ---- | ------ | ------- | --- |
...
is insufficient.
| ïƒ¼   | They  | revise  |     | judgments  |     |     | when  | new  |     | evidence  |     |     |     | reveals  |     |
| --- | ----- | ------- | --- | ---------- | --- | --- | ----- | ---- | --- | --------- | --- | --- | --- | -------- | --- |
error.
| ïƒ¼   | Are  | interested  |     |     | in  other  |     | people's  |     |     | ideas  |     | even  |     | when  |     |
| --- | ---- | ----------- | --- | --- | ---------- | --- | --------- | --- | --- | ------ | --- | ----- | --- | ----- | --- |
they tend to disagree with the other person.
| ïƒ¼   | Recognize  |     |     | that  |     | extreme  |     |     | views  |     |     |     | (whether  |     |     |
| --- | ---------- | --- | --- | ----- | --- | -------- | --- | --- | ------ | --- | --- | --- | --------- | --- | --- |
conservative or liberal) are seldom correct, so they
|     | avoid  | them,  |     | practice  |     | fair-mindedness,  |     |     |     |     |     | and  |     | seek  | a   |
| --- | ------ | ------ | --- | --------- | --- | ----------------- | --- | --- | --- | --- | --- | ---- | --- | ----- | --- |
balance view.
| ïƒ¼   | Practice  |     | restraint(controlling)  |     |     |     |     |     | their  |     | feelings  |     |     | rather  |     |
| --- | --------- | --- | ----------------------- | --- | --- | --- | --- | --- | ------ | --- | --------- | --- | --- | ------- | --- |
...
ïƒ¼Regard problems and controversial issues as nuisances or
threats to their ego.
ïƒ¼Are inpatient with complexity and remain confused than
make the effort to understand.
ïƒ¼Base judgments on first impressions and gut/instinctive
reactions. And tend to follow their feelings
ïƒ¼Are preoccupied with themselves and their own opinions,
and
...
ïƒ˜Finally yet importantly, critical thinkers pursue truth
...
the group.
| ïƒ˜   | It             | can  | distort  |     |      | critical  |       |      | thinking  |            |     | in  | many  |        | ways.  |      |
| --- | -------------- | ---- | -------- | --- | ---- | --------- | ----- | ---- | --------- | ---------- | --- | --- | ----- | ------ | ------ | ---- |
...
ïƒ˜ For example, suppose Abdella believes that abortion is
...
ïƒ˜ e.g Drinking wine is widely considered to be wrong in
...
| ïƒ˜ The  | most  | common  |     | form  |     | of  | relativism  |     | is  | moral  |     |
| ------ | ----- | ------- | --- | ----- | --- | --- | ----------- | --- | --- | ------ | --- |
relativism.
ïƒ˜ Moral  subjectivism  is  the  view  that  what  is  morally
...
wished it were true.
| ïƒ˜ People  | fear the  |     | unknown  |     | and  | invent comforting myths  |     |     |     |     |     |
| --------- | --------- | --- | -------- | --- | ---- | ------------------------ | --- | --- | --- | --- | --- |
...
| ïƒ˜How  | to  | reformulate  |     |     |     | these  |     | problems  |     | clearly  |     | and  |     |
| ----- | --- | ------------ | --- | --- | --- | ------ | --- | --------- | --- | -------- | --- | ---- | --- |
precisely.
ïƒ˜How to gather and assess relevant information,
ïƒ˜How develop reasoned conclusions and solutions,
| testing  |     | them  |     | against  |     |     | relevant  |     | criterion  |     |     | and  |     |
| -------- | --- | ----- | --- | -------- | --- | --- | --------- | --- | ---------- | --- | --- | ---- | --- |
standards.
| ïƒ˜How      | to  | be  | open       |     | minded  |      | to  | alternative  |     |       | system  |      | of  |
| --------- | --- | --- | ---------- | --- | ------- | ---- | --- | ------------ | --- | ----- | ------- | ---- | --- |
...
ïƒ˜ Also, critical thinking can help us
ïƒ˜ To avoid making foolish personal decisions.
ïƒ˜ To promote democratic processes. In democracy,
...
and et cetera.
ïƒ˜ To have personal enrichment/improvement it can
...
ïƒ˜ Generally, fallacies can be committed b/c of
ïƒ˜Logical error (error in reasoning) or
|     | ïƒ˜The  |     | creation  |     |     | of  some  |     | illusion  |     | that  | makes  |     | a   | bad  |
| --- | ----- | --- | --------- | --- | --- | --------- | --- | --------- | --- | ----- | ------ | --- | --- | ---- |
argument appear good.
| ïƒ˜If  |            | deductive  |     |            |     | arguments  |     |      | are        | unsound  |     |       | or    | if  |
| ---- | ---------- | ---------- | --- | ---------- | --- | ---------- | --- | ---- | ---------- | -------- | --- | ----- | ----- | --- |
|      | inductive  |            |     | arguments  |     |            |     | are  | uncogent,  |          |     | then  | they  |     |
contain fallacies.
ïƒ˜ This is because such kinds of arguments have one
|     | or  | more  | false  |     |     | premises  |     | or  | they  | contain  |     | a   | fallacy  |     |
| --- | --- | ----- | ------ | --- | --- | --------- | --- | --- | ----- | -------- | --- | --- | -------- | --- |
(or both).

CAUSES OF FALLACIES
ïƒ˜ Causes of fallacies, among others, include:
ïƒ˜The
|     | failure  |     | to  | provide  |     | genuine  |     | evidences  |     | or  | premises  |     |     |
| --- | -------- | --- | --- | -------- | --- | -------- | --- | ---------- | --- | --- | --------- | --- | --- |
for the conclusion;
| ïƒ˜The  | failure  |     | to  | provide  |     |     | premises  |     | that  | provide  |     | good  |     |
| ----- | -------- | --- | --- | -------- | --- | --- | --------- | --- | ----- | -------- | --- | ----- | --- |
support of the premises and conclusion;
ïƒ˜The  failure  to  address  the  most  important  or  relevant
aspects of the issue the arguer arguing for and so forth.
The Classifications of Fallacies
ïƒ˜ Fallacies are usually divided into formal and informal.
ïƒ˜ Formal  fallacies  are  those  fallacies  that  arise  from  an
...
ïƒ˜ The following categorical syllogism contains a formal
fallacy:
ïƒ¼All tigers are animals.
...
ïƒ˜ This argument is invalid, because the conclusion does
not follow from the premises and the conclusion
proves false for there is no any A which is also found
in C.

| ïƒ˜Informal  | fallacies  |          | are  | fallacies  |     | that  | can      | be  |
| ---------- | ---------- | -------- | ---- | ---------- | --- | ----- | -------- | --- |
| detected   | only       | through  |      | analysis   |     | of    | content  |     |
of the argument.
ïƒ˜Informal
|          | fallacies  |      | are       | logical  | errors  |      | in  | the  |
| -------- | ---------- | ---- | --------- | -------- | ------- | ---- | --- | ---- |
| content  | of         | the  | argument  |          | but     | not  | in  | the  |
structure or form of the argument.
  Example:
ïƒ¼All factories are plants.
ïƒ¼All plants are things that contain chlorophyll.
ïƒ¼Therefore, all factories are things that contain
chlorophyll.
...
â€œchlorophyllâ€, respectively.
                           ...
                           All B are C.
                          Therefore, All A are C.
ïƒ˜Since this form is valid, one might conclude that
the argument itself is valid.
| ïƒ˜But  | the  | argument  | is  | invalid  |     | since  | it  |
| ----- | ---- | --------- | --- | -------- | --- | ------ | --- |
...
ïƒ¼ when the premise is expressed by unclear language (the
...
includes:
ïƒ¼fallacies of relevance,
ïƒ¼fallacies of weak induction,
ïƒ¼fallacies of presumption,
ïƒ¼fallacies of ambiguity, and
ïƒ¼fallacies of grammatical analogy.

Fallacies of Relevance
ïƒ˜ They  are  fallacies  that  fail  to  provide  relevant  and
acceptable premises to their conclusion.
| ïƒ˜ They  | are  | arguments  |     | that  | provide  |     | irrelevant  |     |     | premises  |     |
| ------- | ---- | ---------- | --- | ----- | -------- | --- | ----------- | --- | --- | --------- | --- |
to the conclusion.
| ïƒ˜ The       | premises  |     | are      | relevant  |           | psychologically  |      |             |     | and  | the  |
| ----------- | --------- | --- | -------- | --------- | --------- | ---------------- | ---- | ----------- | --- | ---- | ---- |
| connection  |           |     | between  |           | premises  |                  | and  | conclusion  |     |      | is   |
emotional or not logical.
ïƒ˜ Fallacies of Relevance contains eight different types of
...
to the Stick)
ïƒ˜ It occurs whenever an arguer creates a conclusion to
...
ïƒ˜ In other words, an appeal to force fallacy occurs
whenever one irrelevantly appeals to force or threat
of force to win an argument.
ïƒ˜ This fallacy always involves a threat by the arguer to
the physical or psychological wellbeing of the
listener or reader,
ïƒ˜ Obviously, such a threat is logically irrelevant to the
...
ïƒ¼Anyone who believes the government has exceeded
...
ïƒ˜ It occurs when an arguer attempts to support a conclusion by
simply evoking pity from the reader or listener in an effort to
get him or her to accept the conclusion.
ïƒ˜ The pity does not have any logical connection or relevance to
the conclusion.
ïƒ˜ But it is psychologically relevant for the conclusion as the
arguer can usually succeed in getting a pitting heart from his
audience.
ïƒ˜ The appeal to pity is quite common and frequently appears in
...
| ïƒ˜ But  | evidences  |     | are  | not  | logically  |     | relevant  |     | to  | the  |
| ------ | ---------- | --- | ---- | ---- | ---------- | --- | --------- | --- | --- | ---- |
conclusion. so the argument is fallacious
ïƒ¼Your  honor,  it  is  true  that  I  killed  my  parents.  I
...
ïƒ˜  It  occurs  when  the  arguer  attempts  to  persuade  the
reader  or  listener  about  a  certain  issue  on  the  ground
|     | that  |     | most  | people  |     |     | approve  |     | it  | or  | disapprove  |     |     |     | the  | issue  |     |
| --- | ----- | --- | ----- | ------- | --- | --- | -------- | --- | --- | --- | ----------- | --- | --- | --- | ---- | ------ | --- |
being in question.
ïƒ˜ It consist arguments with language that is calculated to
excite enthusiasm, excitement, anger, or hate.
| ïƒ˜   | It  | has  | two  |     | approaches,  |     |     |     | namely,  |     |     | direct  |     | and  | indirect  |     |     |
| --- | --- | ---- | ---- | --- | ------------ | --- | --- | --- | -------- | --- | --- | ------- | --- | ---- | --------- | --- | --- |
approaches .
| ïƒ˜   | The         |     | direct  |      |     | approach    |     |        | occurs  |      |          | when   |     | an       | arguer,  |     |      |
| --- | ----------- | --- | ------- | ---- | --- | ----------- | --- | ------ | ------- | ---- | -------- | ------ | --- | -------- | -------- | --- | ---- |
...
ïƒ˜ The objective of direct approach  is to arouse a kind of
...
love.
| ïƒ˜   | Indirect     |     |     | approach  |                       |     |     | is  | appeal  |     |     |     | to  | some  |       |     | or  |         | more  |
| --- | ------------ | --- | --- | --------- | --------------------- | --- | --- | --- | ------- | --- | --- | --- | --- | ----- | ----- | --- | --- | ------- | ----- |
|     | individuals  |     |     |           | separately, focusing  |     |     |     |         |     |     |     | up  | on    | some  |     |     | aspect  |       |
of their relationship to the crowd.
ïƒ˜ The heaviest reliance on this approach in particular
...
| ïƒ˜   | Individuals  |     |     |     | associated  |     |     |     | with  |     | the  |     | advertisement  |     |     |     |     |     | are  |
| --- | ------------ | --- | --- | --- | ----------- | --- | --- | --- | ----- | --- | ---- | --- | -------------- | --- | --- | --- | --- | --- | ---- |
also usually beautiful or handsome, famous, clever,
etc.
| ïƒ˜   | There  |     | are  |     |     | three  |     | varieties  |     |     |     |     | of  | the  |     |     | indirect  |     |     |
| --- | ------ | --- | ---- | --- | --- | ------ | --- | ---------- | --- | --- | --- | --- | --- | ---- | --- | --- | --------- | --- | --- |
approach. These are appeal to bandwagon, appeal
to vanity, and appeal to snobbery.

A. Appeal to Bandwagon
ïƒ˜ It emphasizes that the majority choice is a correct one
ïƒ˜ It is fallacious because peer pressure urges the acceptance of a
claim on the ground of the approval of friends or associates.
Examples:
ïƒ¼ Chewing chat can not be all wrong because 70% of
Werabe university students see nothing wrong with it.
ïƒ¼ A film is good because there are long lines of people
waiting to see it.
ïƒ˜ They tell us nothing more than what large number of people
does or believes and about the quality of a thing or the truth
of the idea.
ïƒ˜ The idea can be believed by everyone and yet not be true. So,
it is fallacious.
ïƒ˜ loyalty to a group and the need to belong can give people very
strong reasons to agree to the views and positions of those
groups

B. Appeal to Vanity
ïƒ˜ It associates the product with certain celebrities
...
ïƒ˜ It is an appeal to the desire to be regarded as
superior to others.
ïƒ˜ It occurs when an arguer associates a product with a
selected few persons (distinguished person) that have
an exaggerated social position, health and some other
qualities.
Examples:
ïƒ¼ This is not for ordinary people. If you want to be from
among the selected few dignitaries buy the shoe.
ïƒ¼ Look at the mark of this cell phone-it is Nokia and Nokia is
not for everyone. Buy Nokia and join the selected few.
ïƒ¼ First of all, did you see the mark of the shoe-its Clark? You
...
| ïƒ˜The  |     |     | person  |     |     | can  |     | be  |     | abused  |     | for  | being  |     | ugly,  |     |     | smoker,  |     |
| ----- | --- | --- | ------- | --- | --- | ---- | --- | --- | --- | ------- | --- | ---- | ------ | --- | ------ | --- | --- | -------- | --- |
gambler, and conservative.
| ïƒ˜   | But         |     | the  |        | character  |     |      |     |        | of   | the          | individual  |     |     |                | is  |       | logically  |       |
| --- | ----------- | --- | ---- | ------ | ---------- | --- | ---- | --- | ------ | ---- | ------------ | ----------- | --- | --- | -------------- | --- | ----- | ---------- | ----- |
...
| --- | --- | ---- | --- | --- | ----- | --- | ----------- | --- | --- | --- | ------ | --- | ------ | --- | ------ | --- | --- | ------- | --- |
Tamirat.
| ïƒ˜These  |     |     |     | arguments  |     |     |     |     | commit  |     |     | the  | fallacy  |     |     | ad  | hominem  |     |     |
| ------- | --- | --- | --- | ---------- | --- | --- | --- | --- | ------- | --- | --- | ---- | -------- | --- | --- | --- | -------- | --- | --- |
...
|     | ïƒ¼   | My      |     | doctor  |     |     |         | told  | me  |     | to  | lose    | some  |      | weight.  |     |          | Why  |     |
| --- | --- | ------- | --- | ------- | --- | --- | ------- | ----- | --- | --- | --- | ------- | ----- | ---- | -------- | --- | -------- | ---- | --- |
...
ïƒ˜ Here is an example of an argument that discredits a witness:
|     | ïƒ¼Geremew  |            |      |       |            | has  |             | testified  |         |      | that     |        | he  saw   |       |      | Belay  |     |           | set    | fir  |
| --- | --------- | ---------- | ---- | ----- | ---------- | ---- | ----------- | ---------- | ------- | ---- | -------- | ------ | --------- | ----- | ---- | ------ | --- | --------- | ------ | ---- |
...
| ------ | --- | ---- | --------------- | --- | --- | --- | --- | --- | ---- | ---- | ---------- | --- | --- |
in that belief.
ïƒ˜Personal factors are never relevant to truth
and false.
ïƒ˜In
|     | general,  |     |     | ad  | hominum  |     |     |     | arguments  |     |     |     | are  |
| --- | --------- | --- | --- | --- | -------- | --- | --- | --- | ---------- | --- | --- | --- | ---- |
effective due to the following reasons:
| ïƒ¼Close  |     |     | connection  |     |     |     | between  |     |     | truth  |     |     | and  |
| ------- | --- | --- | ----------- | --- | --- | --- | -------- | --- | --- | ------ | --- | --- | ---- |
believability.
| ïƒ¼They  |            | engaged   |      |           | the  | emotion  |         |     | of    | readers  |     |           | and  |
| ------ | ---------- | --------- | ---- | --------- | ---- | -------- | ------- | --- | ----- | -------- | --- | --------- | ---- |
...
ïƒ˜ It is committed when a general rule is applied to a specific
...
ïƒ¼ Kidist! All good patients obey the order of their doctors. Hence,
...
ïƒ¼Tsegaye:  You  cannot  get  people  to  give  up  drinking;
they have been doing it for thousands of years.

ïƒ˜ The straw man fallacy has three essential components.
...
court.
ïƒ¼ Tom: Mary is advocating the release of known terrorists.
...
| --- | ---- | -------- | --- | --- | -------- | --- | ---- | --- | ------ | ----------- | --- | --- |
Elenchii)
| ïƒ˜   | This      | fallacy  |          | occurs      |      | when        | the  |      | premise      |     | of  | an   |
| --- | --------- | -------- | -------- | ----------- | ---- | ----------- | ---- | ---- | ------------ | --- | --- | ---- |
...
ïƒ˜Examples:
|     | ïƒ¼Crimes  |     | of  | theft  |     | and  | robbery  |     |     | have  | been  |     |
| --- | -------- | --- | --- | ------ | --- | ---- | -------- | --- | --- | ----- | ----- | --- |
increasing at an alarming rate lately.
ïƒ˜The conclusion is obvious: We must reinstate
...
| ïƒ˜   | The  |     | conclusion  |     |     |     |     | of  | the  |     |     | example  |     |     |     | misses  |     |     | logical  |     |
| --- | ---- | --- | ----------- | --- | --- | --- | --- | --- | ---- | --- | --- | -------- | --- | --- | --- | ------- | --- | --- | -------- | --- |
implication from the premise.

| ïƒ˜The  |     |     | logical  |     |     | conclusion  |     |     |     | for  |     | the  |     | premise  |     |     |     | is  |     | not  |
| ----- | --- | --- | -------- | --- | --- | ----------- | --- | --- | --- | ---- | --- | ---- | --- | -------- | --- | --- | --- | --- | --- | ---- |
closing  the  university  but  it  could  have  been  stated
in other ways like:
|     | ïƒ˜providing  |             |     |     |              | additional  |     |     |     | facilities   |      |     |     |           | for  |       |     | students,  |        |      |
| --- | ----------- | ----------- | --- | --- | ------------ | ----------- | --- | --- | --- | ------------ | ---- | --- | --- | --------- | ---- | ----- | --- | ---------- | ------ | ---- |
...
ïƒ˜ The red herring fallacy is committed when the arguer diverts
the attention of the reader or listener by changing the subject
to a different but sometimes subtly related one.
ïƒ˜ It usually appears in the form of appeal to humor, ridicule or
...
first.
Examples:
ïƒ¼ The minister: The new education policy is appreciative. Bezawit:
...
discussion.
ïƒ¼ Interviewer: Your opponent has argued for immigration
reform. Do you agree with her position?
ïƒ¼ Candidate: I think the more important question confronting
...
| ïƒ˜   | Usually  |     |     | fallacies  |     |     | of  | weak  |     | induction  |     |     |     | appear  |     | in  |
| --- | -------- | --- | --- | ---------- | --- | --- | --- | ----- | --- | ---------- | --- | --- | --- | ------- | --- | --- |
...
ïƒ˜ Fallacies of weak induction involve that are in some
...
This fallacy is committed whenever one arrives to a conclusion,
on the basis of very little evidence or whereby generalization is
asserted or concluded based on: very limited information,
inadequate information, and unrepresentative sample.
Examples:
I have met two persons in Hawassa town so far, and they were
...
On three separate occasions I drank a bottle of Meta beer and
found it flat and bitter. Probably I would find every bottle of
Meta beer flat and bitter.
Neither of these arguments commits the fallacy of hasty
generalization because in neither case is there any likelihood
that the sample is atypical of the group. In the first argument the
fact that the mice died in only two minutes suggests the
existence of a causal connection between eating substance Z
and death. If there is such a connection, it would hold for other
mice as well. In the second example the fact that the taste of
beer typically remains constant from bottle to bottle causes the
argument to be strong, even though only three bottles were
sampled.

ïƒ˜ Hasty  generalization  is  also  called  converse  accident,
|     | because  |     | it  proceeds  |     |     |     | from  |     | particular  |     |     | to  | general  |     | (the  |
| --- | -------- | --- | ------------- | --- | --- | --- | ----- | --- | ----------- | --- | --- | --- | -------- | --- | ----- |
premises  deal  with  a  particular  issue,  but  the  conclusion
generalizes  that  something  is  true  or  false  merely  based
|     | on  | the  | knowledge  |     |     | of  | the  |     | particular  |     | issue-the  |     |     | sample)  |     |
| --- | --- | ---- | ---------- | --- | --- | --- | ---- | --- | ----------- | --- | ---------- | --- | --- | -------- | --- |
while accident proceeds from the general to the particular
|     | (the  | premises  |     | deal  |     |     | with  |     | a   | general  |     | issues,  |     | but  | the  |
| --- | ----- | --------- | --- | ----- | --- | --- | ----- | --- | --- | -------- | --- | -------- | --- | ---- | ---- |
...
ground that the first event, which the arguer identifies as a
cause, occurs before the new action.

ï± There are three varieties of false cause fallacy, namely, Post Hoc Ergo
Propter Hoc Fallacy, Non Causa pro Causa Fallacy, and
...
ïƒ¼ These examples commit the fallacy of begging the question.
...
ï± Any law can be repealed by the legislative authority. But the
