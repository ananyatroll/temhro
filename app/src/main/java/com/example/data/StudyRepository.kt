    ...
    override suspend fun seedDatabaseIfEmpty() = withContext(Dispatchers.IO) {
        ...
        if (subjectsCount < 41) {
            val subjectsList = listOf(
                ...
                StudySubject("freshman_english_1", "Communicative English I (FLEn 1111)", "biology", "freshman"),
                StudySubject("freshman_emerging_tech", "Emerging Tech (EmTe 1012)", "chemistry", "freshman"),
                StudySubject("freshman_anthropology", "Social Anthropology (Anth 1012)", "anthropology", "freshman"),
                StudySubject("freshman_economics", "Economics (Econ 1011)", "civics", "freshman"),
                StudySubject("freshman_entrepreneurship", "Entrepreneurship (MGMT 1012)", "biology", "freshman"),
                StudySubject("freshman_civics", "Moral & Civics (MCiE 1012)", "civics", "freshman"),
                StudySubject("freshman_global_trends", "Global Trends (GlTr-1012)", "chemistry", "freshman"),

                // Freshman Semester II Package
                StudySubject("freshman_physical_fitness", "Physical Fitness (SpSc1011)", "biology", "freshman"),
                StudySubject("freshman_history", "History of Ethiopia (HIST 1012)", "anthropology", "freshman"),
                StudySubject("freshman_critical_thinking", "Critical Thinking (LoCT 1011)", "civics", "freshman"),
                StudySubject("freshman_geography", "Geography of Ethiopia (GeES 1011)", "anthropology", "freshman"),
                StudySubject("freshman_inclusiveness", "Inclusiveness (SNIE1112)", "biology", "freshman"),
                StudySubject("freshman_psychology", "General Psychology (Psyc1011)", "biology", "freshman"),
                StudySubject("freshman_english_2", "Communicative English II (FLEn 1122)", "chemistry", "freshman"),
                StudySubject("freshman_maths", "Mathematics for Social Sciences (Math 1012)", "chemistry", "freshman"),

                // AAU UAT Prep Package
                StudySubject("uat_verbal", "Verbal Reasoning", "civics", "aau_uat"),
                StudySubject("uat_quantitative", "Quantitative Reasoning", "chemistry", "aau_uat"),
                StudySubject("uat_analytical", "Analytical Reasoning", "anthropology", "aau_uat"),
                StudySubject("uat_english", "General English & Vocabulary", "biology", "aau_uat"),

                // University Department Package
                StudySubject("dept_data_structures", "Data Structures & Algorithms", "maths", "department"),
                StudySubject("dept_software_engineering", "Software Engineering", "physics", "department"),
                StudySubject("dept_dbms", "Database Systems", "chemistry", "department"),
                StudySubject("dept_anatomy", "Human Anatomy", "biology", "department"),
                StudySubject("dept_accounting", "Financial Accounting", "economics", "department"),

                // Exit Exam Prep Package
                StudySubject("exit_cs", "Computer Science Exit Exam", "physics", "exit_exam"),
                StudySubject("exit_mgmt", "Business Management Exit Exam", "economics", "exit_exam"),
                StudySubject("exit_med", "Medicine & Health Sciences Exit Exam", "biology", "exit_exam"),
